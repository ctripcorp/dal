...
public class AbacusAirBookLogGenDaoTest {
	public static void main(String[] args) {
		...
		try {
			...
			**/
			...
			AbacusAirBookLogGenDao dao = new AbacusAirBookLogGenDao();
		
			AbacusAirBookLogGen pk = dao.queryByPk(null);// you value here
			
			pk = dao.queryByPk(pk);
			List<AbacusAirBookLogGen> pojos = dao.queryByPage(pk, 100, 0);
