...
//        DalClientFactory.initClientFactory(this.getClass().getClassLoader().getResource(".").getPath() + "RWDalConfig/Dal.config");
        ...
        MysqlPersonTable masterOnlyOnMysql = new MysqlPersonTable();
...
//        自定义dao
    ...
    public void testRWShardInsert() throws Exception {
        ...
        List<MysqlPersonTable> listFromKey0=dao.test_build_queryByName("testRWShardInsert",new DalHints().inShard(0).masterOnly());
        List<MysqlPersonTable> listFromKey1=dao.test_build_queryByName("testRWShardInsert",new DalHints().inShard(0));
        List<MysqlPersonTable> listFromKey2=dao.test_build_queryByName("testRWShardInsert",new DalHints().inShard(1).masterOnly());
        List<MysqlPersonTable> listFromKey3=dao.test_build_queryByName("testRWShardInsert",new DalHints().inShard(1));
