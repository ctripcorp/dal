...
import DRTestMybatisWithDAL.DRTestDao;
import DRTestMybatisWithDAL.DRTestPojo;
 ...
 */
public class TestBothDALAndMybatisFat16 {
    private static Logger log = LoggerFactory.getLogger(TestBothDALAndMybatisFat16.class);
