...
//    private DalParser<Integer> parser1 = null;	
	...
	private DalRowMapper<MysqlPersonTable> personSimpleShardByDBOnMysqlGenRowMapper = null;
	...
	public DesignatedDatabaseOnMysqlGenDao() throws SQLException {
		...
		this.personSimpleShardByDBOnMysqlGenRowMapper = new DalDefaultJpaMapper(MysqlPersonTable.class);
	...
	**/
	public List<MysqlPersonTable> test_def_query_list(List<Integer> Age, DalHints hints) throws SQLException {
		...
		return (List<MysqlPersonTable>)queryDao.query(sql, parameters, hints, personSimpleShardByDBOnMysqlGenRowMapper);
	}
	...
	**/
	public MysqlPersonTable test_def_query_list_single(List<Integer> Age, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return (MysqlPersonTable)queryDao.queryForObjectNullable(sql, parameters, hints, personSimpleShardByDBOnMysqlGenRowMapper);
	}
	...
	**/
	public MysqlPersonTable test_def_query_list_first(List<Integer> Age, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return (MysqlPersonTable)queryDao.queryFirstNullable(sql, parameters, hints, personSimpleShardByDBOnMysqlGenRowMapper);
	}
	...
	**/
	public List<MysqlPersonTable> test_build_query_page(Integer Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, true);
		builder.select("Birth","Name","Age","ID");
...
//	}
	...
	**/
	public MysqlPersonTable test_build_query_single_greaterThan(Integer Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.greaterThan("Age", Age, Types.INTEGER, false);
	...
	**/
	public MysqlPersonTable test_build_query_first_greaterThan(Integer Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.greaterThan("Age", Age, Types.INTEGER, false);
	...
	**/
	public List<MysqlPersonTable> test_def_query_equal(Integer Age, DalHints hints) throws SQLException {
	 ...
	 * SimpleShardByDBOnMysql,自定义查询，equal
	**/
	public List<MysqlPersonTable> test_def_query_nonexistentColumn(DalHints hints) throws SQLException {
		String sql = "select * from person where name in (select Name from people where Age1=3)";
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
//		parameters.setSensitive(i++, "Age", Types.INTEGER, Age);
		return (List<MysqlPersonTable>)queryDao.query(sql, parameters, hints, parser);
	}
