...
public class StatementParametersTest {
    ...
    public void testDuplicateIndex() {
        StatementParameters test = new StatementParameters();
        test.add(new StatementParameter(1, Types.INTEGER, 20));
        test.add(new StatementParameter(1, Types.INTEGER, 30));
        test.add(new StatementParameter(2, Types.INTEGER, 40));
        test.add(new StatementParameter(3, Types.INTEGER, 50));
        test.add(new StatementParameter(3, Types.INTEGER, 60));

        assertEquals("[1, 3]", test.findDuplicateIndex().toString());
