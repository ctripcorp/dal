 ...
 */
public class NoShardTransactionalTestOnSqlServerDao extends NoShardTransactionTestOnSqlServerDao {
    private static final String DATA_BASE = "noShardTestOnSqlServer";
    public NoShardTransactionalTestOnSqlServerDao() throws SQLException {
