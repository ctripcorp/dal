    ...
    public class CTimer
    {
        ...
        class CTimerInternal : IDisposable
        {
            ...
            private void TimerCallback(object state)
            {
                ...
                try
                {
                    //Arch.Release.ServerAgent.Client.LogBroadcast.IISAgentLog.Debug(HttpRuntime.Cache.Count.ToString());
                    ...
                    //{
                    ////    //Arch.Release.ServerAgent.Client.LogBroadcast.IISAgentLog.Debug("Collected");
