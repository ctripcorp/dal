...
public class ShardColModShardByDBOnSqlServerGenDao {
	 ...
	 **/
	public List<SqlServerPeopleTable> test_build_queryFrom_pojoList(
...
//		return queryDao.query(sql, parameters, hints, parser);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,queryFrom
	 **/
	public List<SqlServerPeopleTable> test_build_queryFromPartialFieldsStrings_pojoList(
			List<Integer> CityID, DalHints hints,int start,int count) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
...
//		return queryDao.query(sql, parameters, hints, parser);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,queryFrom
	 **/
	public List<SqlServerPeopleTable> test_build_queryFromPartialFieldsSet_pojoList(
			List<Integer> CityID, DalHints hints,int start,int count) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
...
//		columns.add("PeopleID");
	...
	private class ShardColModShardByDBOnSqlServerComparator implements Comparator<SqlServerPeopleTable> {
		@Override
