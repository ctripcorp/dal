...
public class AllTypesGenDao {
	...
	private static final String COUNT_SQL_PATTERN = "SELECT count(1) from All_Types WITH (NOLOCK)";
	private static final String ALL_SQL_PATTERN = "SELECT * FROM All_Types WITH (NOLOCK)";
	private static final String PAGE_SQL_PATTERN = "select * from All_Types (nolock) order by ID desc OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";	
	...
	**/
	 ...
	 * java
	**/
	public List<AllTypesGen> test_alltypes_nullable(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	public List<AllTypesGen> test_alltypes(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("All_Types", dbCategory, false);
		builder.select("TextCol","DatetimeCol","DecimalCol","TimeCol","XmlCol","VarcharmaxCol","FloatCol","VarcharCol","BinaryCol","BitCol","SmallDatetimeCol","HierarchidCol","CharCol","ID","DatetimeOffsetCol","TinyIntCol","SmallIntCol","NvarcharMaxCol","NumericCol","NvarcharCol","BigIntCol","GeographyCol","MoneyCol","Datetime2Col","GeometryCol","UniqueidentifierCol","TimestampCol","IntCol","ImageCol","NtextCol","NcharCol","RealCol","SmallMoneyCol","DateCol","VarBinaryMaxCol","VarBinaryCol");
