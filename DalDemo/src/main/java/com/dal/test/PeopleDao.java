...
public class PeopleDao {
    private static final String DATA_BASE = "DBShard";
	...
	**/
	public List<People> findPeople(String name, int pageNo, int pageSize, DalHints hints) throws SQLException {
		...
		builder.likeNullable("Name", name, Types.VARCHAR, true);
	 ...
	 * update test
	**/
	public int updatePeople (String Name, Integer CountryID, String name, Integer prov1, Integer prov2, List<Integer> cityId, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		UpdateSqlBuilder builder = new UpdateSqlBuilder("People", dbCategory);
		builder.update("Name", Name, Types.VARCHAR);
		builder.update("CountryID", CountryID, Types.INTEGER);
		builder.likeNullable("Name", name, Types.VARCHAR, true);
		builder.and().betweenNullable( "ProvinceID", prov1, prov2, Types.INTEGER, true);
		builder.and().in("CityID", cityId, Types.INTEGER, false);
		String sql = builder.build();
	 ...
	 * insert test
	**/
	public int insertPeople (Integer CityID, String Name, Integer ProvinceID, Integer CountryID, DalHints hints) throws SQLException {
		...
		parameters.setSensitive(i++, "ProvinceID", Types.INTEGER, ProvinceID);
	 ...
	 * delete test
	**/
	public int deletePeople (Integer cityId, List<Integer> contryId, String name, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		DeleteSqlBuilder builder = new DeleteSqlBuilder("People", dbCategory);
		builder.equalNullable("CityID", cityId, Types.INTEGER, true);
		builder.and().inNullable("CountryID", contryId, Types.INTEGER, true);
		builder.and().like("Name", name, Types.VARCHAR, false);
	    String sql = builder.build();
		return client.update(sql, builder.buildParameters(), hints);
	}
