...
public class SimpleShardByDBTableOnMysqlGenDaoUnitTest {
	...
	public void setUp() throws Exception {
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos1 = new ArrayList<>(3);
		for(int i=0;i<3;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos101 = new ArrayList<>(3);
		for(int i=0;i<3;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(i+200);
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos2 = new ArrayList<>(3);
		for(int i=0;i<3;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(i+200);
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos211 = new ArrayList<>(3);
		for(int i=0;i<3;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(i+200);
...
//		assertEquals(3,list.size());
	...
	public void testInsert4() throws Exception {
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos100 = new ArrayList<>(2);
		for(int i=0;i<2;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(200);
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos101 = new ArrayList<>(2);
		for(int i=0;i<2;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(200);
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos110 = new ArrayList<>(2);
		for(int i=0;i<2;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
		...
		List<SimpleShardByDBTableOnMysqlGen> daoPojos111 = new ArrayList<>(2);
		for(int i=0;i<2;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setCityID(201);
...
//		List<PeopleGen> list = dao.queryByPage(pageSize, pageNo, hints);
	...
	public void testQueryByPk1() throws Exception {
		Number id = 3L;
		SimpleShardByDBTableOnMysqlGen ret = dao.queryByPk(id, new DalHints().inShard(0).inTableShard(0));
	...
	public void testQueryByPk2() throws Exception {
		SimpleShardByDBTableOnMysqlGen pk = new SimpleShardByDBTableOnMysqlGen();
		pk.setID(3);
		SimpleShardByDBTableOnMysqlGen ret = dao.queryByPk(pk, new DalHints().inShard(0).inTableShard(0));
		assertEquals("InsertByShard_0TableShard_02",ret.getName());
	...
	public void testUpdate2() throws Exception {
		List<SimpleShardByDBTableOnMysqlGen> daoPojos1 = new ArrayList<>(2);
		for(int i=0;i<2;i++)
		{
			SimpleShardByDBTableOnMysqlGen daoPojo = new SimpleShardByDBTableOnMysqlGen();
			daoPojo.setID(i+1);
