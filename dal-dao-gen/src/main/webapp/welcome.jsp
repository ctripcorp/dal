...
<div class="container">
    ...
    <div class="row demo-samples">
        ...
        <div class="col-xs-8 demo-video">
            <!--[if !IE]> -->
            <video class="video-js" controls preload="auto" width="620" height="349"
                   poster="/static/Flat-UI-master/images/video/poster.jpg" data-setup="{}">
            ...
            <!--[if IE]>
            <video class="video-js" controls preload="auto" width="620" height="349"
                   poster="http://video-js.zencoder.com/oceans-clip.jpg" data-setup="{}">
