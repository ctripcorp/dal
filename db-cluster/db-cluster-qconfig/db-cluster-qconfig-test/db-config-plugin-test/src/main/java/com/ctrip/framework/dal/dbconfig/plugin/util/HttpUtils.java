...
public class HttpUtils {
    ...
    public String sendPost(String url, Map<String, String> headers, List<NameValuePair> urlParams) throws Exception {
        return sendPost(url, headers, urlParams, "", DEFAULT_TIMEOUT_MS);
    }
