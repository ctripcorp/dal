...
public class PeopleShardColModShardByDBTableOnMysqlDao {
	...
	private DalTableDao<PeopleShardColModShardByDBTableOnMysql> client;
	...
	private DalRowMapper<PeopleShardColModShardByDBTableOnMysql> peopleShardColModShardByDBTableOnMysqlRowMapper = null;
...
//		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(PeopleShardColModShardByDBTableOnMysql.class));
		this.client = new DalTableDao<>(PeopleShardColModShardByDBTableOnMysql.class);
...
//		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(PeopleShardColModShardByDBTableOnMysql.class));
	...
	/**
	 * Query PeopleShardColModShardByDBTableOnMysql by the specified ID
	 * The ID must be a number
	**/
	public PeopleShardColModShardByDBTableOnMysql queryByPk(Number id, DalHints hints)
			throws SQLException {
	...
	/**
	 * Query PeopleShardColModShardByDBTableOnMysql by PeopleShardColModShardByDBTableOnMysql instance which the primary key is set
	**/
	public PeopleShardColModShardByDBTableOnMysql queryByPk(PeopleShardColModShardByDBTableOnMysql pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<PeopleShardColModShardByDBTableOnMysql> queryLike(PeopleShardColModShardByDBTableOnMysql sample, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	/**
	 * Query PeopleShardColModShardByDBTableOnMysql with paging function
	 * The pageSize and pageNo must be greater than zero.
	 */
	public List<PeopleShardColModShardByDBTableOnMysql> queryAllByPage(int pageNo, int pageSize, DalHints hints)  throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<PeopleShardColModShardByDBTableOnMysql> queryAll(DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, PeopleShardColModShardByDBTableOnMysql daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @return how many rows been affected
	 */
	public int[] insert(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, KeyHolder keyHolder, PeopleShardColModShardByDBTableOnMysql daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] insert(DalHints hints, KeyHolder keyHolder, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchInsert(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, KeyHolder keyHolder, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int delete(DalHints hints, PeopleShardColModShardByDBTableOnMysql daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] delete(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchDelete(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int update(DalHints hints, PeopleShardColModShardByDBTableOnMysql daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] update(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchUpdate(DalHints hints, List<PeopleShardColModShardByDBTableOnMysql> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	 ...
	 * 构建
	**/
	public List<PeopleShardColModShardByDBTableOnMysql> test_build_query_list(List<Integer> CityID, List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建
	**/
	public List<PeopleShardColModShardByDBTableOnMysql> test_build_query_listByPage(List<Integer> CityID, List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建
	**/
	public PeopleShardColModShardByDBTableOnMysql test_build_query_listSingle(List<Integer> CityID, List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建
	**/
	public PeopleShardColModShardByDBTableOnMysql test_build_query_listFirst(List<Integer> CityID, List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	 ...
	 * 自定义
	**/
	public List<PeopleShardColModShardByDBTableOnMysql> test_def_query_list(List<Integer> CityID, List<Integer> Age, DalHints hints,String tableShardID) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<List<PeopleShardColModShardByDBTableOnMysql>> builder = new FreeSelectSqlBuilder<>(dbCategory);
	 ...
	 * 自定义
	**/
	public List<PeopleShardColModShardByDBTableOnMysql> test_def_query_listByPage(List<Integer> CityID, List<Integer> Age, int pageNo, int pageSize, DalHints hints,String tableShardID) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 自定义
	**/
	public PeopleShardColModShardByDBTableOnMysql test_def_query_listSingle(List<Integer> CityID, List<Integer> Age, DalHints hints,String tableShardID) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<PeopleShardColModShardByDBTableOnMysql> builder = new FreeSelectSqlBuilder<>(dbCategory);
		builder.setTemplate("select * from People"+tableShardID+" where CityID in (?) and Age in (?)");
		StatementParameters parameters = new StatementParameters();
		int i = 1;
		i = parameters.setSensitiveInParameter(i, "CityID", Types.INTEGER, CityID);
		...
		return (PeopleShardColModShardByDBTableOnMysql)queryDao.query(builder, parameters, hints);
	}

	/**
	 * 自定义
	**/
	public PeopleShardColModShardByDBTableOnMysql test_def_query_listFirst(List<Integer> CityID, List<Integer> Age, DalHints hints,String tableShardID) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		...
		return (PeopleShardColModShardByDBTableOnMysql)queryDao.query(builder, parameters, hints.sortBy(new PeopleShardColModShardByDBTableOnMysqlComparator()));
	}
