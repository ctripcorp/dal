...
public class PeopleShardColModShardByDBTableOnMysqlDaoUnitTest {
	...
	public void setUp() throws Exception {
		...
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos1 = new ArrayList<>(2);
		for (int i = 0; i < 6; i++) {
			PeopleShardColModShardByDBTableOnMysql daoPojo = new PeopleShardColModShardByDBTableOnMysql();
	   ...
	   dao.insert(new DalHints(), daoPojos1);
		...
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos2 = new ArrayList<>(2);
		for (int i = 0; i <6; i++) {
			PeopleShardColModShardByDBTableOnMysql daoPojo = new PeopleShardColModShardByDBTableOnMysql();
	...
	private PeopleShardColModShardByDBTableOnMysql createPojo(int index) {
		PeopleShardColModShardByDBTableOnMysql daoPojo = new PeopleShardColModShardByDBTableOnMysql();
	...
	private void changePojo(PeopleShardColModShardByDBTableOnMysql daoPojo) {
		// Change a field to make pojo different with original one
	}
	
	private void changePojos(List<PeopleShardColModShardByDBTableOnMysql> daoPojos) {
		for(PeopleShardColModShardByDBTableOnMysql daoPojo: daoPojos)
			changePojo(daoPojo);
	}
	
	private void verifyPojo(PeopleShardColModShardByDBTableOnMysql daoPojo) {
		//assert changed value
	}
	
	private void verifyPojos(List<PeopleShardColModShardByDBTableOnMysql> daoPojos) {
		for(PeopleShardColModShardByDBTableOnMysql daoPojo: daoPojos)
			verifyPojo(daoPojo);
	}
...
//		dao.test_def_truncate(new DalHints().inShard(1),"_1");
	...
	public void testDelete1() throws Exception {
		PeopleShardColModShardByDBTableOnMysql daoPojo = createPojo(1);
		daoPojo.setID(1);
		daoPojo.setCityID(201);
		daoPojo.setAge(23);
	...
	public void testDelete2() throws Exception {
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos = dao.queryAll(new DalHints().inShard(1).inTableShard(0));
	...
	public void testBatchDelete() throws Exception {
		...
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos = dao.queryAll(new DalHints().inShard(0).inTableShard(1));
	...
	public void testQueryAll() throws Exception {
		List<PeopleShardColModShardByDBTableOnMysql> list = dao.queryAll(new DalHints().inShard(0).inTableShard(0));
	...
	public void testInsert2() throws Exception {
		...
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos = dao.queryAll(new DalHints().inShard(0).inTableShard(0));
	...
	public void testInsert4() throws Exception {
		DalHints hints = new DalHints();
		KeyHolder keyHolder = new KeyHolder();
		List<PeopleShardColModShardByDBTableOnMysql> daoPojos = dao.queryAll(new DalHints().inShard(1).inTableShard(1));
...
//		int pageSize = 100;
//		int pageNo = 1;
		List<PeopleShardColModShardByDBTableOnMysql> list = dao.queryAllByPage(2, 2, new DalHints().inShard(1).inTableShard(0));
	...
	public void testQueryByPk1() throws Exception {
		...
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		PeopleShardColModShardByDBTableOnMysql affected = dao.queryByPk(id,  hints.inShard(1).setTableShardValue(0));
	...
	public void testQueryByPk2() throws Exception {
		PeopleShardColModShardByDBTableOnMysql pk = createPojo(1);
		pk.setID(2);
		DalHints hints = new DalHints();
		PeopleShardColModShardByDBTableOnMysql affected = dao.queryByPk(pk, new DalHints().inShard(0).inTableShard(1));
		assertNotNull(affected);
	...
	public void testUpdate1() throws Exception {
		...
		PeopleShardColModShardByDBTableOnMysql daoPojo1=dao.queryByPk(2, new DalHints().inShard(0).inTableShard(0));
		assertEquals("UpdateByfields_0fields_0", daoPojo1.getName());
		
		daoPojo = new PeopleShardColModShardByDBTableOnMysql();
		daoPojo.setID(3);
		daoPojo.setCityID(200);
		daoPojo.setAge(100);
		daoPojo.setName("UpdateByfields_0fields_0");
	...
	public void testUpdate2() throws Exception {
		...
		PeopleShardColModShardByDBTableOnMysql daoPojo1=dao.queryByPk(1, new DalHints().inShard(0).inTableShard(0));
		daoPojo1.setID(2);
		daoPojo1.setCityID(300);
		daoPojo1.setAge(100);
		PeopleShardColModShardByDBTableOnMysql daoPojo2=dao.queryByPk(1, new DalHints().inShard(1).inTableShard(1));
		daoPojo2.setID(2);
	...
	public void testtest_build_update() throws Exception {
	    ...
	    PeopleShardColModShardByDBTableOnMysql pojo=dao.queryByPk(1, new DalHints().inShard(0).inTableShard(0));
	...
	public void testtest_build_query_listFirst() throws Exception {
		//Integer CityID = null;// Test value here
		//Integer Age = null;// Test value here
	    //PeopleShardColModShardByDBTableOnMysql ret = dao.test_build_query_listFirst(CityID, Age, new DalHints());
		List<Integer> CityID=new ArrayList<>(2);
		CityID.add(200);
		CityID.add(201);
		...
		PeopleShardColModShardByDBTableOnMysql ret = dao.test_build_query_listFirst(CityID, Age, new DalHints().inShard(0).inTableShard(0));
	...
	public void testtest_build_query_list() throws Exception {
		//Integer CityID = null;// Test value here
		//Integer Age = null;// Test value here
	    //List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_build_query_list(CityID, Age, new DalHints());
		List<Integer> CityID=new ArrayList<>(2);
		CityID.add(200);
		CityID.add(201);
		...
		List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_build_query_list(CityID, Age, new DalHints().setShardColValue("CityID", 200).setShardColValue("Age", 20));
...
//			System.out.println("4: "+ret.get(i).getName());
	...
	public void testtest_build_query_listByPage() throws Exception {
		//Integer CityID = null;// Test value here
		//Integer Age = null;// Test value here
	    //List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_build_query_listByPage(CityID, Age, 1, 10, new DalHints());
		List<Integer> CityID=new ArrayList<>(2);
		CityID.add(200);
		CityID.add(201);
		...
		List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_build_query_listByPage(CityID, Age, 2, 1, new DalHints().inShard(0).inTableShard(1));
	...
	public void testtest_build_query_listSingle() throws Exception {
		//Integer CityID = null;// Test value here
		//Integer Age = null;// Test value here
	    //PeopleShardColModShardByDBTableOnMysql ret = dao.test_build_query_listSingle(CityID, Age, new DalHints());
		List<Integer> CityID=new ArrayList<>(2);
		CityID.add(200);
		...
		PeopleShardColModShardByDBTableOnMysql ret = dao.test_build_query_listSingle(CityID, Age, new DalHints().setShardColValue("CityID", 200).setShardColValue("Age", 21));
	...
	public void testtest_build_query_fieldFirst() throws Exception {
		//Integer CityID = null;// Test value here
		//Integer Age = null;// Test value here
	    //PeopleShardColModShardByDBTableOnMysql ret = dao.test_build_query_fieldFirst(CityID, Age, new DalHints());
		List<Integer> CityID=new ArrayList<>(2);
		CityID.add(200);
		CityID.add(201);
	...
	public void testtest_def_query_listFirst() throws Exception {
		...
		PeopleShardColModShardByDBTableOnMysql ret = dao.test_def_query_listFirst(CityID, Age, new DalHints().inShard(0),"_0");
		assertEquals("InsertByfields_0fields_0", ret.getName());
	...
	public void testtest_def_query_list() throws Exception {
		...
		List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_def_query_list(CityID, Age, new DalHints().setShardColValue("CityID", 200),"_0");
		assertEquals(2, ret.size());
...
//			System.out.println("3: "+ret.get(i).getName());
	...
	public void testtest_def_query_listByPage() throws Exception {
		...
		List<PeopleShardColModShardByDBTableOnMysql> ret = dao.test_def_query_listByPage(CityID, Age, 2, 1, new DalHints().inShard(0),"_1");
		assertEquals("InsertByfields_0fields_3", ret.get(0).getName());
	}
	...
	public void testtest_def_query_listSingle() throws Exception {
		...
		PeopleShardColModShardByDBTableOnMysql ret = dao.test_def_query_listSingle(CityID, Age, new DalHints().setShardColValue("CityID", 200),"_1");
		assertEquals("InsertByfields_0fields_1", ret.getName());
