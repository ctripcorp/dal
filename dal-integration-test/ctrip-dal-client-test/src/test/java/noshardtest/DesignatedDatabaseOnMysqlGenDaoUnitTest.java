...
import dao.noshard.DesignatedDatabaseOnMysqlGenDao;
...
//		List<MysqlPersonTable> ret=dao.test_def_query_nonexistentColumn(new DalHints().inDatabase("DalService2DB_W"));
//		assertNull(ret);
//	}
}
