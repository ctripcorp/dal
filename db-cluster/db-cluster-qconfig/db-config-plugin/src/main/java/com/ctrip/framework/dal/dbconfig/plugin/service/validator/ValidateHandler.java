...
public class ValidateHandler {
    ...
    //=== Constructor ===
    public ValidateHandler(Properties pluginProp, Properties keyProp, String clientAppId, String clientIp, String env, boolean fromPublicNet) {
...
//        Preconditions.checkArgument(!Strings.isNullOrEmpty(clientIp), "clientIp不能为空");
        ...
        // create validator
        ClientRequestContext requestContext = new ClientRequestContext(clientAppId, clientIp, env, fromPublicNet);
        Step1KeyEnabledValidator step1KeyEnabledValidator = new Step1KeyEnabledValidator(keyProp);
        Step2PermissionSwitchValidator step2PermissionSwitchValidator = new Step2PermissionSwitchValidator(pluginProp, keyProp, requestContext);
        ...
        Step5AppIdIpCheckServiceValidator step5AppIdIpCheckServiceValidator = new Step5AppIdIpCheckServiceValidator(pluginProp, keyProp, requestContext);
