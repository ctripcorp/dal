...
//		builder.range(start, count)
    ...
    public MysqlPersonExtendsUpdatableEntity test_query_first_with_requireFirst(List<Integer> Age, DalHints hints) throws SQLException {
        hints = DalHints.createIfAbsent(hints);
        ...
        builder.orderBy("ID", true);
        builder.requireFirst();
        return client.queryFirst(builder, hints);
    }

    public MysqlPersonExtendsUpdatableEntity test_query_first_without_requireFirst(List<Integer> Age, DalHints hints) throws SQLException {
        hints = DalHints.createIfAbsent(hints);
