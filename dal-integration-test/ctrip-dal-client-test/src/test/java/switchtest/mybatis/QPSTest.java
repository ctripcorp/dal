...
//        poolPropertiesSwitch.resetPoolProperties();
    ...
    public void getCountInTable() throws Exception {
        DalClientFactory.shutdownFactory();
        DalClientFactory.initClientFactory(this.getClass().getClassLoader().getResource(".").getPath() + "DalConfigForQPSTest/Dal.config");
...
//        System.exit(-1);
    ...
    public void test() throws Exception{
       String path= this.getClass().getClassLoader().getResource(".").getPath() + "DalConfigForQPSTest/Dal.config";
