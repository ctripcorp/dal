...
public class SimpleShardByDBOnSqlServerGenDaoUnitTest {
	...
	public void setUp() throws Exception {
		...
		List<SimpleShardByDBOnSqlServerGen> daoPojos1 = new ArrayList<SimpleShardByDBOnSqlServerGen>(
				3);
		for (int i = 0; i < 3; i++) {
			SimpleShardByDBOnSqlServerGen daoPojo = new SimpleShardByDBOnSqlServerGen();
		...
		List<SimpleShardByDBOnSqlServerGen> daoPojos2 = new ArrayList<SimpleShardByDBOnSqlServerGen>(
				3);
		for (int i = 0; i < 3; i++) {
			SimpleShardByDBOnSqlServerGen daoPojo = new SimpleShardByDBOnSqlServerGen();
			daoPojo.setPeopleID(Long.valueOf(i) + 1);
	...
	public void testDelete1() throws Exception {
		...
		Number id = 1l;
		SimpleShardByDBOnSqlServerGen ret1 = dao.queryByPk(id,
				new DalHints().inShard(0));
		assertNull(ret1);

		ret = dao.delete(new DalHints().inShard(1), daoPojo);
		// assertEquals(1, ret);
		SimpleShardByDBOnSqlServerGen ret2 = dao.queryByPk(id,
	...
	public void testGetAll() throws Exception {
		List<SimpleShardByDBOnSqlServerGen> list = dao.getAll(new DalHints()
				.inShard(0));
	...
	public void testQueryByPage() throws Exception {
		int pageSize = 2;
		int pageNo = 1;
		List<SimpleShardByDBOnSqlServerGen> list = dao.queryByPage(pageSize,
	...
	public void testQueryByPk1() throws Exception {
		Number id = 1l;
		SimpleShardByDBOnSqlServerGen ret = dao.queryByPk(id,
				new DalHints().inShard(0));
	...
	public void testQueryByPk2() throws Exception {
		SimpleShardByDBOnSqlServerGen pk = new SimpleShardByDBOnSqlServerGen();
		pk.setPeopleID(1l);
		SimpleShardByDBOnSqlServerGen ret = dao.queryByPk(pk,
				new DalHints().inShard(0));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testUpdate2() throws Exception {
		...
		Long peopleID = 1l;
		SimpleShardByDBOnSqlServerGen ret1 = dao.queryByPk(peopleID,
				new DalHints().inShard(0));
		assertEquals("Update_Shard_00", ret1.getName());

		peopleID = 2l;
		SimpleShardByDBOnSqlServerGen ret2 = dao.queryByPk(peopleID,
				new DalHints().inShard(0));
		...
		peopleID = 1l;
		SimpleShardByDBOnSqlServerGen ret4 = dao.queryByPk(peopleID,
				new DalHints().inShard(1));
		assertEquals("Update_Shard_10", ret4.getName());

		peopleID = 2l;
		SimpleShardByDBOnSqlServerGen ret5 = dao.queryByPk(peopleID,
				new DalHints().inShard(1));
	...
	public void testtest_build_query_pojoFirst() throws Exception {
		// Integer CityID = null;// Test value here
		// PeopleSimpleShardByDBOnSqlServerGen ret =
		// dao.test_build_query_pojoFirst(CityID, new DalHints());
		List<Integer> CityID = new ArrayList<Integer>(2);// Test value here
		CityID.add(20);
		CityID.add(21);
		SimpleShardByDBOnSqlServerGen ret = dao.test_build_query_pojoFirst(
	...
	public void testtest_build_query_pojoList() throws Exception {
		// Integer CityID = null;// Test value here
		// List<PeopleSimpleShardByDBOnSqlServerGen> ret =
		// dao.test_build_query_pojoList(CityID, new DalHints());

		List<Integer> CityID = new ArrayList<Integer>(2);// Test value here
		CityID.add(20);
		CityID.add(21);
		List<SimpleShardByDBOnSqlServerGen> ret = dao
	...
	public void testtest_build_query_pojoSingle() throws Exception {
		...
		CityID.add(20);
		CityID.add(24);
		SimpleShardByDBOnSqlServerGen ret = dao.test_build_query_pojoSingle(
	...
	public void testtest_def_query_pojoFirst() throws Exception {
		...
		CityID.add(20);
		CityID.add(21);
		SimpleShardByDBOnSqlServerGen ret = dao.test_def_query_pojoFirst(
				CityID, new DalHints().inAllShards());
		assertNotNull(ret);
	...
	public void testtest_def_query_pojoList() throws Exception {
		...
		CityID.add(20);
		CityID.add(21);
		List<SimpleShardByDBOnSqlServerGen> ret = dao.test_def_query_pojoList(
				CityID, new DalHints().inAllShards());
		assertEquals(4, ret.size());
	...
	public void testtest_def_query_pojoSingle() throws Exception {
		...
		CityID.add(20);
		CityID.add(24);
		SimpleShardByDBOnSqlServerGen ret = dao.test_def_query_pojoSingle(
				CityID, new DalHints().inShard(0));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_build_update_equal() throws Exception {
		...
		int ret = dao.test_build_update_equal(Name, CityID, new DalHints()
				.inAllShards().sequentialExecute());
		// assertEquals(-2, ret);
		SimpleShardByDBOnSqlServerGen pojo = dao.queryByPk(1,
				new DalHints().inShard(0));
	...
	public void testtest_build_query_equal() throws Exception {
		Integer CityID = 20;// Test value here
		List<SimpleShardByDBOnSqlServerGen> ret = dao.test_build_query_equal(
	...
	public void testtest_def_query_equal() throws Exception {
		...
		// hints1.inShard(0);
		Integer CityID = 20;
		List<SimpleShardByDBOnSqlServerGen> ret1 = dao.test_def_query_equal(
		...
		// hints2.inShard(1);
		CityID = 22;
		List<SimpleShardByDBOnSqlServerGen> ret2 = dao.test_def_query_equal(
	...
	public void testtest_def_query_page() throws Exception {
		...
		int pageSize = 2;
		Integer CityID = 19;
		List<SimpleShardByDBOnSqlServerGen> ret1 = dao.def_query_page(CityID,
