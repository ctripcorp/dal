...
public class AbacusParaGenDaoTest {
	public static void main(String[] args) {
		...
		try {
			...
			**/
			...
			AbacusParaGenDao dao = new AbacusParaGenDao();
		
			AbacusParaGen pk = dao.queryByPk(null);// you value here
			
			pk = dao.queryByPk(pk);
			List<AbacusParaGen> pojos = dao.queryByPage(pk, 100, 0);
