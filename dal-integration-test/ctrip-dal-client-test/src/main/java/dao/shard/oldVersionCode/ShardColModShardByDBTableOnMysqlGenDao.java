...
public class ShardColModShardByDBTableOnMysqlGenDao {
	...
	private DalParser<MysqlPeopleTable> parser = null;
	...
	public ShardColModShardByDBTableOnMysqlGenDao() throws SQLException {
		parser = new DalDefaultJpaParser<>(MysqlPeopleTable.class,DATA_BASE);
		this.client = new DalTableDao<MysqlPeopleTable>(parser);
	...
	**/
	public List<MysqlPeopleTable> queryByPage(int pageSize, int pageNo, DalHints hints)  throws SQLException {
	...
	**/
	public List<MysqlPeopleTable> getAll(DalHints hints) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		List<MysqlPeopleTable> result = null;
