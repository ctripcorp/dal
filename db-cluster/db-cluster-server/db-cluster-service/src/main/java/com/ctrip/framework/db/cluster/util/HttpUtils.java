...
public class HttpUtils {
    ...
    public String sendPost(String url, String message) throws Exception {
        Map<String, String> headers = Maps.newHashMapWithExpectedSize(1);
        headers.put("Content-Type", "application/json");
        return sendPost(url, headers, null, message, DEFAULT_TIMEOUT_MS);
    }
    ...
    public String sendPost(String url, List<NameValuePair> urlParams, String message, int timeout) throws Exception {
        Map<String, String> headers = Maps.newHashMapWithExpectedSize(1);
        headers.put("Content-Type", "application/json");
        return sendPost(url, headers, urlParams, message, timeout);
    }
    ...
    public String sendGet(String url, List<NameValuePair> urlParams, int timeout) throws Exception {
        Map<String, String> headers = Maps.newHashMapWithExpectedSize(1);
        headers.put("Content-Type", "application/json");
        return sendGet(url, headers, urlParams, timeout);
    }
