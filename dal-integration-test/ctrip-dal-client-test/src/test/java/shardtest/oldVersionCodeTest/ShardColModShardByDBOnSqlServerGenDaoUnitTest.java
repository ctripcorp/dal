...
import dao.shard.oldVersionCode.ShardColModShardByDBOnSqlServerGenDao;
...
public class ShardColModShardByDBOnSqlServerGenDaoUnitTest {
	...
	public void testGetAll() throws Exception {
		List<SqlServerPeopleTable> list = dao
	...
	public void testQueryByPage() throws Exception {
		int pageSize = 2;
		int pageNo = 1;
		List<SqlServerPeopleTable> list = dao.queryByPage(
	...
	public void testtest_def_update_in() throws Exception {
		...
		SqlServerPeopleTable pojo = dao.queryByPk(1l,
				new DalHints().inShard(0));
