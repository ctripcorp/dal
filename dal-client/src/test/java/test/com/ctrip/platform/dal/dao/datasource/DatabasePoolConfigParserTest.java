...
public class DatabasePoolConfigParserTest {
    ...
    @Test
    public void test1() {
        DataSourceConfigure config = DataSourceConfigureParser.getInstance().getDataSourceConfigure("dao_test");
    ...
    @Test
    public void test2() {
        DataSourceConfigure config = DataSourceConfigureParser.getInstance().getDataSourceConfigure("dao_test_select");
    ...
    @Test
    public void test3() {
        DataSourceConfigure config = DataSourceConfigureParser.getInstance().getDataSourceConfigure("dal_test_new");
