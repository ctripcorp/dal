 ...
 */
public class AutoTestForConnectionStringFat16 {
    ...
    private static Logger log = LoggerFactory.getLogger(AutoTestForConnectionStringFat16.class);
    ...
    private String databaseSet2 = "shardTestOnMysql";
