...
public class HintsOfCodeGenOnSqlServerDao {
	...
	private DalRowMapper<SqlServerPeopleTable> peopleGenSimpleShardBySqlServerLljRowMapper = null;
	
	public HintsOfCodeGenOnSqlServerDao() throws SQLException {
		this.peopleGenSimpleShardBySqlServerLljRowMapper = new DalDefaultJpaMapper(SqlServerPeopleTable.class);
	...
	public List<SqlServerPeopleTable> testBaseClient() throws SQLException{
...
//		list.add(20);
		...
		List<SqlServerPeopleTable> ret =baseClient.query(sql, parameters, new DalHints().inShard(0), new DalRowMapperExtractor<>(this.parser));
...
//		assertNotNull(promotionPos);
	...
	**/
	 ...
	 * ��������ѯ
	**/
	public List<SqlServerPeopleTable> test_build_query_allShard_callback(Integer CityID, DalHints hints, DalResultCallback callback) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		hints.inAllShards();
	 ...
	 * ��������ѯ
	**/
	public List<SqlServerPeopleTable> test_build_query_shards_async(Integer CityID, DalHints hints, Set<String> shards) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	 ...
	 * 构建，查询
	**/
	public List<SqlServerPeopleTable> test_def_query_allShard_callback(Integer CityID, DalHints hints, DalResultCallback callback) throws SQLException {
		...
		int i = 1;
		parameters.set(i++, "CityID", Types.INTEGER, CityID);
		return (List<SqlServerPeopleTable>)queryDao.query(sql, parameters, hints, peopleGenSimpleShardBySqlServerLljRowMapper);
	}
	/**
	 * 构建，查询
	**/
	public List<SqlServerPeopleTable> test_def_query_shards_async(Integer CityID, DalHints hints, Set<String> shards) throws SQLException {
		String sql = "select * from People with(nolock) where CityID=?";
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		hints.inShards(shards);
