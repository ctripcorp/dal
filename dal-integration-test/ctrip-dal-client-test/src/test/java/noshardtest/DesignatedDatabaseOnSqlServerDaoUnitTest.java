...
import dao.noshard.DesignatedDatabaseOnSqlServerDao;
...
//		assertEquals(1, affected);
	...
	public void testDelete2() throws Exception {
		...
		List<SqlServerPeopleTable> daoPojos = dao.queryAll(new DalHints().inDatabase("DalService1DB"));
...
//		assertArrayEquals(new int[]{1,1,1},  affected);
	...
	public void testQueryAll() throws Exception {
		List<SqlServerPeopleTable> ret=dao.queryAll(new DalHints().inDatabase("DalServiceDB"));
...
//		int affected = dao.insert(new DalHints().inDatabase("DalServiceDB"), daoPojo);
		...
		Number id = 4l;
		SqlServerPeopleTable ret1 = dao.queryByPk(id, new DalHints().inDatabase("DalServiceDB"));
		assertNotNull(ret1);
		...
		SqlServerPeopleTable ret2 = dao.queryByPk(id, new DalHints().inDatabase("DalService1DB"));
		assertNotNull(ret2);
	}
	...
	public void testInsert2() throws Exception {
		...
		List<SqlServerPeopleTable> daoPojos = dao.queryAll(new DalHints().inDatabase("DalServiceDB"));
...
//		assertArrayEquals(new int[]{1,1,1,1,1,1},  affected);
	...
	public void testQueryAllByPage() throws Exception {
		List<SqlServerPeopleTable> ret=dao.queryAllByPage(2, 1, new DalHints().inDatabase("DalServiceDB"));
	...
	public void testQueryByPk1() throws Exception {
		Number id = 1l;
		SqlServerPeopleTable ret = dao.queryByPk(id, new DalHints().inDatabase("DalServiceDB"));
...
//		assertEquals("Initial_Shard_11", ret.getName());
	...
	public void testQueryByPk2() throws Exception {
		...
		pk.setPeopleID(1l);
		SqlServerPeopleTable ret = dao.queryByPk(pk, new DalHints().inDatabase("DalServiceDB"));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testQueryLike() throws Exception {
		...
		List<SqlServerPeopleTable> ret=dao.queryLike(sample, new DalHints().inDatabase("DalServiceDB"));
...
//		assertEquals(1, affected);
		...
		SqlServerPeopleTable ret=dao.queryByPk(1, new DalHints().inDatabase("DalServiceDB"));
...
//		name列赋值
		...
		SqlServerPeopleTable ret=dao.queryByPk(1, new DalHints().inDatabase("DalService1DB"));
	...
	public void testtest_build_delete() throws Exception {
		...
		List<SqlServerPeopleTable> pojos=dao.queryAll(new DalHints().inDatabase("DalServiceDB"));
...
//		assertEquals(0, pojos.size());
	...
	public void testtest_build_queryEqual() throws Exception {
		Integer cityID=20;
		List<SqlServerPeopleTable> ret=dao.test(cityID, new DalHints().inDatabase("DalServiceDB"));
		assertEquals(1, ret.size());
	}
...
//	    assertEquals(1, ret);
	   ...
	   SqlServerPeopleTable pojo=dao.queryByPk(4, new DalHints().inDatabase("DalServiceDB"));
	...
	public void testtest_build_update() throws Exception {
	   ...
	   SqlServerPeopleTable pojo=dao.queryByPk(1, new DalHints().inDatabase("DalServiceDB"));
	...
	public void testtest_build_query_first() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_query_first(CityID, new DalHints().inDatabase("DalService1DB"));
	...
	public void testtest_build_queryPartial_first() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_queryPartial_first(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals("Initial_Shard_13", ret.getName());
	...
	public void testtest_build_query_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_query_list(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals(1, ret.size());
	...
	public void testtest_build_queryPartial_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_queryPartial_list(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals(1, ret.size());
	...
	public void testtest_build_query_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
	    List<SqlServerPeopleTable> ret = dao.test_build_query_listByPage(CityID, 2, 1, new DalHints().inDatabase("DalServiceDB"));
	    assertEquals("Initial_Shard_02", ret.get(0).getName());
	...
	public void testtest_build_queryPartial_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
	    List<SqlServerPeopleTable> ret = dao.test_build_queryPartial_listByPage(CityID, 2, 1, new DalHints().inDatabase("DalServiceDB"));
	    assertEquals("Initial_Shard_02", ret.get(0).getName());
	    assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_build_query_single() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_query_single(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals("Initial_Shard_13", ret.getName());
	...
	public void testtest_build_queryPartial_single() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_queryPartial_single(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals("Initial_Shard_13", ret.getName());
	    assertNull(ret.getPeopleID());
...
//	}
	...
	public void testtest_def_query_listFirst() throws Exception {
		...
		SqlServerPeopleTable ret = dao.test_def_query_listFirst(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals("Initial_Shard_11", ret.getName());
...
//	    assertEquals(3, ret.size());
		...
		List<SqlServerPeopleTable> ret = dao.test_def_query_list(CityID, new DalHints().inDatabase("DalService1DB"));
	    assertEquals(1, ret.size());
