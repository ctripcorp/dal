...
public class DataSourceUtil {
    ...
    public static Connection getConnection(String address, String port, String userName, String password, String driverClass) throws SQLException {
    ...
    private static DataSource createDataSource(String address, String port, String userName, String password, String driverClass) throws SQLException {
        String url = "";
    ...
    private static DataSource createDataSource(String address, String port, String catalog, String userName, String password, String driverClass) throws SQLException {
        String url = "";
        String driver = getDriverClass(driverClass);
        if (DRIVER_MYSQL.equals(driver)) {
    ...
    private static DataSource createDataSource(String url, String userName, String password, String driverClass) throws SQLException {
    ...
    private static void validateParam(String address, String port, String userName, String password, String driverClass) throws SQLException {
        if (isEmpty(address)) {
    ...
    private static void validateParam(String allInOneName, String address, String port, String catalog, String userName, String password, String driverClass) throws SQLException {
        if (isEmpty(address)) {
