...
import com.ctrip.sysdev.das.server.AbstractServer;
import com.ctrip.sysdev.das.server.NettyServer;
import com.ctrip.sysdev.das.server.Server;
 ...
 * 
 */
public class DASService extends AbstractServer {

	private static final Logger logger = LoggerFactory
			.getLogger(DASService.class);
	...
	public static void main(String[] args) {
		DASService server = new DASService();
		server.startUp();
	}
