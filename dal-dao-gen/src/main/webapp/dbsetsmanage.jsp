...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Update databaseSet
						Entry</h4>
				</div>
				<div class="modal-body">
					...
					<div class="row-fluid">
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">Entry
								Name:</label> <input id="dbsetentryname2" class="span8 input-sm"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">Add databaseSet
						Entry</h4>
				</div>
				<div class="modal-body">
					<div class="row-fluid">
					...
					<div class="row-fluid">
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">Entry
								Name:</label> <input id="dbsetentryname" class="span8 input-sm"
								type="text" style="height: 30px">
						</div>
					</div>
					<div class="row-fluid">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">Add databaseSet</h4>
				</div>
				<div class="modal-body">
					<div class="row-fluid">
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">databaseSet
								Name:</label> <input id="dbsetname" class="span8 input-sm" type="text"
								style="height: 30px">
						</div>
					</div>
					<div class="row-fluid">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					<button id="save_adddbset" type="button" class="btn btn-primary">Save
						changes</button>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row-fluid">
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">databaseSet
								Name:</label> <input id="dbsetname2" class="span8 input-sm" type="text"
								style="height: 30px">
						</div>
					</div>
					<div class="row-fluid">
				...
				<div class="modal-footer">
					<label id="updatedbset_error_msg" class="control-label popup_label"
						style="color: red;"></label>
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					<button id="save_updatedbset" type="button" class="btn btn-primary">Save
						changes</button>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">Config Template</h4>
				</div>
				<div class="modal-body">
					<div class="row-fluid">
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">Config
								Type:</label> <select id="configType" class="span8">
							</select>
						</div>
						<div class="control-group">
							<label class="control-label popup_label" style="width: 130px;">Language:</label>
	...
	<script src="/static/js/dbsetsmanage.js?codegen=${codegenpageflag}"></script>
