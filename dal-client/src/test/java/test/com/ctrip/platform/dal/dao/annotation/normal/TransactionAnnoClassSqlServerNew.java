...
@Component("TransactionAnnoClassSqlServerNew")
public class TransactionAnnoClassSqlServerNew extends BaseTransactionAnnoClass {
    ...
    public TransactionAnnoClassSqlServerNew() {
