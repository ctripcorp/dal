...
public class AbacusCancelPNRLogGenDao {
	private static final String DATA_BASE = "AbacusDB_INSERT_1";
	private static final String COUNT_SQL_PATTERN = "SELECT count(1) from AbacusCancelPNRLog";
	private static final String ALL_SQL_PATTERN = "SELECT * FROM AbacusCancelPNRLog";
	private static final String PAGE_SQL_PATTERN = "WITH CTE AS (select *, row_number() over(order by LogID desc ) as rownum" 
			+" from AbacusCancelPNRLog (nolock)) select * from CTE where rownum between %s and %s";

	private static final String INSERT_SP_NAME = "spA_AbacusCancelPNRLog_i";
	private static final String DELETE_SP_NAME = "spA_AbacusCancelPNRLog_d";
	private static final String UPDATE_SP_NAME = "spA_AbacusCancelPNRLog_u";
	private static final String RET_CODE = "retcode";
	private static final String UPDATE_COUNT = "update_count";
	
	private DalParser<AbacusCancelPNRLogGen> parser = new AbacusCancelPNRLogGenParser();
	private DalScalarExtractor extractor = new DalScalarExtractor();
	private DalRowMapperExtractor<AbacusCancelPNRLogGen> rowextractor = null;
	private DalTableDao<AbacusCancelPNRLogGen> client;
	private DalClient baseClient;

	public AbacusCancelPNRLogGenDao() {
		this.client = new DalTableDao<AbacusCancelPNRLogGen>(parser);
		this.rowextractor = new DalRowMapperExtractor<AbacusCancelPNRLogGen>(parser); 
		this.baseClient = DalClientFactory.getClient(DATA_BASE);
	}

	public AbacusCancelPNRLogGen queryByPk(Number id)
			throws SQLException {
		DalHints hints = new DalHints();
		return client.queryByPk(id, hints);
	}

	public AbacusCancelPNRLogGen queryByPk(AbacusCancelPNRLogGen pk)
			throws SQLException {
		DalHints hints = new DalHints();
	...
	public List<AbacusCancelPNRLogGen> queryByPage(AbacusCancelPNRLogGen pk, int pageSize, int pageNo)  throws SQLException {
	...
	public List<AbacusCancelPNRLogGen> getAll() throws SQLException
	{
		StatementParameters parameters = new StatementParameters();
		DalHints hints = new DalHints();
		List<AbacusCancelPNRLogGen> result = null;
		result = this.baseClient.query(ALL_SQL_PATTERN, parameters, hints, rowextractor);
		return result;
	}

	public int insert(AbacusCancelPNRLogGen daoPojo) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		DalHints hints = new DalHints();
	...
	public int delete(AbacusCancelPNRLogGen daoPojo) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		DalHints hints = new DalHints();
	...
	public int update(AbacusCancelPNRLogGen daoPojo) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		DalHints hints = new DalHints();
	...
	private static class AbacusCancelPNRLogGenParser extends AbstractDalParser<AbacusCancelPNRLogGen> {
		public static final String DATABASE_NAME = "AbacusDB_INSERT_1";
		public static final String TABLE_NAME = "AbacusCancelPNRLog";
		...
		public AbacusCancelPNRLogGenParser() {
			super(DATABASE_NAME, TABLE_NAME, COLUMNS, PRIMARY_KEYS, COLUMN_TYPES);
		}
		
		@Override
		public AbacusCancelPNRLogGen map(ResultSet rs, int rowNum) throws SQLException {
			AbacusCancelPNRLogGen pojo = new AbacusCancelPNRLogGen();
		...
		@Override
		public Number getIdentityValue(AbacusCancelPNRLogGen pojo) {
			return pojo.getLogID();
		}
	
		@Override
		public Map<String, ?> getPrimaryKeys(AbacusCancelPNRLogGen pojo) {
		...
		@Override
		public Map<String, ?> getFields(AbacusCancelPNRLogGen pojo) {
