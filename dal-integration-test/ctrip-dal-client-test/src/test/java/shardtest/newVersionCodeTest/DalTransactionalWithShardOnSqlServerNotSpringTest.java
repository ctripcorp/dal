...
import dao.shard.newVersionCode.DalTransactionalWithShardOnSqlServerDao;
 ...
 */
public class DalTransactionalWithShardOnSqlServerNotSpringTest {
    private static DalTransactionalWithShardOnSqlServerDao dao;

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {

        dao= DalTransactionManager.create(DalTransactionalWithShardOnSqlServerDao.class);
//        dao=new SqlServerPeopleTableDao();
    }
...
//		dao.test_def_update(new DalHints());
    ...
    public void transWithStringShardIDWithoutDalHintsTest() throws Exception{
        //@dao.noshardtest.shardtest 传入null
        try{
            dao.transWithStringShardIDWithoutDalHints(null);
            fail();
        }catch (Exception e){}

        //@dao.noshardtest.shardtest 传入string
    ...
    public void transWithIntegerShardIDWithoutDalHintsTest() throws Exception{
        //integer @dao.noshardtest.shardtest 传入null
        try{
            dao.transWithIntegerShardIDWithoutDalHints(null);
            fail();
        }catch (Exception e){}

        //integer @dao.noshardtest.shardtest 传入interger
    ...
    public void transWithStringShardIDWithDalHintsTest() throws Exception{
        //string dao.noshardtest.shardtest, different int shardid in dalhints
        try{
        ...
        //string dao.noshardtest.shardtest, different string shardid in dalhints
        try{
            dao.transWithStringShardIDWithDalHints("0",new DalHints().inShard("1"));
            fail();
        }catch (Exception e){}
        ...
        //string dao.noshardtest.shardtest, null hints
        ...
        //string dao.noshardtest.shardtest, same int shardid in dalhints
        dao.transWithStringShardIDWithDalHints("0",new DalHints().inShard(0));
        assertEquals("transWithStringShardIDWithDalHints",dao.queryByPk(1,new DalHints().inShard(0).inTableShard(0)).getName());
        assertEquals(2,dao.count(new DalHints().inShard(0).inTableShard(1)));

        //string dao.noshardtest.shardtest, same string shardid in dalhints
    ...
    public void transWithIntegerShardIDWithDalHintsTest() throws Exception{
        //Integer dao.noshardtest.shardtest, different int shardid in dalhints
        try{
        ...
        //Integer dao.noshardtest.shardtest, different string shardid in dalhints
        try{
            dao.transWithIntegerShardIDWithDalHints(Integer.valueOf(0),new DalHints().inShard("1"));
            fail();
        }catch (Exception e){}
        ...
        //Integer dao.noshardtest.shardtest, null hints
        ...
        //Integer dao.noshardtest.shardtest, same int shardid in dalhints
        dao.transWithIntegerShardIDWithDalHints(Integer.valueOf(0),new DalHints().inShard(0));
        assertEquals("transWithIntegerShardIDWithDalHints",dao.queryByPk(1,new DalHints().inShard(0).inTableShard(0)).getName());
        assertEquals(2,dao.count(new DalHints().inShard(0).inTableShard(1)));

        //Integer dao.noshardtest.shardtest, same string shardid in dalhints
    ...
    public void transWithNullStringShardIDWithDalHintsTest() throws Exception{
        //null string dao.noshardtest.shardtest, null hints
        try {
            dao.transWithStringShardIDWithDalHints(null, new DalHints());
            fail();
        }catch (Exception e){}

        //null string dao.noshardtest.shardtest, int shardid in dalhints
        dao.transWithStringShardIDWithDalHints(null,new DalHints().inShard(0));
        assertEquals("transWithStringShardIDWithDalHints",dao.queryByPk(1,new DalHints().inShard(0).inTableShard(0)).getName());
        assertEquals(2,dao.count(new DalHints().inShard(0).inTableShard(1)));

        //null dao.noshardtest.shardtest, string shardid in dalhints
    ...
    public void transWithNullIntegerShardIDWithDalHintsTest() throws Exception{
        //null Integer dao.noshardtest.shardtest, null hints
        try {
            dao.transWithIntegerShardIDWithDalHints(null, new DalHints());
            fail();
        }catch (Exception e){}

        //null Integer dao.noshardtest.shardtest, int shardid in dalhints
    ...
    public void transWithIntShardIDWithDalHintsTest() throws Exception{
        //int dao.noshardtest.shardtest, null hints
        ...
        //int dao.noshardtest.shardtest, different string shardid in dalhints
        try{
            dao.transWithIntShardIDWithDalHints(0,new DalHints().inShard("1"));
            fail();
        }catch (Exception e){}
        ...
        //int dao.noshardtest.shardtest, same int shardid in dalhints
        dao.transWithIntShardIDWithDalHints(0,new DalHints().inShard(0));
        assertEquals("transWithIntShardIDWithDalHints",dao.queryByPk(1,new DalHints().inShard(0).inTableShard(0)).getName());
        assertEquals(2,dao.count(new DalHints().inShard(0).inTableShard(1)));

        //int dao.noshardtest.shardtest, same string shardid in dalhints
    ...
    public void transWithStringShardIDVSNestStringHintsTest() throws Exception{
        ...
        //@dao.noshardtest.shardtest 传null
        try {
