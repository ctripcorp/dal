...
//		assertArrayEquals(new int[]{-2,-2},  affected);
	...
	public void testBuildQueryLikeWithMatchPattern() throws Exception {
		List<PeopleShardColModShardByDBOnSqlServer> ret = dao.testBuildQueryLikeWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
		assertEquals(1, ret.size());
	...
	public void testBuildQueryLikeNullableWithMatchPattern() throws Exception {
		List<PeopleShardColModShardByDBOnSqlServer> ret = dao.testBuildQueryLikeNullableWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
		assertEquals(1, ret.size());
