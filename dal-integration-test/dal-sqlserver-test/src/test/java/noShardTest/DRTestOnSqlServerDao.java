...
//	DRTestOnSqlServer test =new DRTestOnSqlServer();
//	Thread.sleep(15000);
        DalClientFactory.shutdownFactory();
        DalClientFactory.initClientFactory(DRTestOnSqlServerDao.class.getClassLoader().getResource(".").getPath() + "DalConfig/Dal.config");
//	Thread.sleep(15000);
        DalClientFactory.shutdownFactory();
        System.exit(-1);
    }
