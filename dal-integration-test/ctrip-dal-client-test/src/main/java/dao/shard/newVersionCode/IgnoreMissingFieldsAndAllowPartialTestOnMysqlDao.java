...
public class IgnoreMissingFieldsAndAllowPartialTestOnMysqlDao {
	...
	private DalRowMapper<MysqlPersonTableWithDiffColumns> personShardColModShardByDBOnMysqlPojoRowMapper = null;
	...
	public IgnoreMissingFieldsAndAllowPartialTestOnMysqlDao() throws SQLException {
		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(MysqlPersonTableWithDiffColumns.class,DATA_BASE));
		this.personShardColModShardByDBOnMysqlPojoRowMapper = new DalDefaultJpaMapper<>(MysqlPersonTableWithDiffColumns.class);
		this.queryDao = new DalQueryDao(DATA_BASE);
	}

	
	private class PersonShardColModShardByDBOnMysqlComparator implements Comparator<MysqlPersonTableWithDiffColumns>{
		@Override
...
//	
	...
	/**
	 * Query MysqlPersonTableWithDiffColumns by the specified ID
	...
	**/
	...
	/**
	 * Query MysqlPersonTableWithDiffColumns by MysqlPersonTableWithDiffColumns instance which the primary key is set
	**/
	...
	**/
	public List<MysqlPersonTableWithDiffColumns> queryLike(MysqlPersonTableWithDiffColumns sample, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	/**
	 * Query MysqlPersonTableWithDiffColumns with paging function
	 * The pageSize and pageNo must be greater than zero.
	 */
	public List<MysqlPersonTableWithDiffColumns> queryAllByPage(int pageNo, int pageSize, DalHints hints)  throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<MysqlPersonTableWithDiffColumns> queryAll(DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	 ...
	 * 构建，查询
	**/
	public List<MysqlPersonTableWithDiffColumns> test_build_query_list(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.selectAll();
	 ...
	 * 构建，查询部分字段
	**/
	public List<MysqlPersonTableWithDiffColumns> test_build_queryPartial_list(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.selectAll();
	 ...
	 * 构建，查询
	**/
	public List<MysqlPersonTableWithDiffColumns> test_build_query_listByPage(List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.range(start, count)
	 ...
	 * 构建，查询部分字段
	**/
	public List<MysqlPersonTableWithDiffColumns> test_build_queryPartial_listByPage(List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.range(start, count)
	...
	**/
	 ...
	 * 构建，查询部分字段
	**/
	public MysqlPersonTableWithDiffColumns test_build_queryPartial_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.and();
	 ...
	 * 构建，查询
	**/
	public MysqlPersonTableWithDiffColumns test_build_queryPartial_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.and();
	 ...
	 * testEqual
	**/
	public List<MysqlPersonTableWithDiffColumns> test(Integer param1, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.equalNullable(field, paramValue, sqlType)
	...
	**/
	public List<MysqlPersonTableWithDiffColumns> test_def_query_list(List<Integer> Age, DalHints hints) throws SQLException {
		...
		FreeSelectSqlBuilder<List<MysqlPersonTableWithDiffColumns>> builder = new FreeSelectSqlBuilder<>(dbCategory);
...
//		columns.add("Name");
	 ...
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryPartialSet_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<MysqlPersonTableWithDiffColumns> builder = new FreeSelectSqlBuilder<>(dbCategory);
		builder.setTemplate("select * from person where Age in (?)");
		StatementParameters parameters = new StatementParameters();
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		...
		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints.partialQuery(columns));
	}
	
	/**
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryPartialStrings_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		...
		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints.partialQuery("Age","Name"));
	}
	
	/**
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_query_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		...
		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints);
	}
	
	/**
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryIgnoreMissingFields_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		...
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		builder.mapWith(personShardColModShardByDBOnMysqlPojoRowMapper).requireSingle().nullable();
		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints.partialQuery("Name", "ID", "Birth", "Age").sortBy(new PersonShardColModShardByDBOnMysqlComparator()));
	}
	
	/**
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryAllowPartial_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		...
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		builder.mapWith(personShardColModShardByDBOnMysqlPojoRowMapper).requireSingle().nullable();
		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints.sortBy(new PersonShardColModShardByDBOnMysqlComparator()));
	}

	/**
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_query_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryIgnoreMissingFields_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints);
	 ...
	 * 自定义，查询
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryAllowPartial_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 自定义，查询部分字段
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryPartialSet_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 自定义，查询部分字段
	**/
	public MysqlPersonTableWithDiffColumns test_def_queryPartialStrings_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		return (MysqlPersonTableWithDiffColumns)queryDao.query(builder, parameters, hints);
	...
	**/
	 ...
	 * 自定义 ，查询，list<string>
	**/
	public List<MysqlPersonTableWithDiffColumns> test_def_query_in_string(List<String> name, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	...
	public List queryListMultipleAllShards(DalHints hints) throws SQLException {
	    ...
	    builder.addQuery(sqlList, new StatementParameters(),personShardColModShardByDBOnMysqlPojoRowMapper,new DalListMerger<MysqlPersonTableWithDiffColumns>());//ListMerger
	    builder.addQuery(sqlList, new StatementParameters(), MysqlPersonTableWithDiffColumns.class);
	    builder.addQuery(sqlList, new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new DalListMerger<MysqlPersonTableWithDiffColumns>());
//	    builder.addQuery(sqlList, new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new DalRangedResultMerger<MysqlPersonTableWithDiffColumns>(1,2));
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,1,1), new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlList, new StatementParameters(), new DalSingleResultExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,false), new DalFirstResultMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlList, new StatementParameters(), new TestDalRowCallback());
	    builder.addQuery(sqlList, new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());
...
//	    builder.addQuery(sqlCount, new StatementParameters(), Integer.class, new IntegerComparator());
	    ...
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1),personShardColModShardByDBOnMysqlPojoRowMapper,new DalListMerger<MysqlPersonTableWithDiffColumns>());//ListMerger
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class);
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class, new DalListMerger<MysqlPersonTableWithDiffColumns>());
//	    builder.addQuery(sqlList, new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new DalRangedResultMerger<MysqlPersonTableWithDiffColumns>(1,2));
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,1,1), new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1), new DalSingleResultExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,false), new DalFirstResultMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1), new TestDalRowCallback());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());
...
//	    builder.addQuery(sqlObject, parameters, Integer.class);
	    ...
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1),personShardColModShardByDBOnMysqlPojoRowMapper,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class);
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1), new DalSingleResultExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,false), new DalFirstResultMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1), new TestDalRowCallback());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "ID", Types.INTEGER, 1), MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());
...
//	    builder.addQuery(sqlListCount,new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());//sorter
...
//	    builder.addQuery(sqlNoResult, new StatementParameters(),new TestDalRowCallback3());//callback
	    ...
	    builder.addQuery(sqlInParam, parameters,personShardColModShardByDBOnMysqlPojoRowMapper,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlInParam, parameters, MysqlPersonTableWithDiffColumns.class);
	    builder.addQuery(sqlInParam, parameters, MysqlPersonTableWithDiffColumns.class,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlInParam, parameters, new DalSingleResultExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,false), new DalFirstResultMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlInParam, parameters, new TestDalRowCallback());
	    builder.addQuery(sqlInParam, parameters, MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());
	    ...
	    builder.addQuery(sqlNoResult, new StatementParameters(),personShardColModShardByDBOnMysqlPojoRowMapper,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), MysqlPersonTableWithDiffColumns.class);
	    builder.addQuery(sqlNoResult, new StatementParameters(), MysqlPersonTableWithDiffColumns.class,new DalListMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), new DalSingleResultExtractor(personShardColModShardByDBOnMysqlPojoRowMapper,false), new DalFirstResultMerger<MysqlPersonTableWithDiffColumns>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), new TestDalRowCallback());
	    builder.addQuery(sqlNoResult, new StatementParameters(), MysqlPersonTableWithDiffColumns.class, new PersonShardColModShardByDBOnMysqlComparator());
