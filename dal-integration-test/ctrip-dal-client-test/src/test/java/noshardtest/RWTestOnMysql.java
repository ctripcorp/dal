...
//        Thread.sleep(20000);
    ...
    public void testRWInsert() throws Exception {
        ...
        List<MysqlPersonTable> listFromKey0=dao.test_build_queryByName("testRWInsert",new DalHints().inDatabase(keyName0));
        List<MysqlPersonTable> listFromKey1=dao.test_build_queryByName("testRWInsert",new DalHints().inDatabase(keyName1));
        List<MysqlPersonTable> listFromKey2=dao.test_build_queryByName("testRWInsert",new DalHints().inDatabase(keyName2));
        List<MysqlPersonTable> listFromKey3=dao.test_build_queryByName("testRWInsert",new DalHints().inDatabase(keyName3));
