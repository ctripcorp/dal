...
//		assertEquals(null, ret.getName());
	...
	public void testBuildQueryLikeWithMatchPattern() throws Exception {
		List<PersonShardColModShardByDBOnMysql> ret = dao.testBuildQueryLikeWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
	...
	public void testBuildQueryLikeNullableWithMatchPattern() throws Exception {
		List<PersonShardColModShardByDBOnMysql> ret = dao.testBuildQueryLikeNullableWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
		assertEquals(1, ret.size());
