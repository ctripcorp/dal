...
public class ConnectionStringUtil {
    ...
    public static String GetConnectionString(String providerName, String address, String port, String username, String password, String database) {
        String connectionString = null;
        if (providerName.equals(DatabaseType.SQLServer.getValue().toLowerCase())) {
            connectionString = String.format(sqlServerConnectinoStringPattern, address, port, username, password, database);
        } else {
