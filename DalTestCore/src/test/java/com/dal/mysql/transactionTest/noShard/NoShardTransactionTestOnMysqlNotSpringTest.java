package com.dal.mysql.transactionTest.noShard;

import com.ctrip.platform.dal.dao.DalClientFactory;
import com.ctrip.platform.dal.dao.DalHints;
import com.ctrip.platform.dal.dao.client.DalTransactionManager;
import com.dal.mysql.transaction.noShard.NoShardTransactionTestOnMysql;
import com.dal.mysql.transaction.noShard.NoShardTransactionTestOnMysqlDao;
import org.junit.*;
 ...
 */
public class NoShardTransactionTestOnMysqlNotSpringTest {
    private static NoShardTransactionTestOnMysqlDao dao;
    ...
    public static void setUpBeforeClass() throws Exception {
         ...
         **/
        dao= DalTransactionManager.create(NoShardTransactionTestOnMysqlDao.class);
    }
