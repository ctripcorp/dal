...
public class LocalizedStatement implements Statement, LocalizationValidatable {
    ...
    protected void validateLocalization(boolean isUpdateOperation) throws DalException {
        if (!validate(isUpdateOperation))
            throw new DalException(ErrorCode.NonLocalRequestBlocked,
                    "Non-local operation is not allowed for drc cluster");
    }

    @Override
    public boolean validate(boolean isUpdateOperation) {
        if (validator == null) {
    ...
    public boolean execute(String sql) throws SQLException {
        validateLocalization(isUpdateOperation(sql));
