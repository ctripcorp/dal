...
import dao.noshard.AllTypesOnSqlServerDao;
...
**/
public class SqlServerAllTypesTableDaoUnitTest {
...
//		}
		...
		SqlServerAllTypesTable daoPojo1 = new SqlServerAllTypesTable();
		...
		SqlServerAllTypesTable daoPojo2 = new SqlServerAllTypesTable();
        ...
        SqlServerAllTypesTable daoPojo3 = new SqlServerAllTypesTable();
		...
		daoPojo3.setDatetimeCol(Timestamp.valueOf("2017-4-21 15:50:50"));
         ...
         SqlServerAllTypesTable daoPojo4 = new SqlServerAllTypesTable();
	...
	private SqlServerAllTypesTable createPojo(int index) {
		SqlServerAllTypesTable daoPojo = new SqlServerAllTypesTable();
	...
	private void changePojo(SqlServerAllTypesTable daoPojo) {
		// Change a field to make pojo different with original one
	}
	
	private void changePojos(List<SqlServerAllTypesTable> daoPojos) {
		for(SqlServerAllTypesTable daoPojo: daoPojos)
			changePojo(daoPojo);
	}
	
	private void verifyPojo(SqlServerAllTypesTable daoPojo) {
		//assert changed value
	}
	
	private void verifyPojos(List<SqlServerAllTypesTable> daoPojos) {
		for(SqlServerAllTypesTable daoPojo: daoPojos)
			verifyPojo(daoPojo);
	}
...
//		dao.delete(null, dao.queryAll(null));
	...
	@Test
	public void insertAllColumns() throws Exception{
		SqlServerAllTypesTable sqlServerAllTypesTable=new SqlServerAllTypesTable();
		sqlServerAllTypesTable.setIntCol(3);
		sqlServerAllTypesTable.setSmallIntCol((short)3);
		sqlServerAllTypesTable.setTinyIntCol((short)3);
		sqlServerAllTypesTable.setBigIntCol(3l);
		sqlServerAllTypesTable.setBitCol(true);
		sqlServerAllTypesTable.setNumericCol(new BigDecimal("3.33"));
		sqlServerAllTypesTable.setFloatCol(3.33d);
		sqlServerAllTypesTable.setDecimalCol(new BigDecimal("3.33"));
		sqlServerAllTypesTable.setRealCol(3.33f);
		sqlServerAllTypesTable.setCharCol("c");
		sqlServerAllTypesTable.setNcharCol("c");
		sqlServerAllTypesTable.setNvarcharCol("ccc");
		sqlServerAllTypesTable.setNvarcharMaxCol("cccc");
		sqlServerAllTypesTable.setVarcharCol("cc");
		sqlServerAllTypesTable.setVarcharmaxCol("ccc");
		sqlServerAllTypesTable.setDateCol(Date.valueOf("2018-6-28"));
		sqlServerAllTypesTable.setDatetimeCol(Timestamp.valueOf("2018-06-28 13:42:29"));
		sqlServerAllTypesTable.setDatetime2Col(Timestamp.valueOf("0001-01-01 01:01:01"));
		sqlServerAllTypesTable.setSmallDatetimeCol(Timestamp.valueOf("2018-06-28 13:42:29"));
		sqlServerAllTypesTable.setTimeCol(Time.valueOf("13:49:20"));
		sqlServerAllTypesTable.setMoneyCol(new BigDecimal("1234.45"));
		sqlServerAllTypesTable.setSmallMoneyCol(new BigDecimal("234.4"));
		dao.insert(sqlServerAllTypesTable);
		Assert.assertEquals(5,dao.count());
	}

	@Test
	public void testAllColumnsWithDefaultType() throws Exception{
		insertAllColumns();
		List<String> charCol=new ArrayList<>();
		charCol.add("a");
		charCol.add("b");
		charCol.add("c");

		List<String> ncharCol=new ArrayList<>();
		ncharCol.add("a");
		ncharCol.add("b");
		ncharCol.add("c");

		List<String> nvarcharCol=new ArrayList<>();
		nvarcharCol.add("aaa");
		nvarcharCol.add("bbb");
		nvarcharCol.add("ccc");

		List<String> nvarcharmaxCol=new ArrayList<>();
		nvarcharmaxCol.add("aaaa");
		nvarcharmaxCol.add("bbbb");
		nvarcharmaxCol.add("cccc");


		List<SqlServerAllTypesTable> ret=dao.testAllColumnsWithDefaultType(3,(short)3,(short)3,3l,true,new BigDecimal("2.22"),
				2.22d,new BigDecimal("2.22"),2.22f,charCol,ncharCol,nvarcharCol,nvarcharmaxCol,"cc","ccc",
				Date.valueOf("2018-6-28"),Timestamp.valueOf("2018-06-28 13:42:29"),Timestamp.valueOf("0001-01-01 01:01:01"),Timestamp.valueOf("2018-06-27 13:42:29"),
				Time.valueOf("13:49:20"),new BigDecimal("1234.45"),new BigDecimal("234.4"),null);
	assertEquals(5,ret.get(0).getID().intValue());
	}
	...
	public void testDelete1() throws Exception {
		SqlServerAllTypesTable daoPojo = createPojo(1);
		daoPojo.setID(1);
		/**
		 * WARNING !!!
	...
	public void testDelete2() throws Exception {
		List<SqlServerAllTypesTable> daoPojos = dao.queryAll();
		/**
		 * WARNING !!!
		 * To test delete, please make sure you can easily restore all the data. otherwise data will not be revovered.
		 */
...
//		for(SqlServerAllTypesTable pojo :daoPojos) {
...
//	}
	...
	public void testQueryAll() throws Exception {
		List<SqlServerAllTypesTable> list = dao.queryAll();
	...
	public void  test() throws Exception{
		SqlServerAllTypesTable pojo=new SqlServerAllTypesTable();
	...
	public void testInsert1() throws Exception {
		...
		SqlServerAllTypesTable insertPojo=dao.queryByPk(5);
...
//
//		List<SqlServerAllTypesTable> daoPojos = new ArrayList<>();
//
//		for(int i=0;i<4;i++){
//			SqlServerAllTypesTable pojo=new SqlServerAllTypesTable();
//			pojo.setID(i);
...
//	}
	...
	public void testQueryAllByPage() throws Exception {
		...
		int pageSize = 2;
		int pageNo = 2;
		List<SqlServerAllTypesTable> list = dao.queryAllByPage(pageNo, pageSize);
	...
	public void testQueryByPk1() throws Exception {
		...
		SqlServerAllTypesTable affected = dao.queryByPk(id);
	...
	public void testQueryByPk2() throws Exception {
		SqlServerAllTypesTable pk = createPojo(1);
		pk.setID(2);
		SqlServerAllTypesTable affected = dao.queryByPk(pk);
		assertNotNull(affected);
	...
	public void testQueryLike() throws Exception {
		SqlServerAllTypesTable sample = createPojo(1);
		sample.setVarcharCol("new");
		List<SqlServerAllTypesTable> affected = dao.queryLike(sample);
	...
	public void testUpdate1() throws Exception {
		...
		SqlServerAllTypesTable daoPojo = dao.queryByPk(1);
	...
	public void testUpdate2() throws Exception {
		...
		SqlServerAllTypesTable daoPojo = dao.queryByPk(3);
	...
	public void testtest_build_nullable_inNull() throws Exception {
		...
		varCharCol.add(null);
		varCharCol.add(null);
		List<SqlServerAllTypesTable> ret = dao.test_build_query_nullable(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
	...
	public void testFreeSqlQueryWithAppendNullable() throws Exception {
		...
		varCharCol.add(null);
		varCharCol.add("world");
		List<SqlServerAllTypesTable> ret = dao.testFreeSqlQueryWithAppendNullable(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
		assertEquals(2, ret.size());
	}
	...
	public void testFreeSqlQueryNullable() throws Exception {
		...
		varCharCol.add(null);
		varCharCol.add("world");
		List<SqlServerAllTypesTable> ret = dao.testFreeSqlQueryNullable(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
		assertEquals(2, ret.size());
	}
	...
	public void testFreeSqlQueryNotNullWithSet() throws Exception {
		...
		varCharCol.add("world");
		List<SqlServerAllTypesTable> ret = dao.testFreeSqlQueryNotNullWithSet(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
		assertEquals(2, ret.size());
	}
	...
	public void testFreeSqlQueryNotNull() throws Exception {
		...
		varCharCol.add("colorful");
		varCharCol.add("world");
		List<SqlServerAllTypesTable> ret = dao.testFreeSqlQueryNotNull(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
		assertEquals(2, ret.size());
	}

	@Test
	public void testFreeSqlSetNullable() throws Exception {
		List<SqlServerAllTypesTable> ret1 = dao.testFreeSqlSetNullableAndIncludeAll(null, new DalHints());
		assertEquals(4, ret1.size());

		List<SqlServerAllTypesTable> ret2 = dao.testFreeSqlSetNullableAndExcludeAll(null, new DalHints());
	...
	public void testtest_build_notnull_notnull() throws Exception {
        ...
        varCharCol.add("colorful");
        varCharCol.add("world");
	    List<SqlServerAllTypesTable> ret = dao.test_build_query_notnull(CharCol, NcharCol,  BitCol, IntCol,SmallIntCol, TinyIntCol, NumericCol, BigIntCol_start, BigIntCol_end, varCharCol, new DalHints());
	    assertEquals(2, ret.size());
	}
...
//	}
	...
	public void testFreeSqlDelete() throws Exception {
		...
		SqlServerAllTypesTable pojo = dao.queryByPk(1);
		assertNull(pojo);
	...
	public void testtestBuildInsert() throws Exception {
	    ...
	    SqlServerAllTypesTable daoPojo = dao.queryByPk(5);
	...
	public void testFreeSqlInsert() throws Exception {
		...
		SqlServerAllTypesTable pojo = dao.queryByPk(5);
	...
	public void testFreeSqlUpdate() throws Exception {
		...
		SqlServerAllTypesTable pojo = dao.queryByPk(2);
	...
	public void testtestBuildQueryPojoFirst() throws Exception {
		Integer id = 1;// Test value here
	    SqlServerAllTypesTable ret = dao.testBuildQueryPojoFirst(id);
	...
	public void testtestBuildQueryPojoList() throws Exception {
		Integer id = 1;// Test value here
	    List<SqlServerAllTypesTable> ret = dao.testBuildQueryPojoList(id);
	    assertEquals(3, ret.size());
	...
	public void testtestBuildQueryPojoListByPage() throws Exception {
		Integer id = 1;// Test value here
	    List<SqlServerAllTypesTable> ret = dao.testBuildQueryPojoListByPage(id, 2, 2);
	...
	public void testtestBuildQueryPojoSingle() throws Exception {
	    ...
	    SqlServerAllTypesTable ret = dao.testBuildQueryPojoSingle(id);
	...
	public void testFreeSqlLikePattern() throws Exception {
		List<SqlServerAllTypesTable> ret1 = dao.testFreeSqlLikePattern("n", MatchPattern.BEGIN_WITH);
		assertEquals(1, ret1.size());
		assertEquals(100, ret1.get(0).getBigIntCol().intValue());

		List<SqlServerAllTypesTable> ret2 = dao.testFreeSqlLikePattern("e", MatchPattern.CONTAINS);
		assertEquals(2, ret2.size());

		List<SqlServerAllTypesTable> ret3 = dao.testFreeSqlLikePattern("ful", MatchPattern.END_WITH);
		assertEquals(1, ret3.size());

		List<SqlServerAllTypesTable> ret4 = dao.testFreeSqlLikePattern("%ful", MatchPattern.USER_DEFINED);
		assertEquals(1, ret4.size());
	}

	@Test
	public void testFreeSqlNotLikePattern() throws Exception {
		List<SqlServerAllTypesTable> ret1 = dao.testFreeSqlNotLikePattern("n", MatchPattern.BEGIN_WITH);
		assertEquals(3, ret1.size());

		List<SqlServerAllTypesTable> ret2 = dao.testFreeSqlNotLikePattern("e", MatchPattern.CONTAINS);
		assertEquals(2, ret2.size());

		List<SqlServerAllTypesTable> ret3 = dao.testFreeSqlNotLikePattern("ful", MatchPattern.END_WITH);
		assertEquals(3, ret3.size());

		List<SqlServerAllTypesTable> ret4 = dao.testFreeSqlNotLikePattern("%ful", MatchPattern.USER_DEFINED);
	...
	public void testFreeSqlNotNotNull() throws Exception {
		...
		List<SqlServerAllTypesTable> ret = dao.testNotNotNull(low, upper, bigIntCol, varCharCol);
		assertEquals(2, ret.size());
	...
	public void testFreeSqlNotNullable() throws Exception {
		...
		List<SqlServerAllTypesTable> ret = dao.testNotNullable(null, 4, bigIntCol, varCharCol);
		assertEquals(3, ret.size());
	}
	...
	public void testtestDefQueryPojoFirst() throws Exception {
		Integer id = 1;// Test value here
		SqlServerAllTypesTable ret = dao.testDefQueryPojoFirst(id);
		assertEquals("new", ret.getVarcharCol());
	...
	public void testtestDefQueryPojoList() throws Exception {
		...
		intcol.add(12);
		intcol.add(99);
		List<SqlServerAllTypesTable> ret = dao.testDefQueryPojoList(intcol);
		assertEquals(2, ret.size());
	...
	public void testtestDefQueryPojoListByPage() throws Exception {
		Integer id = 1;// Test value here
		List<SqlServerAllTypesTable> ret = dao.testDefQueryPojoListByPage(id, 2, 2);
		assertEquals(1, ret.size());
	...
	public void testtestDefQueryPojoSingle() throws Exception {
		Integer id = 1;// Test value here
		SqlServerAllTypesTable ret = dao.testDefQueryPojoSingle(id);
