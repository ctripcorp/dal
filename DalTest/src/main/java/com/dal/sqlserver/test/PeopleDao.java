...
public class PeopleDao {
	...
	public PeopleDao() throws SQLException {
		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(People.class));
	}
	...
	**/
	public List<People> queryLike(People sample, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<People> queryAllByPage(int pageNo, int pageSize, DalHints hints)  throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<People> queryAll(DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
