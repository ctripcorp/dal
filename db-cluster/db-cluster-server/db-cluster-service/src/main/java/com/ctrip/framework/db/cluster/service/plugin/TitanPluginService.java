...
//    public TitanKeyPageResponse pageQueryTitanKeys() {
//
//    }

    // deprecated
    public PluginResponse switchTitanKey(TitanKeyUpdateRequest titanKeyUpdateRequest, String operator) {
        ...
        try {
            ...
            urlParams.add(new BasicNameValuePair("operator", operator));
            String request = Utils.gson.toJson(titanKeyUpdateRequest);
            t.addData("request", request);
