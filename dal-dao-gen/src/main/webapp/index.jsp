            ...
            <div class="modal-body">
                <div class="row-fluid">
                    <div class="control-group">
                        <input id="project_group_id" type="hidden" value=""> <input
                            id="project_id" type="hidden" value=""> <label
                ...
                <div class="row-fluid">
                    <div class="control-group">
                        <label class="control-label popup_label" style="width: 110px;">Dal.config
                            Name</label> <input id="dalconfigname" class="span9 input-sm"
                                                type="text">
                    </div>
                </div>
                <div class="row-fluid">
              ...
              <div class="row-fluid">
               ...
               -->
                <div class="row-fluid useNewPojo">
                    <label class="popup_label"><input id="newPojo"
                                                      type="checkbox" checked="checked">生成代码时附带数据库中的类型（DAL
                        Fx>V1.2.0.6）</label>
                </div>
                <div class="row-fluid useNewPojo">
...
<div class="modal fade" id="generateCodeProcessDiv" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row-fluid">
                    <div class="control-group">
                        <label id="generateCodeProcessErrorMess"
                               class="control-label popup_label"></label>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="page1" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title" id="page1_label"
                       style="font-size: 25px; font-weight: bold">DAO生成向导</label> <a
            ...
            <div class="modal-body"
                    ...
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label" style="width: 130px;">方法功能描述：</label>
								<textarea id="comment" class="span12 popup_text input-sm"
                                          rows="4"></textarea>
                        </div>
                    </div>
                </div>
                <div class="steps step2-1 row-fluid">
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">选择表：</label> <select
                                id="table_list" multiple="multiple" class="popup_text"
                                style="width: 420px;">
                        </select>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">选择视图：</label> <select
                                id="view_list" multiple="multiple" class="popup_text"
                                style="width: 420px;">
                        </select>
                        </div>
                    </div>
                    <div class="row-fluid mysql_hide">
                        <div class="control-group">
                            <label class="control-label popup_label">选择存储过程：</label> <select
                                id="sp_list" multiple="multiple" class="popup_text"
                                style="width: 420px;">
                        </select>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">移除DAO名前缀：</label> <input
                                type="text" id="prefix" class="span9 popup_text input-sm">
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">添加DAO名后缀：</label> <input
                                type="text" id="suffix" class="span9 popup_text input-sm">
                        </div>
                    </div>
                    <div class="row-fluid mysql_hide">
                        <label class="popup_label"><input id="cud_by_sp"
                                                          type="checkbox" checked="true">增删改使用SPA或SP3（Sql
                            Server请勾选，MySql请去除）</label>
                    </div>
                    <div class="row-fluid">
                        <label class="popup_label"><input id="pagination"
                ...
                <div class="steps step2-1-2 row-fluid">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <input id="SelectAllCreateMethodAPIChk" type="checkbox"
                                           checked="true"> <a data-toggle="collapse"
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body" id="CreateMethodListDiv"
                                     style="max-height: 300px; overflow-y: auto">Create
                                    Method list here.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <input id="SelectAllRetrieveMethodAPIChk" type="checkbox"
                                           checked="true"> <a data-toggle="collapse"
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse">
                                <div class="panel-body" id="RetrieveMethodListDiv"
                                     style="max-height: 300px; overflow-y: auto">Retrieve
                                    Method list here.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <input id="SelectAllUpdateMethodAPIChk" type="checkbox"
                                           checked="true"> <a data-toggle="collapse"
                            ...
                            <div id="collapseThree" class="panel-collapse collapse">
                                <div class="panel-body" id="UpdateMethodListDiv"
                                     style="max-height: 300px; overflow-y: auto">Update
                                    Method list here.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <input id="SelectAllDeleteMethodAPIChk" type="checkbox"
                                           checked="true"> <a data-toggle="collapse"
                            ...
                            <div id="collapseFour" class="panel-collapse collapse">
                                <div class="panel-body" id="DeleteMethodListDiv"
                                     style="max-height: 300px; overflow-y: auto">Delete
                                    Method list here.
                                </div>
                            </div>
                        </div>
                ...
                <div class="steps step2-2 row-fluid">
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">选择一个表：</label> <select
                                id="tables" class="span9 popup_text">
                        </select>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group">
                            <label class="control-label popup_label">操作类型：</label> <select
                                id="crud_option" class="span9 popup_text">
                    ...
                    <div class="row-fluid method_name_class">
                        <div class="control-group">
                            <label class="control-label popup_label">生成的方法名：</label> <input
                                id="method_name" class="span9  popup_text"
                ...
                <div class="row-fluid steps step2-2-1" style="height: 368px;"
                    ...
                    <div id="operation_fields" class="step2-2-1-1 row-fluid">
                        <div class="row-fluid">
                            <div class="control-group">
                                <label class="control-label popup_label">选择字段：</label> <select
                                    id="fields" multiple="multiple" class="popup_text"
                                    style="width: 434px;">
                            </select>
                            </div>
                        </div>
                    ...
                    <div id="where_condition" class="step2-2-1-2">
                        <div class="row-fluid">
                            <div class="control-group">
                                <label class="control-label popup_label">Where条件：</label> <select
                                    id="conditions" class="span4">
                        ...
                        <div class="row-fluid">
                            <select class="span10" id="selected_condition"
                    ...
                    <div class="row-fluid" id="auto_sql_scalarTypeDiv">
                        <div class="control-group">
                            <label class="control-label popup_label">返回形式：</label> <select
                                id="auto_sql_scalarType" class='span5'>
                    ...
                    <div id="orderby">
                        <div class="row-fluid">
                            <div class="control-group">
                                <label class="control-label popup_label">Order by：</label> <select
                                    id="orderby_field" class="span5">
                                <option value='-1'>--请选择--</option>
                ...
                <div class="steps step2-2-2 row-fluid" from="">
                    ...
                    <div id="buildJavaHints">
                        ...
                        <div class="row-fluid">
                            <label class="popup_label"><input
                                    id="chk_build_allShard" type="checkbox" value="allShard">allShard&nbsp;&nbsp;
                            </label>
                            <label class="popup_label"><input id="chk_build_shards"
                                                              type="checkbox" value="shards">shards&nbsp;&nbsp;</label>
                            <label
                                    class="popup_label"><input id="chk_build_async"
                                                               type="checkbox" value="async">async&nbsp;&nbsp;</label>
                            <label
                    ...
                    <div class="row-fluid">
                        <div id="step2_2_2_sql_editor" class="span12"
                ...
                <div class="steps step2-2-3 row-fluid">
                    ...
                    <div class="row-fluid">
                        <div id="step2_2_3_sql_editor" class="span12"
                             style="height: 200px;"></div>
                    </div>
                </div>
                <div class="steps step2-2-4 row-fluid">
                    ...
                    <div class="row-fluid">
                        <div id="step2_2_4_sql_editor" class="span12"
                             style="height: 200px;"></div>
                    </div>
                </div>
                ...
                <div class="steps step2-3-3 row-fluid" from="">
                    ...
                    <div id="customJavaHints">
                        ...
                        <div class="row-fluid">
                            <label class="popup_label"><input
                                    id="chk_custom_allShard" type="checkbox" value="allShard">allShard&nbsp;&nbsp;
                            </label>
                    ...
                    <div class="row-fluid">
                        <div id="step2_3_1_sql_editor" class="span12"
                             style="height: 200px;"></div>
                    </div>
                </div>
                <div class="steps step2-3-4 row-fluid" from="">
                    ...
                    <div class="row-fluid">
                        <div id="step2_3_4_sql_editor" class="span12"
                             style="height: 200px;"></div>
                    </div>
                </div>
                <div class="steps step2-3-5 row-fluid" from="">
                    ...
                    <div class="row-fluid">
                        <div id="step2_3_5_sql_editor" class="span12"
                             style="height: 200px;"></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <div class="row-fluid">
                    ...
                    <label class="popup_label"><input id="gen_on_save"
                                                      type="checkbox">保存时生成代码</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row-fluid">
                    <div class="control-group">
                        <label class="control-label popup_label">选择审批人：</label> <select
                            id="approve_user" class="span8">
                    </select>
                    </div>
                </div>
            </div>
