...
import dao.shard.newVersionCode.DalTransactionalWithShardOnMysqlDao;
...
@ContextConfiguration("classpath*:/DalTransactionalShardTest.xml")
public class DalTransactionalWithShardOnMysqlSpringTest {
    @Autowired
    private DalTransactionalWithShardOnMysqlDao dao;
