...
import com.ctrip.sysdev.das.handler.NettyServiceHandler;
import com.ctrip.sysdev.das.handler.RequestDecoder;
import com.ctrip.sysdev.das.handler.ResponseEncoder;
...
public class NettyServer implements Server {
	...
	private class ServerChannelInitializer extends ChannelInitializer<Channel> {
		...
		protected void initChannel(Channel ch) throws Exception {
			...
			p.addLast(logicGroup, "handler", new NettyServiceHandler(allChannels));
		}
	}
