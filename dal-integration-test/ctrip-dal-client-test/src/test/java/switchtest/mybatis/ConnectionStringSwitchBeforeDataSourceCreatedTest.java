 ...
 */
public class ConnectionStringSwitchBeforeDataSourceCreatedTest {
    ...
    private static Logger log = LoggerFactory.getLogger(ConnectionStringSwitchBeforeDataSourceCreatedTest.class);
...
//        Thread.sleep(5000);
    ...
    @Test
    public void switchBeforeDataSourceCreatedTest() throws Exception {
...
//        Thread.sleep(20000);
        dao = new DRTestDao();
        queryHostName(keyName1,new DalHints(),dao);
        queryHostName(keyName1,new DalHints(),dao);
        queryHostName(keyName1,new DalHints(),dao);
        queryHostName(keyName1,new DalHints(),dao);
        log.info(String.format("开始第二次切换"));
        connectionStringSwitch.postByMHA(true);
        Thread.sleep(20000);
        queryHostName(keyName1,new DalHints(),dao);
        queryHostName(keyName1,new DalHints(),dao);
