...
public class ignoreMissingFieldsAndAllowPartialTestOnSqlServerGenDao {
	...
	private DalParser<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> parser = null;
	private DalScalarExtractor extractor = new DalScalarExtractor();
	private DalTableDao<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> client;
	private DalRowMapper<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> PeopleSimpleShardByDBOnSqlServerGenRowMapper = null;
	...
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGenDao() throws SQLException {
		this.PeopleSimpleShardByDBOnSqlServerGenRowMapper = new DalDefaultJpaMapper(
				ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen.class);
		parser = new DalDefaultJpaParser<>(
				ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen.class);
		this.client = new DalTableDao<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen>(
				parser);
	 ...
	 * be a number
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen queryByPk(Number id,
	 ...
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen queryByPk(
            ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> queryByPage(int pageSize,
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> getAll(DalHints hints)
			throws SQLException {
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> result = null;
	...
	public int insert(DalHints hints,
			ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen daoPojo) throws SQLException {
		if (null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public int[] insert(DalHints hints,
			List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> daoPojos)
			throws SQLException {
	 ...
	 * 构建，查询，equal
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_query_equal(
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_query_pojoList(
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryIgnoreMissingFields_pojoList(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryAllowPartial_pojoList(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryFromIgnoreMissingFields_pojoList(
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,queryFrom
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryFromAllowPartial_pojoList(
			List<Integer> CityID, DalHints hints,int start,int count) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_query_pojoListByPage(
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoListByPage
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryIgnoreMissingFields_pojoListByPage(
			List<Integer> CityID, int pageNo, int pageSize, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoListByPage
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_build_queryAllowPartial_pojoListByPage(
			List<Integer> CityID, int pageNo, int pageSize, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
	 ...
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_query_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoSingle
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_queryIgnoreMissingFields_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoSingle
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_queryAllowPartial_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_query_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoFirst
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_queryIgnoreMissingFields_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoFirst
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_build_queryAllowPartial_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory,
				false);
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_queryIgnoreMissingFields_pojoList(
			List<Integer> CityID, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "CityID", Types.INTEGER, CityID);
		return (List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen>) queryDao
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoList
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_queryAllowPartial_pojoList(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "select * from People with(nolock) where CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoList
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_query_pojoList(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "select * from People with(nolock) where CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_query_pojoListByPage(
			List<Integer> CityID, int pageNo, int pageSize, DalHints hints)
			throws SQLException {
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoListByPage
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_queryIgnoreMissingFields_pojoListByPage(
			List<Integer> CityID, int pageNo, int pageSize, DalHints hints)
			throws SQLException {
		String sql = "SELECT * FROM People WHERE CityID IN (?) ORDER BY PeopleID OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
		sql = SQLParser.parse(sql, CityID);
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoListByPage
	 **/
	public List<ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen> test_def_queryAllowPartial_pojoListByPage(
			List<Integer> CityID, int pageNo, int pageSize, DalHints hints)
			throws SQLException {
		String sql = "SELECT * FROM People WHERE CityID IN (?) ORDER BY PeopleID OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
		sql = SQLParser.parse(sql, CityID);
	 ...
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_query_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
		...
		int i = 1;
		i = parameters.setInParameter(i, "CityID", Types.INTEGER, CityID);
		return (ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen) queryDao
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoSingle
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_queryIgnoreMissingFields_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoSingle
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_queryAllowPartial_pojoSingle(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_query_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoFirst
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_queryIgnoreMissingFields_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
	 ...
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoFirst
	 **/
	public ignoreMissingFieldsAndAllowPartialTestOnSqlServerGen test_def_queryAllowPartial_pojoFirst(
			List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
