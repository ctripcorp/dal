...
namespace TestAgent
{
    public sealed class SummaryInfo
    {
        ...
        private static float _lastRequestCount = 0.0F;
        private static float _lastFailedRequest = 0.0F;
        private static float _lastSuccessRequest = 0.0F;
        private static float _lastNotAuthorizedRequest = 0.0F;
        private static float _lastNotFoundRequest = 0.0F;
        private static float _lastServerErrorRequest = 0.0F;
        ...
        //private static int _disposePerfMon = 0;
        //确保只有一个线程访问
        public static void GetMetrics()
        {
            try
            {
                //if (Interlocked.CompareExchange(ref _disposePerfMon, 0, 30) == 30)
                //{
                //    _ramCounter.Dispose();
                //    _ramCounter = null;
                //    _cpuCounter.Dispose();
                //    _cpuCounter = null;
                //    _totalRequestCounter.Dispose();
                //    _totalRequestCounter = null;
                //    _successRequestCounter.Dispose();
                //    _successRequestCounter = null;
                //    _failedRequestCounter.Dispose();
                //    _failedRequestCounter = null;
                //    _notAuthorizedRequestCounter.Dispose();
                //    _notAuthorizedRequestCounter = null;
                //    _notFoundRequestCounter.Dispose();
                //    _notFoundRequestCounter = null;
                //    _serverErrorRequestCounter.Dispose();
                //    _serverErrorRequestCounter = null;
            ...
            try
            {
                ...
                tempEntity.q = (int)(_reqeustCount - _lastRequestCount);
                tempEntity.s = (int)(_successRequest - _lastSuccessRequest);
                tempEntity.f = (int)(_failedRequest - _lastFailedRequest);
                tempEntity.u = (int)(_notAuthorizedRequest - _lastNotAuthorizedRequest);
                tempEntity.d = (int)(_notFoundRequest - _lastNotFoundRequest);
                tempEntity.e = (int)(_serverErrorRequest - _lastServerErrorRequest);
            ...
            //Interlocked.Increment(ref _disposePerfMon);
