...
//    private DalParser<Integer> parser1 = null;	
	...
	**/
	public List<MysqlPersonTable> test_def_query_list(List<Integer> Age, DalHints hints) throws SQLException {
		...
		return queryDao.query(sql, parameters, hints.sortBy(new MysqlPersonTableComparator()), personMysqlPersonTableRowMapper);
	}
	...
	**/
	public List<MysqlPersonTable> test_def_query_listByPage(List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		...
		return (List<MysqlPersonTable>)queryDao.query(sql, parameters, hints, personMysqlPersonTableRowMapper);
	}
	...
	**/
	public MysqlPersonTable test_def_query_list_single(List<Integer> Age, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return (MysqlPersonTable)queryDao.queryForObjectNullable(sql, parameters, hints, personMysqlPersonTableRowMapper);
	}
	...
	**/
	public MysqlPersonTable test_def_query_list_first(List<Integer> Age, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return queryDao.queryFirstNullable(sql, parameters, hints.sortBy(new MysqlPersonTableComparator()), personMysqlPersonTableRowMapper);
	}
