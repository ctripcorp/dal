 ...
 **/
public class FreeShardingStrategyByDBOnSqlServerDaoUnitTest {

	private static final String DATA_BASE = "FreeShardingStrategyByDBOnSqlServer";
	...
	public static void setUpBeforeClass() throws Exception {
		...
		dao = new PeopleShardColModShardByDBOnSqlServerDao(DATA_BASE);
	}
...
//		Thread.sleep(2000);
	...
	public void testCount() throws Exception {
		...
		assertEquals(6,ret2);
		int ret3 = dao.count(new DalHints().inAllShards().mergeBy(new ResultMerger.IntSummary()));
...
//		assertEquals(1, affected);
	...
	public void testDelete2() throws Exception {
		...
		List<SqlServerPeopleTable> daoPojos = dao.queryAll(new DalHints().inShard(1));
...
//		assertArrayEquals(new int[]{1,1,1},  affected);
	...
	public void testBatchDelete() throws Exception {
		...
		List<SqlServerPeopleTable> daoPojos = dao.queryAll(new DalHints().inAllShards());
...
//		assertArrayEquals(new int[]{1,1,1},  affected);
	...
	public void testQueryAll() throws Exception {
		List<SqlServerPeopleTable> ret=dao.queryAll(new DalHints().setShardValue(20));
...
//		int affected = dao.insert(new DalHints().inShard(0), daoPojo);
		...
		Number id = 7l;
		SqlServerPeopleTable ret1 = dao.queryByPk(id, new DalHints().inShard(0));
		assertNotNull(ret1);
		...
		SqlServerPeopleTable ret2 = dao.queryByPk(id, new DalHints().inShard(1));
		assertNotNull(ret2);
	}
...
//		assertArrayEquals(new int[]{1,1,1,1,1,1},  affected);
	...
	public void testQueryAllByPage() throws Exception {
		List<SqlServerPeopleTable> ret=dao.queryAllByPage(2, 1, new DalHints().setShardValue(20));
	...
	public void testQueryByPk1() throws Exception {
		Number id = 1l;
		SqlServerPeopleTable ret = dao.queryByPk(id, new DalHints().setShardColValue("CityID", 20));
	...
	public void testQueryByPk2() throws Exception {
		...
		pk.setPeopleID(1l);
		SqlServerPeopleTable ret = dao.queryByPk(pk, new DalHints().inShard(0));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testQueryLike() throws Exception {
		...
		List<SqlServerPeopleTable> ret=dao.queryLike(sample, new DalHints().inShard(0));
...
//		assertEquals(1, affected);
		...
		SqlServerPeopleTable ret=dao.queryByPk(1, new DalHints().inShard(0));
...
//		List<SqlServerPeopleTableWithDiffColumns> daoPojos = dao.queryAll(new DalHints());
...
//		
		...
		SqlServerPeopleTable daoPojo1=new SqlServerPeopleTable();
		...
		SqlServerPeopleTable daoPojo2=new SqlServerPeopleTable();
...
//		SqlServerPeopleTableWithDiffColumns daoPojo2=new SqlServerPeopleTableWithDiffColumns();
//		
//		daoPojo2.setPeopleID(1l);
//		daoPojo2.setCityID(21);
//		daoPojo2.setName("updateShard1");
...
//		assertArrayEquals(new int[]{-2,-2},  affected);
	...
	public void testBuildQueryLikeWithMatchPattern() throws Exception {
		List<SqlServerPeopleTable> ret = dao.testBuildQueryLikeWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
		assertEquals(1, ret.size());
	...
	public void testBuildQueryLikeNullableWithMatchPattern() throws Exception {
		List<SqlServerPeopleTable> ret = dao.testBuildQueryLikeNullableWithMatchPattern("_00", MatchPattern.END_WITH, new DalHints().inShard(0));
		assertEquals(1, ret.size());
	...
	public void testtest_build_delete() throws Exception {
		...
		List<SqlServerPeopleTable> pojos=dao.queryAll(new DalHints().inShard(0));
	...
	public void testtest_build_queryEqual() throws Exception {
		Integer cityID=20;
		List<SqlServerPeopleTable> ret=dao.test(cityID, new DalHints().inShard(0));
		assertEquals(1, ret.size());
	}
...
//	    assertEquals(1, ret);
		...
		SqlServerPeopleTable pojo=dao.queryByPk(7, new DalHints().inShard(0));
...
//	    assertEquals(3, ret);
		...
		SqlServerPeopleTable pojo=dao.queryByPk(1, new DalHints().inShard(0));
	...
	public void testtest_build_query_first() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_query_first(CityID, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_build_queryPartial_first() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_queryPartial_first(CityID, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_ClientQueryFrom_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_ClientQueryFrom_list(CityID, new DalHints().inAllShards(),1,1);
		assertEquals(1, ret.size());
	...
	public void testtest_ClientQueryFromPartialFieldsSet_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_ClientQueryFromPartialFieldsSet_list(CityID, new DalHints().inAllShards(),1,1);
		assertEquals(1, ret.size());
		assertEquals(22, ret.get(0).getCityID().intValue());
	...
	public void testtest_ClientQueryFromPartialFieldsStrings_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_ClientQueryFromPartialFieldsStrings_list(CityID, new DalHints().inAllShards(),1,1);
		assertEquals(1, ret.size());
		assertEquals(22, ret.get(0).getCityID().intValue());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_build_query_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_query_list(CityID, new DalHints().inAllShards());
	...
	public void testtest_build_queryPartial_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_queryPartial_list(CityID, new DalHints().inAllShards());
		assertEquals(3, ret.size());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_build_queryPartialFieldsByHints_list() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_queryPartialFieldsByHints_list(CityID, new DalHints().inAllShards());
		assertEquals(3, ret.size());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_build_query_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_query_listByPage(CityID, 2, 1, new DalHints().inShard(0));
		assertEquals("Initial_Shard_02", ret.get(0).getName());
	...
	public void testtest_build_queryPartial_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_build_queryPartial_listByPage(CityID, 2, 1, new DalHints().inShard(0));
		assertEquals("Initial_Shard_02", ret.get(0).getName());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_build_query_single() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_query_single(CityID, new DalHints().setShardColValue("CityID", 21));
	...
	public void testtest_build_queryPartial_single() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_build_queryPartial_single(CityID, new DalHints().setShardColValue("CityID", 21));
		assertEquals("Initial_Shard_13", ret.getName());
		assertNull(ret.getPeopleID());
	...
	public void testtest_build_query_fieldFirst() throws Exception {
		//Integer CityID = null;// Test value here
		//SqlServerPeopleTableWithDiffColumns ret = dao.test_build_query_fieldFirst(CityID, new DalHints());
		List<Integer> CityID=new ArrayList<Integer>();
		CityID.add(20);
		CityID.add(23);
		CityID.add(22);
...
//	    assertEquals(2, ret);
	...
	public void testtest_def_query_listFirst() throws Exception {
		...
		SqlServerPeopleTable ret = dao.test_def_query_listFirst(CityID, new DalHints().setShardColValue("CityID", 20));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_def_queryPartialSet_listFirst() throws Exception {
		...
		SqlServerPeopleTable ret = dao.test_def_queryPartialSet_listFirst(CityID, new DalHints().setShardColValue("CityID", 20));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_def_queryPartialStrings_listFirst() throws Exception {
		...
		SqlServerPeopleTable ret = dao.test_def_queryPartialStrings_listFirst(CityID, new DalHints().setShardColValue("CityID", 20));
		assertEquals("Initial_Shard_00", ret.getName());
		assertEquals(20, ret.getCityID().intValue());
		assertNull(ret.getCountryID());
		assertNull(ret.getPeopleID());
...
//	    assertEquals(3, ret.size());
		...
		List<SqlServerPeopleTable> ret = dao.test_def_query_list(CityID, new DalHints().inShard(1));
		assertEquals(1, ret.size());
...
//	    assertEquals(3, ret.size());
		...
		List<SqlServerPeopleTable> ret = dao.test_def_queryPartialSet_list(CityID, new DalHints().inShard(1));
		assertEquals(1, ret.size());
...
//	    assertEquals(3, ret.size());
		...
		List<SqlServerPeopleTable> ret = dao.test_def_queryPartialStrings_list(CityID, new DalHints().inShard(1));
		assertEquals(1, ret.size());
		assertEquals(23, ret.get(0).getCityID().intValue());
		assertEquals("Initial_Shard_13", ret.get(0).getName());
		assertNull(ret.get(0).getCountryID());
	...
	public void testtest_def_query_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_def_query_listByPage(CityID, 2, 1, new DalHints().inShard(0));
		assertEquals("Initial_Shard_02", ret.get(0).getName());
	...
	public void testtest_def_queryPartialSet_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_def_queryPartialSet_listByPage(CityID, 2, 1, new DalHints().inShard(0));
		assertEquals("Initial_Shard_02", ret.get(0).getName());
		assertEquals(22, ret.get(0).getCityID().intValue());
		assertNull(ret.get(0).getCountryID());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_def_queryPartialStrings_listByPage() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		List<SqlServerPeopleTable> ret = dao.test_def_queryPartialStrings_listByPage(CityID, 2, 1, new DalHints().inShard(0));
		assertEquals("Initial_Shard_02", ret.get(0).getName());
		assertEquals(22, ret.get(0).getCityID().intValue());
		assertNull(ret.get(0).getCountryID());
		assertNull(ret.get(0).getPeopleID());
	...
	public void testtest_def_query_listSingle() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_def_query_listSingle(CityID, new DalHints().setShardColValue("CityID", 21));
		assertEquals("Initial_Shard_13", ret.getName());
	...
	public void testtest_def_queryPartialSet_listSingle() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_def_queryPartialSet_listSingle(CityID, new DalHints().setShardColValue("CityID", 21));
		assertEquals("Initial_Shard_13", ret.getName());
	...
	public void testtest_def_queryPartialStrings_listSingle() throws Exception {
		...
		CityID.add(23);
		CityID.add(22);
		SqlServerPeopleTable ret = dao.test_def_queryPartialStrings_listSingle(CityID, new DalHints().setShardColValue("CityID", 21));
		assertEquals("Initial_Shard_13", ret.getName());
		assertEquals(23, ret.getCityID().intValue());
		assertNull(ret.getCountryID());
		assertNull(ret.getPeopleID());
	...
	@Test
	/**
	 * queryDao.query("select top 100 * from People", parameters, hints, SqlServerPeopleTableWithDiffColumns.class)
	 **/
	public void testtest_def_top() throws Exception {
		List<SqlServerPeopleTable> ret=dao.test_def_top(new DalHints().inShard(0));
		assertEquals(6, ret.size());
	}
