...
import dao.shard.newVersionCode.TransactionalWithShardOnSqlServerDao;
 ...
 */
public class TransactionalWithShardOnSqlServerNotSpringTest {
    private static TransactionalWithShardOnSqlServerDao dao;

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {

        dao= DalTransactionManager.create(TransactionalWithShardOnSqlServerDao.class);
