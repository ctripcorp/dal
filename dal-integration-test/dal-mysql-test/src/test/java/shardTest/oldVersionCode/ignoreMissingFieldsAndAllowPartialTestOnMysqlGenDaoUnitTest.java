...
//	    assertEquals(2, ret);
	    ...
	    List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> daoPojos1 = new ArrayList<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen>(
				3);

		for (int i = 0; i < 6; i++) {
			ignoreMissingFieldsAndAllowPartialTestOnMysqlGen daoPojo = new ignoreMissingFieldsAndAllowPartialTestOnMysqlGen();
			daoPojo.setAge(i + 20);
//			if(i%2==0)
...
//		dao.test_def_update(new DalHints().inShard(1));
	...
	public void testtest_build_queryIgnoreMissingFields_first() throws Exception {
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_build_queryIgnoreMissingFields_first(Age, hints.inAllShards().ignoreMissingFields());
...
//        assertNull(ret);
	...
	public void testtest_build_queryAllowPartial_first() throws Exception {
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_build_queryAllowPartial_first(Age, new DalHints().inAllShards().allowPartial());
		assertEquals(1, ret.getID().intValue());
...
//        assertNull(ret);
	...
	public void testtest_build_queryIgnoreMissingFields() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_build_queryIgnoreMissingFields(Age, new DalHints().inAllShards().ignoreMissingFields());
	...
	public void testtest_build_queryAllowPartial() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_build_queryAllowPartial(Age, new DalHints().inAllShards().allowPartial());
		assertEquals(2, ret.size());
	...
	public void testtest_build_queryIgnoreMissingFields_byPage() throws Exception {
        ...
        List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_build_queryIgnoreMissingFields_byPage(Age,2,2, new DalHints().setShardValue(3).ignoreMissingFields());
	...
	public void testtest_build_queryAllowPartial_byPage() throws Exception {
        ...
        List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_build_queryAllowPartial_byPage(Age,2,2, new DalHints().setShardValue(3).allowPartial());
		assertEquals(0, ret.size());
	...
	public void testtest_build_queryIgnoreMissingFields_single() throws Exception {
        ...
        ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_build_queryIgnoreMissingFields_single(Age, new DalHints().setShardColValue("Age", 20).ignoreMissingFields());
        assertEquals(1, ret.getID().intValue());
...
//        assertEquals(1, ret.getID().intValue());
	...
	public void testtest_build_queryAllowPartial_single() throws Exception {
        ...
        ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_build_queryAllowPartial_single(Age, new DalHints().setShardColValue("Age", 20).allowPartial());
        assertEquals(1, ret.getID().intValue());
...
//        assertEquals(1, ret.getID().intValue());
	...
	public void testtest_def_queryIgnoreMissingFields_list_first() throws Exception {
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_def_queryIgnoreMissingFields_list_first(Age, new DalHints().inAllShards().ignoreMissingFields());
		assertEquals(1, ret.getID().intValue());
	...
	public void testtest_def_queryAllowPartial_list_first() throws Exception {
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_def_queryAllowPartial_list_first(Age, new DalHints().inAllShards().allowPartial());
		assertEquals(1, ret.getID().intValue());
	...
	public void testtest_def_queryIgnoreMissingFields_list() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> pojos=dao.test_def_queryIgnoreMissingFields_list(Age, new DalHints().inShard(0).ignoreMissingFields());
	...
	public void testtest_def_queryAllowPartial_list() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> pojos=dao.test_def_queryAllowPartial_list(Age, new DalHints().inShard(0).allowPartial());
		assertEquals(1, pojos.size());
	...
	public void testtest_def_queryFromIgnoreMissingFields_list() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> pojos=dao.test_def_queryFromIgnoreMissingFields_list(Age, new DalHints().inShard(0).ignoreMissingFields(),0,1);
		assertEquals(1, pojos.size());
	...
	public void testtest_def_queryFromAllowPartial_list() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> pojos=dao.test_def_queryFromAllowPartial_list(Age, new DalHints().inShard(0).allowPartial(),0,1);
		assertEquals(1, pojos.size());
		assertEquals(20, pojos.get(0).getAge().intValue());
		assertEquals(1, pojos.get(0).getID().intValue());
	...
	public void testtest_def_queryIgnoreMissingFields_listByPage() throws Exception {
        ...
        List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_def_queryIgnoreMissingFields_listByPage(Age,2,2, new DalHints().setShardValue(3).ignoreMissingFields());
		assertEquals(0, ret.size());
	...
	public void testtest_def_queryAllowPartial_listByPage() throws Exception {
        ...
        List<ignoreMissingFieldsAndAllowPartialTestOnMysqlGen> ret = dao.test_def_queryAllowPartial_listByPage(Age,2,2, new DalHints().setShardValue(3).allowPartial());
		assertEquals(0, ret.size());
	...
	public void testtest_def_queryIgnoreMissingFields_list_single() throws Exception {
        ...
        DalHints hints=new DalHints();
        DalHints original=hints.clone();
        ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_def_queryIgnoreMissingFields_list_single(Age, hints.setShardColValue("Age", 20).ignoreMissingFields());
        assertEquals(1, ret.getID().intValue());
        List<DalHintEnum> exclude=new ArrayList<>();
        exclude.add(DalHintEnum.ignoreMissingFields);
        exclude.add(DalHintEnum.shardColValues);
	...
	public void testtest_def_queryAllowPartial_list_single() throws Exception {
        ...
        ignoreMissingFieldsAndAllowPartialTestOnMysqlGen ret = dao.test_def_queryAllowPartial_list_single(Age, new DalHints().setShardColValue("Age", 20).allowPartial());
        assertEquals(1, ret.getID().intValue());
