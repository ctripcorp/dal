...
public class NewHintsOfCodeGenOnSqlServerDao {
	...
	private DalRowMapper<SqlServerPeopleTable> pojoPojoRowMapper = null;
	...
	public NewHintsOfCodeGenOnSqlServerDao() throws SQLException {
		...
		this.pojoPojoRowMapper = new DalDefaultJpaMapper<>(SqlServerPeopleTable.class);
	...
	**/
	 ...
	 * 构建，查询
	**/
	public List<SqlServerPeopleTable> test_def_query_shards_varchar(String name, DalHints hints, Set<String> shards) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		hints.inShards(shards);
		hints.asyncExecution();
