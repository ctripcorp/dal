...
public class AbacusCreateSegmentLogGenDaoTest {
	public static void main(String[] args) {
		...
		try {
			...
			**/
			...
			AbacusCreateSegmentLogGenDao dao = new AbacusCreateSegmentLogGenDao();
		
			AbacusCreateSegmentLogGen pk = dao.queryByPk(null);// you value here
			
			pk = dao.queryByPk(pk);
			List<AbacusCreateSegmentLogGen> pojos = dao.queryByPage(pk, 100, 0);
