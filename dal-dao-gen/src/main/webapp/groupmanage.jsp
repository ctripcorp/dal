...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="save_group" type="button" class="btn btn-primary">Save
						changes</button>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row-fluid">
						<div class="control-group">
							<input id="group_id" type="hidden" value=""> <label
								class="control-label popup_label" style="width: 100px;">Team
								Name:</label> <input id="name2" class="span7 input-sm" type="text">&nbsp;
						</div>
					</div>
					<div class="row-fluid">
						<div class="control-group">
				...
				<div class="modal-footer">
					<label id="error_msg2" class="control-label popup_label"
						style="color: red;"></label>
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					<button id="update_group" type="button" class="btn btn-primary">Save
						changes</button>
				</div>
			</div>
		</div>
	...
	<script src="/static/js/groupmanage.js?codegen=${codegenpageflag}"></script>
</body>
</html>
