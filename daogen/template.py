...
from daogen import escape
# from daogen.log import app_log
from daogen.util import bytes_type, ObjectDict, exec_in, unicode_type
...
class Template(object):
    ...
    def __init__(self, template_string, name="<string>", loader=None,
        ...
        try:
            ...
            #print self.name, formatted_code
            raise
