...
import dao.noshard.NoShardTransactionalTestOnSqlServerDao;
 ...
 */
public class NoShardTransactionalTestOnSqlServerNotSpringTest {
    private static NoShardTransactionalTestOnSqlServerDao dao;

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {

        dao= DalTransactionManager.create(NoShardTransactionalTestOnSqlServerDao.class);
    }
