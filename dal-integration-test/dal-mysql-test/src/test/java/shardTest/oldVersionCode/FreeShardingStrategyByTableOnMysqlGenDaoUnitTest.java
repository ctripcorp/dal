...
public class FreeShardingStrategyByTableOnMysqlGenDaoUnitTest {
	...
	public void setUp() throws Exception {
		...
		// By tabelShard
		List<FreeShardingStrategyByTableOnMysqlGen> daoPojos1 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos2 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			assertEquals(3,affected.length);
			// By tableShardValue
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos3 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos4 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			// By shardColValue
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos5 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos6 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
			...
			// By fields
			List<FreeShardingStrategyByTableOnMysqlGen> daoPojos7 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(3);
			for(int i=0;i<3;i++)
			{
				FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
				daoPojo.setAge(i+20);
...
//		dao2.test_def_update(new DalHints(), "1");
	...
	public void testDelete2() throws Exception {
		// By tabelShard
				List<FreeShardingStrategyByTableOnMysqlGen> daoPojos1 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
				for(int i=0;i<2;i++)
				{
					FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
					daoPojo.setID(i+1);
...
//					daoPojo.setName("Initial_TableShard_0"+i);
				...
				List<FreeShardingStrategyByTableOnMysqlGen> daoPojos2 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
				for(int i=0;i<2;i++)
				{
					FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
					daoPojo.setID(i+1);
...
//					daoPojo.setName("Initial_TableShard_1"+i);
				...
				// By tableShardValue
						List<FreeShardingStrategyByTableOnMysqlGen> daoPojos3 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
						for(int i=3;i<5;i++)
						{
							FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
							daoPojo.setID(i+1);
...
//							daoPojo.setName("Initial_TableShard_0"+i);
						...
						List<FreeShardingStrategyByTableOnMysqlGen> daoPojos4 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
						for(int i=3;i<5;i++)
						{
							FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
							daoPojo.setID(i+1);
...
//							daoPojo.setName("Initial_TableShard_1"+i);
						...
						// By shardColValue
						List<FreeShardingStrategyByTableOnMysqlGen> daoPojos5 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
						for(int i=6;i<8;i++)
						{
							FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
							daoPojo.setID(i+1);
...
//							daoPojo.setName("Initial_TableShard_0"+i);
						...
						List<FreeShardingStrategyByTableOnMysqlGen> daoPojos6 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
						for(int i=6;i<8;i++)
						{
							FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
							daoPojo.setID(i+1);
...
//							daoPojo.setName("Initial_TableShard_1"+i);
						...
						// By fields
						List<FreeShardingStrategyByTableOnMysqlGen> daoPojos7 = new ArrayList<FreeShardingStrategyByTableOnMysqlGen>(2);
						for(int i=9;i<11;i++)
						{
							FreeShardingStrategyByTableOnMysqlGen daoPojo = new FreeShardingStrategyByTableOnMysqlGen();
							daoPojo.setID(10);
...
//					daoPojo.setName("Initial_TableShard_0"+i);
	...
	public void testGetAll() throws Exception {
		List<FreeShardingStrategyByTableOnMysqlGen> list = dao.getAll(new DalHints());
	}
	...
	public void testQueryByPage() throws Exception {
		...
		int pageSize = 100;
		int pageNo = 1;
		List<FreeShardingStrategyByTableOnMysqlGen> list = dao.queryByPage(pageSize, pageNo, hints);
	}
	...
	public void testQueryByPk1() throws Exception {
		//by tableShard
				Number id = 3;
				FreeShardingStrategyByTableOnMysqlGen ret = dao.queryByPk(id, new DalHints().inTableShard(0));
	...
	public void testQueryByPk2() throws Exception {
		//by tableShard
				FreeShardingStrategyByTableOnMysqlGen pk = new FreeShardingStrategyByTableOnMysqlGen();
				pk.setID(3);
				FreeShardingStrategyByTableOnMysqlGen ret = dao.queryByPk(pk, new DalHints().inTableShard(0));
				assertEquals("InsertByTableShard_02",ret.getName());
