...
public class ClusterDataSource extends DalDataSource implements DataSource,
    ...
    protected MultiHostDataSource createInnerDataSource() {
        try {
            ...
            MultiHostClusterProperties properties = new MultiHostClusterPropertiesAdapter(cluster.getRouteStrategyConfig(), cluster.getClusterType(), cluster.getClusterName());
