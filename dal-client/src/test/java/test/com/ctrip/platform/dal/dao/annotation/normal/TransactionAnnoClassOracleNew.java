...
@Component("TransactionAnnoClassOracleNew")
public class TransactionAnnoClassOracleNew extends BaseTransactionAnnoClass {
    ...
    public TransactionAnnoClassOracleNew() {
