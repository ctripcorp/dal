...
//        connectionString="Server=10.32.20.128;port=3306;UID=root;password=!QAZ@WSX1qaz2wsx;database=llj_test;"
        String connectionUrl = "jdbc:mysql://10.32.20.128:3306/llj_test?useUnicode=true&characterEncoding=UTF-8";
