...
public class MysqlApiConnectionStringUtils {
    ...
    public static MysqlApiConnectionStringInfo getConnectionStringFromMysqlApi(String dbName, String env, DBModel dbModel) throws Exception {
        MysqlApiConnectionStringInfo info = null;
        String url = "FAT".equalsIgnoreCase(env) ? DB_MYSQL_API_FAT : "UAT".equalsIgnoreCase(env) ?
