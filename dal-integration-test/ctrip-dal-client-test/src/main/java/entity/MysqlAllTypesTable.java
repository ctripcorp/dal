...
public class MysqlAllTypesTable implements DalPojo {
	@Id
	@Column(name="idAll_Types")
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Type(value=Types.BIGINT)
	private BigInteger idallTypes;
	...
	public BigInteger getIdallTypes() {
		return idallTypes;
	}

	public void setIdallTypes(BigInteger idallTypes) {
