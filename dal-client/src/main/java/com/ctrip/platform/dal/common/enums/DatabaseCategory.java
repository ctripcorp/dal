...
public enum DatabaseCategory {
	...
	public String getTopSqlTpl() {
		return queryTopTpl;
	}

	public String getPageSqlTpl() {
		return queryByPageTpl;
	}

	public Set<Integer> getRetriableCodeSet() {
		return retriableCodeSet;
	}

	public Set<Integer> getFailOverableCodeSet() {
		return failOverableCodeSet;
	}
