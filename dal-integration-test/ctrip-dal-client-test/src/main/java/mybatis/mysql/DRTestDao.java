...
public class DRTestDao {
    ...
    private static final String DATA_BASE = "noShardSwitchTestOnMysql";
...
//            this.queryDaoSqlServer = new DalQueryDao("noShardTestOnSqlServer");
     ...
     * The DalDetailResults will be set in hints to allow client know how the operation performed in each of the shardtest.
     *
     * @param hints    Additional parameters that instruct how DAL Client perform database operation.
