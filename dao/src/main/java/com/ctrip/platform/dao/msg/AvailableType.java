package com.ctrip.platform.dao.msg;
...
public class AvailableType implements Comparable {
		...
		default:
			if (object_arg != null && object_arg.getClass().isArray()) {
				...
				for(int i=0;i<Array.getLength(object_arg);i++){
				 ...
				 setPreparedStatementByClass(Array.get(object_arg, i), ps);
				 paramIndex++;
				 }
			} else {
	...
	public void setPreparedStatementByClass(Object obj, PreparedStatement ps)
			throws SQLException {
