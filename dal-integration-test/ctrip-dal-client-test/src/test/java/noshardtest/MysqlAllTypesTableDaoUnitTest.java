...
import dao.noshard.AllTypesOnMysqlDao;
 ...
 **/
public class MysqlAllTypesTableDaoUnitTest {
...
//
//		MysqlAllTypesTable daoPojo1 = new MysqlAllTypesTable();
...
//
//		MysqlAllTypesTable daoPojo2 = new MysqlAllTypesTable();
...
//
//         MysqlAllTypesTable daoPojo3 = new MysqlAllTypesTable();
...
//
//         MysqlAllTypesTable daoPojo4 = new MysqlAllTypesTable();
...
//  		dao.insert(hints, daoPojo4);
        ...
        MysqlAllTypesTable daoPojo5 = new MysqlAllTypesTable();
...
//		dao.insert(hints, daoPojo1);
        ...
        MysqlAllTypesTable daoPojo6 = new MysqlAllTypesTable();
...
//		dao.insert(hints, daoPojo2);
        ...
        MysqlAllTypesTable daoPojo7 = new MysqlAllTypesTable();
...
//		dao.insert(hints, daoPojo3);
        ...
        MysqlAllTypesTable daoPojo8 = new MysqlAllTypesTable();
...
//		dao.insert(hints, daoPojo4);
        ...
        List<MysqlAllTypesTable> pojos = new ArrayList<>();
        pojos.add(daoPojo1);
        pojos.add(daoPojo2);
        pojos.add(daoPojo3);
        pojos.add(daoPojo4);
    ...
    private MysqlAllTypesTable createPojo(int index) {
        MysqlAllTypesTable daoPojo = new MysqlAllTypesTable();
    ...
    private void changePojo(MysqlAllTypesTable daoPojo) {
        // Change a field to make pojo different with original one
    }

    private void changePojos(List<MysqlAllTypesTable> daoPojos) {
        for (MysqlAllTypesTable daoPojo : daoPojos)
            changePojo(daoPojo);
    }

    private void verifyPojo(MysqlAllTypesTable daoPojo) {
        //assert changed value
    }

    private void verifyPojos(List<MysqlAllTypesTable> daoPojos) {
        for (MysqlAllTypesTable daoPojo : daoPojos)
            verifyPojo(daoPojo);
    }
...
//		dao.delete(null, dao.queryAll(null));
    ...
    public void testCombinedInsert1() throws Exception {
        ...
        List<MysqlAllTypesTable> daoPojos = dao.queryAll();
        ...
        MysqlAllTypesTable combinedInsertedPojo = dao.queryByPk(new BigInteger("9"));
    ...
    public void testDelete1() throws Exception {
        MysqlAllTypesTable daoPojo = createPojo(1);
        daoPojo.setIdallTypes(new BigInteger("1"));
        /**
         * WARNING !!!
        ...
        daoPojo.setIdallTypes(new BigInteger("2"));
    ...
    public void testQueryAll() throws Exception {
        List<MysqlAllTypesTable> list = dao.queryAll();
        assertEquals(8, list.size());

        MysqlAllTypesTable queryPojo = dao.queryByPk(new BigInteger("1"));
    ...
    public void testInsert1() throws Exception {
        ...
        MysqlAllTypesTable insertPojo = dao.queryByPk(new BigInteger("9"));
        ...
        insertPojo = dao.queryByPk(new BigInteger("10"));
        assertEquals("insert1", insertPojo.getVarCharCol());
        assertNotEquals("2012-12-12 13:13:13", insertPojo.getTimeStampCol().toString());
    ...
    @Test
    public void testAllColumnsInsert() throws Exception{
        MysqlAllTypesTable daoPojo=new MysqlAllTypesTable();
        daoPojo.setIntCol(3);
        daoPojo.setBigIntCol(3l);
        daoPojo.setMediumIntCol(3);
        daoPojo.setSmallIntCol(3);
        daoPojo.setTinyIntCol(3);
        daoPojo.setFloatCol(3.3f);
        daoPojo.setDoubleCol(3.3d);
        daoPojo.setDecimalCol(new BigDecimal("3.3"));
        daoPojo.setCharCol("c");
        daoPojo.setVarCharCol("cc");
        daoPojo.setDateCol(Date.valueOf("2018-6-27"));
        daoPojo.setDateTimeCol(Timestamp.valueOf("2018-6-27 11:10:00"));
        daoPojo.setTimeCol(Time.valueOf("11:10:00"));
//        daoPojo.setYearCol(Date.valueOf("2018"));
        daoPojo.setLongTextCol("ccccc");
        daoPojo.setMediumTextCol("cccc");
        daoPojo.setTextCol("ccc");
        daoPojo.setTinyTextCol("cc");
        daoPojo.setBitCol(true);
        daoPojo.setEnumCol("1");
        daoPojo.setSetCol("c");
    ...
    @Test
    public void testDefaultTypesWithAllColumns() throws Exception{
        testAllColumnsInsert();
        ...
        List<String> longtextCol=new ArrayList<>();
        longtextCol.add("aaaaa");
        longtextCol.add("bbbbb");
        longtextCol.add("ccccc");

        List<String> mediumtextCol=new ArrayList<>();
        mediumtextCol.add("aaaa");
        mediumtextCol.add("bbbb");
        mediumtextCol.add("cccc");

        List<MysqlAllTypesTable> ret=dao.testDefaultTypesWithAllColumns(3,3l,
                3,3,3,3.0f,3.0d,new BigDecimal("2.0"),charCol,varcharCol,
                Date.valueOf("2018-6-27"),Timestamp.valueOf("2018-6-27 11:10:00"),Time.valueOf("11:10:00"),
                longtextCol,mediumtextCol,"ccc","cc",true,"1","c",null);

        Assert.assertEquals(9,ret.get(0).getIdallTypes().intValue());
    }
    ...
    public void testInsert2() throws Exception {
        ...
        MysqlAllTypesTable insertedPojo = dao.queryByPk(new BigInteger("9"));
...
//		assertArrayEquals(new int[]{1,1,1,1},  affected);
    ...
    public void testQueryAllByPage() throws Exception {
        ...
        int pageSize = 2;
        int pageNo = 2;
        List<MysqlAllTypesTable> list = dao.queryAllByPage(pageNo, pageSize);
    ...
    public void testQueryByPk1() throws Exception {
        ...
        MysqlAllTypesTable affected = dao.queryByPk(id);
    ...
    public void testQueryByPk2() throws Exception {
        MysqlAllTypesTable pk = createPojo(1);
        pk.setIdallTypes(new BigInteger("2"));
        MysqlAllTypesTable affected = dao.queryByPk(pk);
        assertNotNull(affected);
        assertNotEquals("2012-12-12 12:12:12", affected.getTimeStampCol().toString());
    ...
    public void testQueryLike() throws Exception {
        MysqlAllTypesTable sample = createPojo(1);
        sample.setVarCharCol("new");
        List<MysqlAllTypesTable> affected = dao.queryLike(sample);
    ...
    public void testUpdate1() throws Exception {
        MysqlAllTypesTable daoPojo = dao.queryByPk(new BigInteger("1"));
        ...
        daoPojo = dao.queryByPk(new BigInteger("1"));
    ...
    public void testUpdate2() throws Exception {
        ...
        MysqlAllTypesTable daoPojo = dao.queryByPk(new BigInteger("3"));
        ...
        daoPojo = dao.queryByPk(new BigInteger("3"));
    ...
    public void testUpdateSet() throws Exception {
        ...
        //include,单个shard
        MysqlAllTypesTable pojo = dao.queryByPk(5, new DalHints());
        pojo.setIdallTypes(new BigInteger("6"));
        ...
        pojo.setIdallTypes(new BigInteger("7"));
        ...
        //include&exclude
        pojo = dao.queryByPk(5, new DalHints());
        pojo.setIdallTypes(new BigInteger("8"));
    ...
    public void testUpdate2Set() throws Exception {
        ...
        List<MysqlAllTypesTable> daoPojos = new ArrayList<>();
        MysqlAllTypesTable daoPojo1 = dao.queryByPk(5, new DalHints());
        daoPojo1.setIdallTypes(new BigInteger("7"));
        daoPojos.add(daoPojo1);
        MysqlAllTypesTable daoPojo2 = dao.queryByPk(6, new DalHints());
        daoPojo2.setIdallTypes(new BigInteger("8"));
        ...
        MysqlAllTypesTable pojo = dao.queryByPk(7, new DalHints());
        // exclude列没有更新
        assertEquals(3L, pojo.getBigIntCol().longValue());
        assertEquals(3, pojo.getSmallIntCol().intValue());
        assertEquals("a", pojo.getCharCol());
    ...
    public void testBatchUpdateStrings() throws Exception {
        ...
        List<MysqlAllTypesTable> daoPojos = new ArrayList<>();
        MysqlAllTypesTable daoPojo1 = dao.queryByPk(new BigInteger("5"), new DalHints());
        daoPojo1.setIdallTypes(new BigInteger("7"));
        daoPojos.add(daoPojo1);
        MysqlAllTypesTable daoPojo2 = dao.queryByPk(new BigInteger("6"), new DalHints());
        daoPojo2.setIdallTypes(new BigInteger("8"));
        daoPojos.add(daoPojo2);
        ...
        MysqlAllTypesTable pojo = dao.queryByPk(new BigInteger("7"), new DalHints());
        // exclude列没有更新
        assertEquals(3L, pojo.getBigIntCol().longValue());
        assertEquals(3, pojo.getSmallIntCol().intValue());
        assertEquals("a", pojo.getCharCol());
        ...
        pojo = dao.queryByPk(new BigInteger("8"), new DalHints());
        //exclude列没有更新
        assertEquals(4L, pojo.getBigIntCol().longValue());
        assertEquals(4, pojo.getSmallIntCol().intValue());
        assertEquals("a", pojo.getCharCol());
    ...
    public void testtest_build_query_notnull() throws Exception {
        ...
        List<MysqlAllTypesTable> ret = dao.test_build_query_notnull(CharCol, SetCol, BitCol,
    ...
    public void testFreeSqlLikePattern() throws Exception {
        List<MysqlAllTypesTable> ret1 = dao.testFreeSqlLikePattern("n", MatchPattern.BEGIN_WITH);
        assertEquals(2, ret1.size());
        assertEquals(100, ret1.get(0).getBigIntCol().intValue());
        assertEquals(2, ret1.get(1).getBigIntCol().intValue());

        List<MysqlAllTypesTable> ret2 = dao.testFreeSqlLikePattern("e", MatchPattern.CONTAINS);
        assertEquals(4, ret2.size());

        List<MysqlAllTypesTable> ret3 = dao.testFreeSqlLikePattern("ful", MatchPattern.END_WITH);
        assertEquals(2, ret3.size());

        List<MysqlAllTypesTable> ret4 = dao.testFreeSqlLikePattern("%ful", MatchPattern.USER_DEFINED);
        assertEquals(2, ret4.size());
    }

    @Test
    public void testFreeSqlNotLikePattern() throws Exception {
        List<MysqlAllTypesTable> ret1 = dao.testFreeSqlNotLikePattern("n", MatchPattern.BEGIN_WITH);
        assertEquals(6, ret1.size());

        List<MysqlAllTypesTable> ret2 = dao.testFreeSqlNotLikePattern("e", MatchPattern.CONTAINS);
        assertEquals(4, ret2.size());

        List<MysqlAllTypesTable> ret3 = dao.testFreeSqlNotLikePattern("ful", MatchPattern.END_WITH);
        assertEquals(6, ret3.size());

        List<MysqlAllTypesTable> ret4 = dao.testFreeSqlNotLikePattern("%ful", MatchPattern.USER_DEFINED);
    ...
    public void testFreeSqlNotNotNull() throws Exception {
        ...
        List<MysqlAllTypesTable> ret = dao.testNotNotNull(low, upper, bigIntCol, varCharCol);
        assertEquals(2, ret.size());
    ...
    public void testFreeSqlNotNullable() throws Exception {
        ...
        List<MysqlAllTypesTable> ret = dao.testNotNullable(null, 4, bigIntCol, varCharCol);
    ...
    public void testFreeSqlQueryNotNullWithSet() throws Exception {
        ...
        varCharCol.add("colorful");
        varCharCol.add("world");
        List<MysqlAllTypesTable> ret = dao.testFreeSqlQueryNotNullWithSet(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
                BigIntCol_end, varCharCol, new DalHints());
        assertEquals(2, ret.size());
        assertNotEquals("2012-12-12 12:12:12", ret.get(0).getTimeStampCol().toString());
    ...
    public void testFreeSqlQueryNotNull() throws Exception {
        ...
        varCharCol.add("colorful");
        varCharCol.add("world");
        List<MysqlAllTypesTable> ret = dao.testFreeSqlQueryNotNull(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
                BigIntCol_end, varCharCol, new DalHints());
        assertEquals(2, ret.size());
        assertNotEquals("2012-12-12 12:12:12", ret.get(0).getTimeStampCol().toString());
    ...
    public void testFreeSqlSetNullable() throws Exception {
        List<MysqlAllTypesTable> ret1 = dao.testFreeSqlSetNullableAndIncludeAll(null, new DalHints());
        assertEquals(8, ret1.size());

        List<MysqlAllTypesTable> ret2 = dao.testFreeSqlSetNullableAndExcludeAll(null, new DalHints());
    ...
    public void testFreeSqlQueryWithAppendNullable() throws Exception {
        ...
        varCharCol.add(null);
        varCharCol.add("world");
        List<MysqlAllTypesTable> ret = dao.testFreeSqlQueryWithAppendNullable(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
                BigIntCol_end, varCharCol, new DalHints());
    ...
    public void testFreeSqlQueryNullable() throws Exception {
        ...
        varCharCol.add(null);
        varCharCol.add("world");
        List<MysqlAllTypesTable> ret = dao.testFreeSqlQueryNullable(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
                BigIntCol_end, varCharCol, new DalHints());
        assertEquals(4, ret.size());
        assertNotEquals("2012-12-12 12:12:12", ret.get(0).getTimeStampCol().toString());
    ...
    public void testtest_build_query_nullable() throws Exception {
        ...
        varCharCol.add(null);
        varCharCol.add("world");
        List<MysqlAllTypesTable> ret = dao.test_build_query_nullable(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
                BigIntCol_end, varCharCol, new DalHints());
        assertEquals(4, ret.size());
        assertNotEquals("2012-12-12 12:12:12", ret.get(0).getTimeStampCol().toString());
...
//		Date date=new Timestamp(DateUtil.stringToDate("2016-06-18","yyyy-MM-dd").getTime())
        MysqlAllTypesTable ret = dao.test_build_query_firstnullable(CharCol, SetCol, BitCol,
                IntCol, SmallIntCol, MediumIntCol, DecimalCol, BigIntCol_start,
    ...
    public void testtestBuildDelete() throws Exception {
        ...
        MysqlAllTypesTable daoPojo = dao.queryByPk(1);
        assertNull(daoPojo);
    ...
    public void testtestBuildInsert() throws Exception {
        ...
        MysqlAllTypesTable daoPojo = dao.queryByPk(5);
    ...
    public void testtestBuildUpdate() throws Exception {
        ...
        MysqlAllTypesTable daoPojo = dao.queryByPk(3);
    ...
    public void testtestBuildQueryPojoFirst() throws Exception {
        Integer id = 1;// Test value here
        MysqlAllTypesTable ret = dao.testBuildQueryPojoFirst(id);
    ...
    public void testtestBuildQueryPojoList() throws Exception {
        Integer id = 1;// Test value here
        List<MysqlAllTypesTable> ret = dao.testBuildQueryPojoList(id);
        assertEquals(7, ret.size());
    ...
    public void testtestBuildQueryPojoListByPage() throws Exception {
        Integer id = 1;// Test value here
        List<MysqlAllTypesTable> ret = dao.testBuildQueryPojoListByPage(id, 2, 2);
        assertEquals(2, ret.size());
    ...
    public void testtestBuildQueryPojoSingle() throws Exception {
        ...
        MysqlAllTypesTable ret = dao.testBuildQueryPojoSingle(id);
    ...
    public void testtestDefUpdate() throws Exception {
        ...
        MysqlAllTypesTable pojo = dao.queryByPk(2);
    ...
    public void testFreeSqlDelete() throws Exception {
        ...
        MysqlAllTypesTable pojo = dao.queryByPk(1);
        assertNull(pojo);
    ...
    public void testFreeSqlInsert() throws Exception {
        ...
        MysqlAllTypesTable pojo = dao.queryByPk(9);
    ...
    public void testtestDefQueryPojoFirst() throws Exception {
        Integer id = 1;// Test value here
        MysqlAllTypesTable ret = dao.testDefQueryPojoFirst(id);
        assertEquals("new", ret.getVarCharCol());
    ...
    public void testFreeSqlQueryPojoFirst() throws Exception {
        Integer id = 1;// Test value here
        MysqlAllTypesTable ret = dao.testFreeSqlQueryFirst(id, null);
        assertEquals("new", ret.getVarCharCol());
    }
    ...
    public void testtestDefQueryPojoList() throws Exception {
        ...
        intcol.add(12);
        intcol.add(99);
        List<MysqlAllTypesTable> ret = dao.testDefQueryPojoList(intcol);
    ...
    public void testtestDefQueryPojoListByPage() throws Exception {
        Integer id = 1;// Test value here
        List<MysqlAllTypesTable> ret = dao.testDefQueryPojoListByPage(id, 2, 2);
        assertEquals(2, ret.size());
    ...
    public void testFreeSqlQueryPojoListByPage() throws Exception {
        Integer id = 1;// Test value here
        List<MysqlAllTypesTable> ret = dao.testFreeSqlQueryListByPage(id, 2, 2, null);
        assertEquals(2, ret.size());
    }
    ...
    public void testtestDefQueryPojoSingle() throws Exception {
        Integer id = 1;// Test value here
        MysqlAllTypesTable ret = dao.testDefQueryPojoSingle(id);
