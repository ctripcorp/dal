...
//		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
	...
	**/
	public List<SqlServerPeopleTable> test(int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	...
	private class PeopleShardColModShardByDBOnSqlServerComparator implements Comparator<SqlServerPeopleTable>{
		@Override
...
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,1,1), new DalListMerger<PeopleShardColModShardByDBOnSqlServer>());
	    ...
	    builder.addQuery(sqlList, new StatementParameters(), SqlServerPeopleTable.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,1,1), new DalListMerger<PeopleShardColModShardByDBOnSqlServer>());
	    ...
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), SqlServerPeopleTable.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlObject, parameters, Integer.class);
	    ...
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), SqlServerPeopleTable.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlNoResult, new StatementParameters(),new TestDalRowCallback3());//callback
	    ...
	    builder.addQuery(sqlInParam, parameters, SqlServerPeopleTable.class, new PeopleShardColModShardByDBOnSqlServerComparator());
	    ...
	    builder.addQuery(sqlNoResult, new StatementParameters(), SqlServerPeopleTable.class, new PeopleShardColModShardByDBOnSqlServerComparator());
