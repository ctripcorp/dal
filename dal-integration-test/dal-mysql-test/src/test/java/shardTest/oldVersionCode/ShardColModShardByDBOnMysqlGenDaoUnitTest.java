...
//	    assertEquals(2, ret);
	    ...
	    List<ShardColModShardByDBOnMysqlGen> daoPojos1 = new ArrayList<>(
				3);

		for (int i = 0; i < 6; i++) {
			ShardColModShardByDBOnMysqlGen daoPojo = new ShardColModShardByDBOnMysqlGen();
			daoPojo.setAge(i + 20);
			if(i%2==0)
...
//		dao.test_def_update(new DalHints().inShard(1));
	...
	public void testDelete2() throws Exception {
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> daoPojos = new ArrayList<>(2);
		ShardColModShardByDBOnMysqlGen daoPojo1=new ShardColModShardByDBOnMysqlGen();
		daoPojo1.setID(1);
		daoPojo1.setAge(20);
		daoPojos.add(daoPojo1);
		
		ShardColModShardByDBOnMysqlGen daoPojo2=new ShardColModShardByDBOnMysqlGen();
		daoPojo2.setID(1);
		daoPojo2.setAge(21);
	...
	public void testBatchDelete() throws Exception {
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> daoPojos = null;
	...
	public void testGetAll() throws Exception {
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> list = dao.getAll(hints.inShard(1));
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shard);
		DalHintsChecker.checkEquals(original,hints,exclude);
	}
	...
	public void testInsert2() throws Exception {
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> daoPojos = dao.getAll(new DalHints().inAllShards());
	...
	public void testInsert3() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen daoPojo = dao.queryByPk(1,new DalHints().inShard(0));
	...
	public void testInsert4() throws Exception {
		...
		DalHints original=hints.clone();
		KeyHolder keyHolder = new KeyHolder();
		List<ShardColModShardByDBOnMysqlGen> daoPojos = dao.getAll(new DalHints().inShard(1));
	...
	public void testQueryByPage() throws Exception {
		...
		int pageSize = 100;
		int pageNo = 1;
		List<ShardColModShardByDBOnMysqlGen> list = dao.queryByPage(pageSize, pageNo, hints.inShard(0));
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shard);
		DalHintsChecker.checkEquals(original,hints,exclude);
	}
	...
	public void testQueryByPk1() throws Exception {
		...
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		ShardColModShardByDBOnMysqlGen ret = dao.queryByPk(id, hints.inShard(0));
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shard);
		DalHintsChecker.checkEquals(original,hints,exclude);
	}
	...
	public void testQueryByPk2() throws Exception {
		ShardColModShardByDBOnMysqlGen pk = new ShardColModShardByDBOnMysqlGen();
		pk.setID(2);
		pk.setAge(21);
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		ShardColModShardByDBOnMysqlGen ret = dao.queryByPk(pk, hints);
	...
	public void testUpdate1() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen updatePojo=dao.queryByPk(1L, hints1.inShard(0));
	...
	public void testUpdate_null() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen updatePojo=dao.queryByPk(1L, new DalHints().inShard(0));
	...
	public void testUpdate2() throws Exception {
		DalHints hints = new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> daoPojos = dao.getAll(new DalHints().inShard(0));
	...
	public void testtest_build_delete() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen	pojo=dao.queryByPk(1L, new DalHints().inShard(0));
		assertNull(pojo);
	...
	public void testtest_build_insert() throws Exception {
	    ...
	    ShardColModShardByDBOnMysqlGen	pojo=dao.queryByPk(4L, new DalHints().inShard(0));
		assertNotNull(pojo);
...
//		assertEquals("build_update_shard", pojo.getName());    
	...
	public void testtest_build_queryFrom() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_queryFrom(Age, hints.inAllShards(),1,1);
	...
	public void testtest_build_queryFromPartialFieldsSet() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_queryFromPartialFieldsSet(Age, new DalHints().inAllShards(),1,1);
		assertEquals(1, ret.size());
		assertEquals(21, ret.get(0).getAge().intValue());
	...
	public void testtest_build_queryFromPartialFieldsStrings() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_queryFromPartialFieldsStrings(Age, new DalHints().inAllShards(),1,1);
		assertEquals(1, ret.size());
		assertEquals(21, ret.get(0).getAge().intValue());
		assertNull(ret.get(0).getID());
	...
	public void testtest_ClientQueryFrom_list() throws Exception {
		...
		Age.add(23);
		Age.add(22);
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_ClientQueryFrom_list(Age, new DalHints().inAllShards(), 0, 1);
	    assertEquals(1, ret.size());
	...
	public void testtest_ClientQueryFromPartialFieldsSet_list() throws Exception {
		...
		Age.add(23);
		Age.add(22);
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_ClientQueryFromPartialFieldsSet_list(Age, new DalHints().inAllShards(), 0, 1);
	    assertEquals(1, ret.size());
	    assertEquals(20, ret.get(0).getAge().intValue());
	    assertNull(ret.get(0).getID());
	...
	public void testtest_ClientQueryFromPartialFieldsStrings_list() throws Exception {
		...
		Age.add(23);
		Age.add(22);
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_ClientQueryFromPartialFieldsStrings_list(Age, new DalHints().inAllShards(), 0, 1);
	    assertEquals(1, ret.size());
	    assertEquals(20, ret.get(0).getAge().intValue());
	    assertNull(ret.get(0).getID());
	...
	public void testtest_build_query_first() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen ret = dao.test_build_query_first(Age, new DalHints().inAllShards());
...
//        assertNull(ret);
	...
	public void testtest_build_queryPartialFields_first() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen ret = dao.test_build_queryPartialFields_first(Age, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_build_query() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_query(Age, hints.inAllShards());
	...
	public void testtest_build_queryPartialFields() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_queryPartialFields(Age, hints.inAllShards());
		assertEquals(2, ret.size());
	...
	public void testtest_build_query_byPage() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_query_byPage(Age,2,2, hints.setShardValue(3));
	...
	public void testtest_build_queryPartialFields_byPage() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_queryPartialFields_byPage(Age,2,2, hints.setShardValue(3));
		assertEquals(0, ret.size());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardValue);
		exclude.add(DalHintEnum.partialQuery);
	...
	public void testtest_build_query_single() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        ShardColModShardByDBOnMysqlGen ret = dao.test_build_query_single(Age, hints.setShardColValue("Age", 20));
        assertEquals("Initial_Shard_00", ret.getName());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardColValues);
		DalHintsChecker.checkEquals(original,hints,exclude);
	...
	public void testtest_build_queryPartialFields_single() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        ShardColModShardByDBOnMysqlGen ret = dao.test_build_queryPartialFields_single(Age, hints.setShardColValue("Age", 20));
        assertEquals("Initial_Shard_00", ret.getName());
		assertEquals(20, ret.getAge().intValue());
		assertNull(ret.getBirth());
		assertNull(ret.getID());
	...
	public void testtest_def_update() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.getAll(new DalHints().inShard(0));
	...
	public void testtest_def_query_list_first() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen ret = dao.test_def_query_list_first(Age, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_def_queryPartialSet_list_first() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen ret = dao.test_def_queryPartialSet_list_first(Age, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
		assertEquals(20,ret.getAge().intValue());
		assertNull(ret.getID());
		assertNull(ret.getBirth());
	...
	public void testtest_def_queryPartialStrings_list_first() throws Exception {
		...
		ShardColModShardByDBOnMysqlGen ret = dao.test_def_queryPartialStrings_list_first(Age, new DalHints().inAllShards());
		assertEquals("Initial_Shard_00", ret.getName());
		assertEquals(20,ret.getAge().intValue());
		assertNull(ret.getID());
		assertNull(ret.getBirth());
	...
	public void testtest_def_query_list() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_query_list(Age, hints.inShard(0));
	...
	public void testtest_def_queryFrom_list() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_queryFrom_list(Age, new DalHints().inShard(0),0,1);
		assertEquals(1, pojos.size());
	...
	public void testtest_def_queryFromPartialFieldsStrings_list() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_queryFromPartialFieldsStrings_list(Age, new DalHints().inShard(0),0,1);
		assertEquals(1, pojos.size());
		assertEquals(20, pojos.get(0).getAge().intValue());
	...
	public void testtest_def_queryFromPartialFieldsSet_list() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_queryFromPartialFieldsSet_list(Age, new DalHints().inShard(0),0,1);
		assertEquals(1, pojos.size());
		assertEquals(20, pojos.get(0).getAge().intValue());
		assertNull(pojos.get(0).getID());
	...
	public void testtest_def_queryPartialSet_list() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_queryPartialSet_list(Age, new DalHints().inShard(0));
		assertEquals(1, pojos.size());
	...
	public void testtest_def_queryPartialStrings_list() throws Exception {
		...
		List<ShardColModShardByDBOnMysqlGen> pojos=dao.test_def_queryPartialStrings_list(Age, new DalHints().inShard(0));
		assertEquals(1, pojos.size());
		assertEquals("Initial_Shard_00", pojos.get(0).getName());
		assertEquals(20,pojos.get(0).getAge().intValue());
		assertNull(pojos.get(0).getID());
	...
	public void testtest_def_query_listByPage() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        List<ShardColModShardByDBOnMysqlGen> ret = dao.test_def_query_listByPage(Age,2,2, hints.setShardValue(3));
		assertEquals(0, ret.size());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardValue);
		DalHintsChecker.checkEquals(original,hints,exclude);
	...
	public void testtest_def_queryPartialSet_listByPage() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        List<ShardColModShardByDBOnMysqlGen> ret = dao.test_def_queryPartialSet_listByPage(Age,2,2, hints.setShardValue(3));
		assertEquals(0, ret.size());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardValue);
		exclude.add(DalHintEnum.partialQuery);
	...
	public void testtest_def_queryPartialStrings_listByPage() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        List<ShardColModShardByDBOnMysqlGen> ret = dao.test_def_queryPartialStrings_listByPage(Age,2,2, hints.setShardValue(3));
		assertEquals(0, ret.size());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardValue);
		exclude.add(DalHintEnum.partialQuery);
	...
	public void testtest_def_query_list_single() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        ShardColModShardByDBOnMysqlGen ret = dao.test_def_query_list_single(Age, hints.setShardColValue("Age", 20));
        assertEquals("Initial_Shard_00", ret.getName());
		List<DalHintEnum> exclude=new ArrayList<>();
		exclude.add(DalHintEnum.shardColValues);
		DalHintsChecker.checkEquals(original,hints,exclude);
	...
	public void testtest_def_queryPartialSet_list_single() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        ShardColModShardByDBOnMysqlGen ret = dao.test_def_queryPartialSet_list_single(Age,hints.setShardColValue("Age", 20));
        assertEquals("Initial_Shard_00", ret.getName());
        assertEquals(20,ret.getAge().intValue());
		assertNull(ret.getID());
		assertNull(ret.getBirth());
	...
	public void testtest_def_queryPartialStrings_list_single() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
        ShardColModShardByDBOnMysqlGen ret = dao.test_def_queryPartialStrings_list_single(Age, hints.setShardColValue("Age", 20));
        assertEquals("Initial_Shard_00", ret.getName());
        assertEquals(20,ret.getAge().intValue());
		assertNull(ret.getID());
		assertNull(ret.getBirth());
	...
	public void testtest_build_update_equal() throws Exception {
	    ...
	    ShardColModShardByDBOnMysqlGen pojo=dao.queryByPk(1, new DalHints().inShard(0));
	...
	public void testtest_build_query_equal() throws Exception {
		...
		DalHints hints=new DalHints();
		DalHints original=hints.clone();
		List<ShardColModShardByDBOnMysqlGen> ret = dao.test_build_query_equal(Age, new DalHints());
		assertEquals(1, ret.size());
		assertEquals("Initial_Shard_00", ret.get(0).getName());
		DalHintsChecker.checkEquals(original,hints);
	}
