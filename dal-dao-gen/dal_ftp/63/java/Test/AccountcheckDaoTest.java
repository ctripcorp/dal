...
public class AccountcheckDaoTest {
	public static void main(String[] args) {
		...
		try {
			...
			**/
			...
			AccountcheckDao dao = new AccountcheckDao();
		
			Accountcheck pk = dao.queryByPk(null);// you value here
			
			pk = dao.queryByPk(pk);
			List<Accountcheck> pojos = dao.queryByPage(pk, 100, 0);
