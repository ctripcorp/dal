...
public class ManyTypesTank1 implements DalPojo {
	private Integer id;
	...
	private Boolean tinyIntOne;
	private String charTow;
	private Date year;
	...
	public Boolean getTinyIntOne() {
		return tinyIntOne;
	}

	public void setTinyIntOne(Boolean tinyIntOne) {
		this.tinyIntOne = tinyIntOne;
	}

	public String getCharTow() {
		return charTow;
	}

	public void setCharTow(String charTow) {
		this.charTow = charTow;
	}
