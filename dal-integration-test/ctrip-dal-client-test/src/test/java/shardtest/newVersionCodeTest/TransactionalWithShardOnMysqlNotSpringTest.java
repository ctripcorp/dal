...
import dao.shard.newVersionCode.TransactionalWithShardOnMysqlDao;
 ...
 */
public class TransactionalWithShardOnMysqlNotSpringTest {
    private static TransactionalWithShardOnMysqlDao dao;

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {

        dao= DalTransactionManager.create(TransactionalWithShardOnMysqlDao.class);
    }
