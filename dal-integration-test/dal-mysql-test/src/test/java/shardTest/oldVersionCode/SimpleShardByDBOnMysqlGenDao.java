...
public class SimpleShardByDBOnMysqlGenDao {
...
//    private DalParser<Integer> parser1 = null;	
	...
	private DalParser<SimpleShardByDBOnMysqlGen> parser = null;	
	private DalScalarExtractor extractor = new DalScalarExtractor();
	private DalTableDao<SimpleShardByDBOnMysqlGen> client;
	private DalQueryDao queryDao = null;
	private DalClient baseClient;
	private DalRowMapper<SimpleShardByDBOnMysqlGen> personSimpleShardByDBOnMysqlGenRowMapper = null;
	
	public SimpleShardByDBOnMysqlGenDao() throws SQLException {
		parser = new DalDefaultJpaParser<>(SimpleShardByDBOnMysqlGen.class);
		this.client = new DalTableDao<SimpleShardByDBOnMysqlGen>(parser);
		this.personSimpleShardByDBOnMysqlGenRowMapper = new DalDefaultJpaMapper(SimpleShardByDBOnMysqlGen.class);
		dbCategory = this.client.getDatabaseCategory();
		this.queryDao = new DalQueryDao(DATA_BASE);
		this.baseClient = DalClientFactory.getClient(DATA_BASE);
	}

	private class SimpleShardByDBOnMysqlGenComparator implements Comparator<SimpleShardByDBOnMysqlGen> {
		@Override
		public int compare(SimpleShardByDBOnMysqlGen o1, SimpleShardByDBOnMysqlGen o2) {
	...
	**/
	public SimpleShardByDBOnMysqlGen queryByPk(Number id, DalHints hints)
			throws SQLException {
	...
	**/
	public SimpleShardByDBOnMysqlGen queryByPk(SimpleShardByDBOnMysqlGen pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> queryByPage(int pageSize, int pageNo, DalHints hints)  throws SQLException {
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> getAll(DalHints hints) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		List<SimpleShardByDBOnMysqlGen> result = null;
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, SimpleShardByDBOnMysqlGen daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @return how many rows been affected
	 */
	public int[] insert(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, KeyHolder keyHolder, SimpleShardByDBOnMysqlGen daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] insert(DalHints hints, KeyHolder keyHolder, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchInsert(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, KeyHolder keyHolder, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int delete(DalHints hints, SimpleShardByDBOnMysqlGen daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] delete(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchDelete(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int update(DalHints hints, SimpleShardByDBOnMysqlGen daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] update(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchUpdate(DalHints hints, List<SimpleShardByDBOnMysqlGen> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> test_build_query(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
	    ...
	    String sql = builder.build();
		StatementParameters parameters = builder.buildParameters();
		return queryDao.query(sql, parameters, hints.sortBy(new SimpleShardByDBOnMysqlGenComparator()), parser);
	}
	/**
	 * SimpleShardByDBOnMysql，构建，查询，ListByPage
	**/
	public List<SimpleShardByDBOnMysqlGen> test_build_query_byPage(List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, true);
		builder.select("Birth","Name","Age","ID");
		builder.inNullable("Age", Age, Types.INTEGER, false);
	...
	**/
	public SimpleShardByDBOnMysqlGen test_build_query_single(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.in("Age", Age, Types.INTEGER, false);
	...
	**/
	public SimpleShardByDBOnMysqlGen test_build_query_first(List<Integer> Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.inNullable("Age", Age, Types.INTEGER, false);
	    String sql = builder.buildFirst();
		return queryDao.queryFirstNullable(sql, builder.buildParameters(), hints.sortBy(new SimpleShardByDBOnMysqlGenComparator()), parser);
	}
	/**
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> test_def_query_list(List<Integer> Age, DalHints hints) throws SQLException {
		...
		return queryDao.query(sql, parameters, hints.sortBy(new SimpleShardByDBOnMysqlGenComparator()), personSimpleShardByDBOnMysqlGenRowMapper);
	}
	
	/**
	 * SimpleShardByDBOnMysql，自定义sql，查询，list，byPage
	**/
	public List<SimpleShardByDBOnMysqlGen> test_def_query_listByPage(List<Integer> Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		...
		return (List<SimpleShardByDBOnMysqlGen>)queryDao.query(sql, parameters, hints, personSimpleShardByDBOnMysqlGenRowMapper);
	}
	
	/**
	 * SimpleShardByDBOnMysql，自定义sql，查询，list，single
	**/
	public SimpleShardByDBOnMysqlGen test_def_query_list_single(List<Integer> Age, DalHints hints) throws SQLException {
		String sql = "select * from person where Age in (?)";
		sql = SQLParser.parse(sql, Age);
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return (SimpleShardByDBOnMysqlGen)queryDao.queryForObjectNullable(sql, parameters, hints, personSimpleShardByDBOnMysqlGenRowMapper);
	}
	
	/**
	 * SimpleShardByDBOnMysql，自定义sql，查询，list，first
	**/
	public SimpleShardByDBOnMysqlGen test_def_query_list_first(List<Integer> Age, DalHints hints) throws SQLException {
		String sql = "select * from person where Age in (?)";
		sql = SQLParser.parse(sql, Age);
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
		i = parameters.setInParameter(i, "Age", Types.INTEGER, Age);
		return queryDao.queryFirstNullable(sql, parameters, hints.sortBy(new SimpleShardByDBOnMysqlGenComparator()), personSimpleShardByDBOnMysqlGenRowMapper);
	}
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> test_build_query_equal(Integer Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> test_build_query_page(Integer Age, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, true);
		builder.select("Birth","Name","Age","ID");
...
//	}
	...
	**/
	public SimpleShardByDBOnMysqlGen test_build_query_single_greaterThan(Integer Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.greaterThan("Age", Age, Types.INTEGER, false);
	...
	**/
	public SimpleShardByDBOnMysqlGen test_build_query_first_greaterThan(Integer Age, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("person", dbCategory, false);
		builder.select("Birth","Name","Age","ID");
		builder.greaterThan("Age", Age, Types.INTEGER, false);
	...
	**/
	public List<SimpleShardByDBOnMysqlGen> test_def_query_equal(Integer Age, DalHints hints) throws SQLException {
