 ...
 */
@Component
public class BatchOrderFailedWithTransactionalTestCase extends AbstractTestCase {

  @Autowired
  private IdGenerator idGenerator;

  @Autowired
  private OrderServiceWithTransactional orderService;
  ...
  public String description() {
    return "Use Dal Transactional to batch inserting orders with duplicated key";
  }
