...
public class ignoreMissingFieldsAndAllowPartialTestOnMysqlDaoUnitTest {
	...
	public void setUp() throws Exception {
		...
		List<ignoreMissingFieldsAndAllowPartialTestOnMysql> daoPojos = new ArrayList<ignoreMissingFieldsAndAllowPartialTestOnMysql>(
				6);
		for (int i = 0; i < 6; i++) {
			ignoreMissingFieldsAndAllowPartialTestOnMysql daoPojo = new ignoreMissingFieldsAndAllowPartialTestOnMysql();
			daoPojo.setAge(i + 20);
//			if(i%2==0)
...
//		dao.test_def_truncate(new DalHints().inShard(1));
	...
	public void test_build_queryIgnoreMissingFields_first() throws Exception {
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysql ret;
...
//	    assertNull(ret);
	...
	public void testtest_build_queryIgnoreMissingFields_listByPage() throws Exception {
		...
		Age.add(23);
		Age.add(22);
	    List<ignoreMissingFieldsAndAllowPartialTestOnMysql> ret = dao.test_build_query_listByPage(Age, 2, 1, new DalHints().inShard(0).ignoreMissingFields());
...
//	    assertEquals("Initial_Shard_13", ret.get(0).getName());
	...
	public void testtest_build_queryIgnoreMissingFields_single() throws Exception {
		...
		Age.add(23);
		Age.add(22);
	    ignoreMissingFieldsAndAllowPartialTestOnMysql ret = dao.test_build_query_single(Age, new DalHints().setShardColValue("Age", 21).ignoreMissingFields());
	    assertEquals(2, ret.getID().intValue());
	}
...
//	    Age.add(31);
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysql ret = dao.test_def_queryPartialStrings_first(Age, hints.ignoreMissingFields().inShard(1));
	    assertNotNull(ret);
...
//	    Age.add(31);
		...
		ignoreMissingFieldsAndAllowPartialTestOnMysql ret = dao.test_def_queryPartialStrings_first(Age, new DalHints().allowPartial().inShard(1));
	    assertNotNull(ret);	    
	}
