...
public class ConnectionStringParserParserTest {
	...
	public void testMySql() {
		ConnectionStringParser parser = new ConnectionStringParser();
		DataSourceConfigure  c = parser.parse("dao_test_mysql", "Server=DST56614;port=3306;UID=root;password=!QAZ@WSX1qaz2wsx;database=dao_test_mysql;");
		Assert.assertNotNull(c);
		Assert.assertEquals("jdbc:mysql://DST56614:3306/dao_test_mysql?useUnicode=true&characterEncoding=UTF-8", c.getConnectionUrl());
