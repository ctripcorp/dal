...
public class DalGroupDao{
	...
	public List<DalGroup> getAllGroups(){
		return this.jdbcTemplate
				.query("select id, group_name, group_comment,create_user_no, create_time "
						+ "from dal_group",
	...
	public DalGroup getDalGroupById(Integer id){
		List<DalGroup> groups= this.jdbcTemplate
				.query("select id, group_name, group_comment,create_user_no, create_time "
	...
	public int deleteDalGroup(Integer groupId){
		return this.jdbcTemplate
				.update("delete from dal_group where id=?",
						groupId);
	}
}
