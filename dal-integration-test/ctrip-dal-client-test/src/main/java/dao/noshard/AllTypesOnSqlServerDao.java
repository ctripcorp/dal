...
import entity.SqlServerAllTypesTable;
...
public class AllTypesOnSqlServerDao {
	...
	private DalTableDao<SqlServerAllTypesTable> client;
	...
	private DalRowMapper<SqlServerAllTypesTable> AllTypesRowMapper = null;

	public AllTypesOnSqlServerDao() throws SQLException {
		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(SqlServerAllTypesTable.class));
		this.AllTypesRowMapper = new DalDefaultJpaMapper<>(SqlServerAllTypesTable.class);
	 ...
	 * test default type
	 **/
	public List<SqlServerAllTypesTable> testAllColumnsWithDefaultType(Integer IntCol, Short SmallIntCol, Short TinyIntCol, Long BigIntCol, Boolean BitCol, BigDecimal NumericCol, Double FloatCol, BigDecimal DecimalCol,
																	  Float RealCol,List<String> CharCol, List<String> NcharCol, List<String> NvarcharCol, List<String> NvarcharMaxCol, String VarcharCol, String VarcharmaxCol,
																	  Date DateCol, Timestamp DatetimeCol, Timestamp Datetime2Col , Timestamp SmallDatetimeCol, Time TimeCol, BigDecimal MoneyCol, BigDecimal SmallMoneyCol,DalHints hints) throws SQLException {

		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder = new FreeSelectSqlBuilder<>(dbCategory);
		builder.setTemplate("select * from all_types with (nolock) where intcol=? and smallintcol=? and tinyintcol=? and bigintcol=? and bitcol=? and numericcol>? " +
				"and floatcol>? and decimalcol>? and realcol>? and charcol in (?) and ncharcol in (?) and nvarcharcol in (?) and nvarcharmaxcol in (?) " +
				"and varcharcol=? and varcharmaxcol=? and datecol=? and datetimecol=? and datetime2col=? and SmallDatetimeCol>?"+
				" and timecol=? and moneycol=? and smallmoneycol=? order by id");
		StatementParameters parameters = new StatementParameters();
		int i = 1;
		parameters.setSensitive(i++,  IntCol);
		parameters.set(i++,  SmallIntCol);
		parameters.setSensitive(i++, "TinyIntCol", TinyIntCol);
		parameters.set(i++, "BigIntCol", BigIntCol);
		parameters.setSensitive(i++,Types.BOOLEAN,  BitCol);
		parameters.set(i++, "NumericCol",  NumericCol);
		parameters.set(i++,  FloatCol);
		parameters.set(i++, "DecimalCol", DecimalCol);
		parameters.set(i++, "RealCol",  RealCol);
		i = parameters.setSensitiveInParameter(i, "CharCol", CharCol);
		i = parameters.setInParameter(i, "NcharCol",  NcharCol);
		i = parameters.setSensitiveInParameter(i,   NvarcharCol);
		i = parameters.setInParameter(i, "NvarcharMaxCol",  NvarcharMaxCol);
		parameters.set(i++, "VarcharCol",  VarcharCol);
		parameters.set(i++, "VarcharmaxCol",  VarcharmaxCol);
		parameters.set(i++, "DateCol",  DateCol);
		parameters.set(i++, "DatetimeCol",  DatetimeCol);
		parameters.set(i++, "Datetime2Col",  Datetime2Col);
		parameters.set(i++, "SmallDatetimeCol",  SmallDatetimeCol);
		parameters.set(i++, "TimeCol",  TimeCol);
		parameters.set(i++, "MoneyCol",  MoneyCol);
		parameters.set(i++, "SmallMoneyCol",  SmallMoneyCol);
	 ...
	 * 自定义，查询，pojoList
	**/
	public List<SqlServerAllTypesTable> testDefQueryPojoList(List<Integer> intcol) throws SQLException {
	 ...
	 * 自定义，查询，pojoList
	**/
	public List<SqlServerAllTypesTable> testDefQueryPojoList(List<Integer> intcol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<SqlServerAllTypesTable> testDefQueryPojoListByPage(Integer id, int pageNo, int pageSize) throws SQLException {
	 ...
	 * 自定义，查询，pojoListByPage
	**/
	public List<SqlServerAllTypesTable> testDefQueryPojoListByPage(Integer id, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	...
	public List<SqlServerAllTypesTable> testFreeSqlQueryListByPage(Integer id, int pageNo, int pageSize, DalHints hints) throws SQLException{
		hints= DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
		builder.selectAll();
	...
	public SqlServerAllTypesTable testFreeSqlQuerySingle(Integer id, DalHints hints) throws SQLException{
		hints= DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<SqlServerAllTypesTable> builder=new FreeSelectSqlBuilder<>();
		builder.selectAll();
	...
	public SqlServerAllTypesTable testFreeSqlQueryFirst(Integer id, DalHints hints) throws SQLException{
		hints= DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<SqlServerAllTypesTable> builder=new FreeSelectSqlBuilder<>();
		builder.selectAll();
		builder.from("all_types").where(Expressions.greaterThan("id",id, Types.INTEGER)).orderBy("id",true);
	 ...
	 * 自定义，查询，pojoSingle
	**/
	public SqlServerAllTypesTable testDefQueryPojoSingle(Integer id) throws SQLException {
	 ...
	 * 自定义，查询，pojoSingle
	**/
	public SqlServerAllTypesTable testDefQueryPojoSingle(Integer id, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<SqlServerAllTypesTable> builder = new FreeSelectSqlBuilder<>(dbCategory);
		...
		return (SqlServerAllTypesTable)queryDao.query(builder, parameters, hints);
	}
	 ...
	 * 自定义，查询，pojoFirst
	**/
	public SqlServerAllTypesTable testDefQueryPojoFirst(Integer id) throws SQLException {
	 ...
	 * 自定义，查询，pojoFirst
	**/
	public SqlServerAllTypesTable testDefQueryPojoFirst(Integer id, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.setLogicDbName(DATA_BASE);
	...
	**/
	public SqlServerAllTypesTable queryByPk(Number id)
			throws SQLException {
	 ...
	 * The ID must be a number
	**/
	public SqlServerAllTypesTable queryByPk(Number id, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public SqlServerAllTypesTable queryByPk(SqlServerAllTypesTable pk)
			throws SQLException {
	 ...
	 * Query AllTypes by AllTypes instance which the primary key is set
	**/
	public SqlServerAllTypesTable queryByPk(SqlServerAllTypesTable pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<SqlServerAllTypesTable> queryLike(SqlServerAllTypesTable sample)
			throws SQLException {
	 ...
	 * will be used as search criteria.
	**/
	public List<SqlServerAllTypesTable> queryLike(SqlServerAllTypesTable sample, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<SqlServerAllTypesTable> queryAllByPage(int pageNo, int pageSize)  throws SQLException {
	 ...
	 * The pageSize and pageNo must be greater than zero.
	 */
	public List<SqlServerAllTypesTable> queryAllByPage(int pageNo, int pageSize, DalHints hints)  throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<SqlServerAllTypesTable> queryAll() throws SQLException {
	 ...
	 * Get all records from table
	 */
	public List<SqlServerAllTypesTable> queryAll(DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int insert(SqlServerAllTypesTable daoPojo) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, SqlServerAllTypesTable daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @return how many rows been affected
	 */
	public int[] insert(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @return how many rows been affected
	 */
	public int[] insert(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insertWithKeyHolder(KeyHolder keyHolder, SqlServerAllTypesTable daoPojo) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, KeyHolder keyHolder, SqlServerAllTypesTable daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] insertWithKeyHolder(KeyHolder keyHolder, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] insert(DalHints hints, KeyHolder keyHolder, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchInsert(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] batchInsert(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int combinedInsertWithKeyHolder(KeyHolder keyHolder, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int combinedInsert(DalHints hints, KeyHolder keyHolder, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int delete(SqlServerAllTypesTable daoPojo) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int delete(DalHints hints, SqlServerAllTypesTable daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] delete(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] delete(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchDelete(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] batchDelete(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int update(SqlServerAllTypesTable daoPojo) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int update(DalHints hints, SqlServerAllTypesTable daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] update(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] update(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchUpdate(List<SqlServerAllTypesTable> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int[] batchUpdate(DalHints hints, List<SqlServerAllTypesTable> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	...
	public List<SqlServerAllTypesTable> testFreeSqlLikePattern(String varcharcol, MatchPattern matchPattern) throws Exception{
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
		builder.select("VarCharCol","BigIntCol").from("all_types").where().like("VarCharCol",varcharcol,matchPattern,Types.VARCHAR);
		builder.mapWith(SqlServerAllTypesTable.class);
		return queryDao.query(builder,new DalHints().allowPartial());
	}

	public List<SqlServerAllTypesTable> testFreeSqlNotLikePattern(String varcharcol, MatchPattern matchPattern) throws Exception{
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
	...
	public List<SqlServerAllTypesTable> testNotNotNull(int low, int upper, List<Long> BigIntCol, String VarCharCol) throws  Exception{
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
	...
	public List<SqlServerAllTypesTable> testNotNullable(Integer low, Integer upper, List<Long> BigIntCol, String VarCharCol) throws  Exception{
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
		builder.selectAll().from("all_types").where();
	...
	public List<SqlServerAllTypesTable> testFreeSqlQueryNotNullWithSet(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
//		SelectSqlBuilder builder=new SelectSqlBuilder();
//		builder.select("SetCol","TextCol","DecimalCol","TimeCol","FloatCol","BinaryCol","LongTextCol","BitCol","BlobCol","VarCharCol","DoubleCol","TinyBlobCol","MediumIntCol","CharCol","TimeStampCol","EnumCol","TinyIntCol","YearCol","SmallIntCol","MediumBlobCol","TinyTextCol","MediumTextCol","BigIntCol","DateTimeCol","LongBlobCol","GeometryCol","IntCol","idAll_Types","DateCol","VarBinaryCol");
	 ...
	 * ��������ѯ��nullable
	**/
	public List<SqlServerAllTypesTable> test_build_query_nullable(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		return queryDao.query(sql, parameters, hints, parser);
	...
	public List<SqlServerAllTypesTable> testFreeSqlQueryNotNull(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
//		SelectSqlBuilder builder=new SelectSqlBuilder();
//		builder.select("SetCol","TextCol","DecimalCol","TimeCol","FloatCol","BinaryCol","LongTextCol","BitCol","BlobCol","VarCharCol","DoubleCol","TinyBlobCol","MediumIntCol","CharCol","TimeStampCol","EnumCol","TinyIntCol","YearCol","SmallIntCol","MediumBlobCol","TinyTextCol","MediumTextCol","BigIntCol","DateTimeCol","LongBlobCol","GeometryCol","IntCol","idAll_Types","DateCol","VarBinaryCol");
	...
	public List<SqlServerAllTypesTable> testFreeSqlQueryWithAppendNullable(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
//		SelectSqlBuilder builder=new SelectSqlBuilder();
//		builder.select("SetCol","TextCol","DecimalCol","TimeCol","FloatCol","BinaryCol","LongTextCol","BitCol","BlobCol","VarCharCol","DoubleCol","TinyBlobCol","MediumIntCol","CharCol","TimeStampCol","EnumCol","TinyIntCol","YearCol","SmallIntCol","MediumBlobCol","TinyTextCol","MediumTextCol","BigIntCol","DateTimeCol","LongBlobCol","GeometryCol","IntCol","idAll_Types","DateCol","VarBinaryCol");
...
//		builder.bracket("SetCol=? or not BitCol!=?").setNullable("SetCol", SetCol, Types.CHAR).setNullable("BitCol",BitCol, Types.BIT);
	...
	public List<SqlServerAllTypesTable> testFreeSqlSetNullableAndIncludeAll(String varcharcol, DalHints hints) throws Exception{
		hints= DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
	...
	public List<SqlServerAllTypesTable> testFreeSqlSetNullableAndExcludeAll(String varcharcol, DalHints hints) throws Exception{
		hints= DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
		builder.append("select * from all_types");
	...
	public List<SqlServerAllTypesTable> testFreeSqlQueryNullable(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		FreeSelectSqlBuilder<List<SqlServerAllTypesTable>> builder=new FreeSelectSqlBuilder<>();
//		SelectSqlBuilder builder=new SelectSqlBuilder();
//		builder.select("SetCol","TextCol","DecimalCol","TimeCol","FloatCol","BinaryCol","LongTextCol","BitCol","BlobCol","VarCharCol","DoubleCol","TinyBlobCol","MediumIntCol","CharCol","TimeStampCol","EnumCol","TinyIntCol","YearCol","SmallIntCol","MediumBlobCol","TinyTextCol","MediumTextCol","BigIntCol","DateTimeCol","LongBlobCol","GeometryCol","IntCol","idAll_Types","DateCol","VarBinaryCol");
	...
	public List<SqlServerAllTypesTable> test_build_query(Timestamp datatimecol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder =  new SelectSqlBuilder();
		builder.select("TextCol","DatetimeCol","DecimalCol","TimeCol","XmlCol","VarcharmaxCol","FloatCol","VarcharCol","BinaryCol","BitCol","SmallDatetimeCol","HierarchidCol","CharCol","ID","DatetimeOffsetCol","TinyIntCol","SmallIntCol","NvarcharMaxCol","NumericCol","NvarcharCol","BigIntCol","GeographyCol","MoneyCol","Datetime2Col","GeometryCol","UniqueidentifierCol","TimestampCol","IntCol","ImageCol","NtextCol","NcharCol","RealCol","SmallMoneyCol","DateCol","VarBinaryMaxCol","VarBinaryCol");
//		builder.likeNullable("CharCol", CharCol, Types.CHAR, false);
...
//		StatementParameters parameters = builder.buildParameters();
	 ...
	 * ��������ѯ��notnull
	**/
	public List<SqlServerAllTypesTable> test_build_query_notnull(String CharCol, String NcharCol, Boolean BitCol, Integer IntCol, Short SmallIntCol, Short TinyIntCol, BigDecimal NumericCol, Long BigIntCol_start, Long BigIntCol_end, List<String> VarcharCol, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
//		SelectSqlBuilder builder = new SelectSqlBuilder("All_Types", dbCategory, false);
		SelectSqlBuilder builder = new SelectSqlBuilder();
		builder.select("TextCol","DatetimeCol","DecimalCol","TimeCol","XmlCol","VarcharmaxCol","FloatCol","VarcharCol","BinaryCol","BitCol","SmallDatetimeCol","HierarchidCol","CharCol","ID","DatetimeOffsetCol","TinyIntCol","SmallIntCol","NvarcharMaxCol","NumericCol","NvarcharCol","BigIntCol","GeographyCol","MoneyCol","Datetime2Col","GeometryCol","UniqueidentifierCol","TimestampCol","IntCol","ImageCol","NtextCol","NcharCol","RealCol","SmallMoneyCol","DateCol","VarBinaryMaxCol","VarBinaryCol");
...
//		return queryDao.query(sql, parameters, hints, parser);
	...
	**/
	 ...
	 * 构建，查询，pojoList
	**/
	public List<SqlServerAllTypesTable> testBuildQueryPojoList(Integer id) throws SQLException {
	 ...
	 * 构建，查询，pojoList
	**/
	public List<SqlServerAllTypesTable> testBuildQueryPojoList(Integer id, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<SqlServerAllTypesTable> testBuildQueryPojoListByPage(Integer id, int pageNo, int pageSize) throws SQLException {
	 ...
	 * 构建，查询，pojoListByPage
	**/
	public List<SqlServerAllTypesTable> testBuildQueryPojoListByPage(Integer id, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询，pojoSingle
	**/
	public SqlServerAllTypesTable testBuildQueryPojoSingle(Integer id) throws SQLException {
	 ...
	 * 构建，查询，pojoSingle
	**/
	public SqlServerAllTypesTable testBuildQueryPojoSingle(Integer id, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询，pojoFirst
	**/
	public SqlServerAllTypesTable testBuildQueryPojoFirst(Integer id) throws SQLException {
	 ...
	 * 构建，查询，pojoFirst
	**/
	public SqlServerAllTypesTable testBuildQueryPojoFirst(Integer id, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
