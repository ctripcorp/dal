...
jQuery(document).ready(function () {
    ...
    $(".icon-refresh").click(function () {
        ...
        $.get("/rest/daogen/project", function (data) {
            ...
            + '<li><a href="javascript:;" onclick="proj_dao(this);"><i class="icon-sun"></i> 对应DAO</a></li>' 
            + '<li><a href="javascript:;" onclick="proj_file(this);"><i class="icon-twitter"></i> 对应文件</a></li>' 
            + '<li><a href="javascript:;" onclick="edit_proj(this);"><i class="icon-pencil"></i> 编辑</a></li>' 
            + '<li><a href="javascript:;" onclick="del_proj(this);"><i class="icon-trash"></i> 删除</a></li>' 
            + '</ul>' 
            + '</div>' 
            + '</div>';
