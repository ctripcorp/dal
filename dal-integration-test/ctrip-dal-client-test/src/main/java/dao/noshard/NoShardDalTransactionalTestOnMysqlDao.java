 ...
 */
public class NoShardDalTransactionalTestOnMysqlDao extends NoShardTransactionTestOnMysqlDao {
    private static final String DATA_BASE = "noShardTestOnMysql";

    public NoShardDalTransactionalTestOnMysqlDao() throws SQLException {
//        this.client = new DalTableDao<>(new DalDefaultJpaParser<>(MysqlPersonTable.class));
    ...
    public void transPass() throws Exception {
        DalTransactionManager.register(new DalTransactionListener() {
            ...
            public void beforeCommit() throws SQLException {
                System.out.println("beforeTransPassCommit");
//                Assert.assertTrue(DalTransactionManager.isInTransaction());
            }

            @Override
            public void beforeRollback() {
                System.out.println("beforeTransPassRollback");
//                Assert.assertTrue(DalTransactionManager.isInTransaction());
            }

            @Override
            public void afterCommit() {
                System.out.println("afterTransPassCommit");
//                Assert.assertFalse(DalTransactionManager.isInTransaction());
            }

            @Override
            public void afterRollback() {
                System.out.println("afterTransPassRollback");
//                Assert.assertFalse(DalTransactionManager.isInTransaction());
            }
        });
    ...
    @DalTransactional(logicDbName = DATA_BASE)
    public void transPassisolution(DalHints hints) throws Exception {
        DalTransactionManager.register(new DalTransactionListener() {
            @Override
            public void beforeCommit() throws SQLException {
                System.out.println("beforeTransPassCommit");
...
//                Assert.assertFalse(DalTransactionManager.isInTransaction());
    ...
    @DalTransactional(logicDbName = DATA_BASE)
    public void transSetRollback() throws Exception {
        DalTransactionManager.register(new DalTransactionListener() {
            @Override
            public void beforeCommit() throws SQLException {
                System.out.println("beforeTransFailCommit");
