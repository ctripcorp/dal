...
import com.ctrip.framework.dal.dbconfig.plugin.util.CommonConstant;
...
public class SiteOutputEntity {
    ...
    public String buildConnectionString() {
        ...
        switch (providerName) {
            case CommonConstant.NAME_MYSQL_PROVIDER:
                connString = String.format(CommonConstant.FORMAT_MYSQL_CONNECTIONSTRING,
                ...
                break;
            case CommonConstant.NAME_SQLSERVER_PROVIDER:
                connString = String.format(CommonConstant.FORMAT_SQLSERVER_CONNECTIONSTRING,
                        connectionInfo.getServer(),
                        connectionInfo.getPort(),
                        connectionInfo.getUid(),
                        connectionInfo.getPassword(),
