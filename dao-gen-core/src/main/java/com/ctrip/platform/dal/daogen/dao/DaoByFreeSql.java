    ...
    public int insertTask(GenTaskByFreeSql task) {
        try {
            return jdbcTemplate.update(
                    ...
                    task.getComment(), task.getScalarType(), task.getPojoType(), task.isPagination(),
                    task.getSql_style(), task.getApproved(), task.getApproveMsg(), task.getHints(),
                    task.getProject_id(), task.getDatabaseSetName(), task.getClass_name(), task.getMethod_name());
        } catch (Throwable e) {
            throw e;
        }
    }
    ...
    public int updateTask(GenTaskByFreeSql task) {
        try {
            ...
            return jdbcTemplate.update(
                    ...
                    task.getScalarType(), task.getPojoType(), task.isPagination(), task.getSql_style(),
