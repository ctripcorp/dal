...
public class SimpleShardByDBOnSqlServerGenDao {
	...
	public SimpleShardByDBOnSqlServerGenDao() throws SQLException {
		...
		parser = new DalDefaultJpaParser<>(SqlServerPeopleTable.class,DATA_BASE);
		this.client = new DalTableDao<SqlServerPeopleTable>(parser);
		dbCategory = this.client.getDatabaseCategory();
		this.queryDao = new DalQueryDao(DATA_BASE);
		this.baseClient = DalClientFactory.getClient(DATA_BASE);
	}
	/**
	 * Query PeopleSqlServerPeopleTable by the specified ID
	...
	/**
	 * Query PeopleSqlServerPeopleTable by PeopleSqlServerPeopleTable instance which the primary key is set
	 **/
	...
	/**
	 * Query PeopleSqlServerPeopleTable with paging function
	 * The pageSize and pageNo must be greater than zero.
	 **/
	public List<SqlServerPeopleTable> queryByPage(int pageSize, int pageNo, DalHints hints)  throws SQLException {
	 ...
	 **/
	public List<SqlServerPeopleTable> getAll(DalHints hints) throws SQLException {
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
	...
	public List<String> test_build_query_fieldListByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
		...
		return queryDao.query(sql, parameters, hints.sortBy(new SqlServerPeopleTableComparator()), String.class);
	}
	/**
	 ...
	 **/
	public List<SqlServerPeopleTable> test_build_query_pojoList(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory, false);
		...
		String sql = builder.build();
		StatementParameters parameters = builder.buildParameters();
		return queryDao.query(sql, parameters, hints.sortBy(new SqlServerPeopleTableComparator()), parser);
	}
	/**
	 * SimpleShardByDBOnSqlServer，构建，查询,pojoListByPage
	 **/
	public List<SqlServerPeopleTable> test_build_query_pojoListByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory, true);
		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
		builder.inNullable("CityID", CityID, Types.INTEGER, false);
	 ...
	 **/
	public SqlServerPeopleTable test_build_query_pojoSingle(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory, false);
		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
		builder.inNullable("CityID", CityID, Types.INTEGER, false);
	 ...
	 **/
	public SqlServerPeopleTable test_build_query_pojoFirst(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory, false);
		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
		builder.inNullable("CityID", CityID, Types.INTEGER, false);
		String sql = builder.buildFirst();
		return queryDao.queryFirstNullable(sql, builder.buildParameters(), hints.sortBy(new SqlServerPeopleTableComparator()), parser);
	}
	/**
	 ...
	 **/
	public List<SqlServerPeopleTable> test_def_query_pojoList(List<Integer> CityID, DalHints hints) throws SQLException {
		...
		int i = 1;
		i = parameters.setInParameter(i, "CityID", Types.INTEGER, CityID);
		return (List<SqlServerPeopleTable>)queryDao.query(sql, parameters, hints.sortBy(new SqlServerPeopleTableComparator()), PeopleSqlServerPeopleTableRowMapper);
	}
	/**
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoListByPage
	 **/
	public List<SqlServerPeopleTable> test_def_query_pojoListByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
	 ...
	 **/
	public SqlServerPeopleTable test_def_query_pojoSingle(List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
		i = parameters.setInParameter(i, "CityID", Types.INTEGER, CityID);
		return (SqlServerPeopleTable)queryDao.queryForObjectNullable(sql, parameters, hints, PeopleSqlServerPeopleTableRowMapper);
	}
	/**
	 * SimpleShardByDBOnSqlServer，自定义，查询，pojoFirst
	 **/
	public SqlServerPeopleTable test_def_query_pojoFirst(List<Integer> CityID, DalHints hints) throws SQLException {
		String sql = "SELECT * FROM People with (nolock) WHERE CityID in (?)";
		sql = SQLParser.parse(sql, CityID);
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
		i = parameters.setInParameter(i, "CityID", Types.INTEGER, CityID);
		return (SqlServerPeopleTable)queryDao.queryFirstNullable(sql, parameters, hints.sortBy(new SqlServerPeopleTableComparator()), PeopleSqlServerPeopleTableRowMapper);
	}
	/**
	 ...
	 **/
	public List<SqlServerPeopleTable> test_build_query_equal(Integer CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		SelectSqlBuilder builder = new SelectSqlBuilder("People", dbCategory, false);
		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
	 ...
	 **/
	public List<SqlServerPeopleTable> test_def_query_equal(Integer CityID, DalHints hints) throws SQLException {
		String sql = "select * from People with(nolock) where CityID=?";
		StatementParameters parameters = new StatementParameters();
		hints = DalHints.createIfAbsent(hints);
		int i = 1;
		parameters.setSensitive(i++, "CityID", Types.INTEGER, CityID);
		return (List<SqlServerPeopleTable>)queryDao.query(sql, parameters, hints, PeopleSqlServerPeopleTableRowMapper);
	}

	/**
	 * SimpleShardByDBOnSqlserver，自定义查询,分页
	 **/
	public List<SqlServerPeopleTable> def_query_page(Integer CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
