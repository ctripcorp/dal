...
@Entity
@Database(name="testForNullableByMysql")
@Table(name="all_types")
public class AllTypesGen implements DalPojo {
	
	@Id
	@Column(name="idAll_Types")
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Type(value=Types.INTEGER)
	private Integer idAll_Types;
	...
	public Integer getIdAll_Types() {
		return idAll_Types;
	}

	public void setIdAll_Types(Integer idAll_Types) {
		this.idAll_Types = idAll_Types;
	}
