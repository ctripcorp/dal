...
public class LocalizedConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        return preparedStatement != null ? new LocalizedPreparedStatement(validator, preparedStatement) : null;
    }

    @Override
    public CallableStatement prepareCall(String sql) throws SQLException {
        CallableStatement callableStatement = connection.prepareCall(sql);
        return callableStatement != null ? new LocalizedCallableStatement(validator, callableStatement) : null;
    }
