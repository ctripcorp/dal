...
public class AccountBalanceLetterDaoTest {
	public static void main(String[] args) {
		...
		try {
			...
			**/
			...
			AccountBalanceLetterDao dao = new AccountBalanceLetterDao();
		
			AccountBalanceLetter pk = dao.queryByPk(null);// you value here
			
			pk = dao.queryByPk(pk);
			List<AccountBalanceLetter> pojos = dao.queryByPage(pk, 100, 0);
