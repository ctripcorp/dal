...
public class SimpleShardByDBOnMysqlGenDaoUnitTest {
	...
	private List<SimpleShardByDBOnMysqlGen> getModel_list(DalHints hints)
			throws SQLException {
		try {
			return (List<SimpleShardByDBOnMysqlGen>) hints.getAsyncResult()
					.get();
		} catch (Exception e) {
			throw new SQLException(e);
		}
	...
	private SimpleShardByDBOnMysqlGen getModel_Pojo(DalHints hints)
			throws SQLException {
		try {
			return (SimpleShardByDBOnMysqlGen) hints.getAsyncResult().get();
		} catch (Exception e) {
			throw new SQLException(e);
		}
	}
	...
	public class TestQueryResultCallback_list implements DalResultCallback {
		...
		private AtomicReference<List<SimpleShardByDBOnMysqlGen>> model_list = new AtomicReference<>();

		@Override
		public <T> void onResult(T result) {

			model_list.set((List<SimpleShardByDBOnMysqlGen>) result);
		}

		public List<SimpleShardByDBOnMysqlGen> get_list() {
	...
	public class TestQueryResultCallback_Pojo implements DalResultCallback {
		...
		private AtomicReference<SimpleShardByDBOnMysqlGen> model_Pojo = new AtomicReference<>();

		@Override
		public <T> void onResult(T result) {

			model_Pojo.set((SimpleShardByDBOnMysqlGen) result);
		}

		public SimpleShardByDBOnMysqlGen get_Pojo() {
	...
	public void setUp() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> daoPojos1 = new ArrayList<SimpleShardByDBOnMysqlGen>(
				3);

		for (int i = 0; i < 3; i++) {
			SimpleShardByDBOnMysqlGen daoPojo = new SimpleShardByDBOnMysqlGen();
			daoPojo.setAge(i + 20);
		...
		List<SimpleShardByDBOnMysqlGen> daoPojos2 = new ArrayList<SimpleShardByDBOnMysqlGen>(
				3);
		for (int i = 0; i < 3; i++) {
			SimpleShardByDBOnMysqlGen daoPojo = new SimpleShardByDBOnMysqlGen();
			daoPojo.setAge(i + 30);
...
//		assertEquals(6, ret);
	...
	public void testGetAll() throws Exception {
		DalHints hints1 = new DalHints();
		hints1.inShard(1);
		List<SimpleShardByDBOnMysqlGen> list = dao.getAll(hints1);
	...
	public void testInsert2() throws Exception {
		...
		DalHints hints1 = new DalHints().asyncExecution();// 异步返回结果
		List<SimpleShardByDBOnMysqlGen> daoPojos = new ArrayList<SimpleShardByDBOnMysqlGen>(
				3);
		for (int i = 0; i < 3; i++) {
			SimpleShardByDBOnMysqlGen daoPojo = new SimpleShardByDBOnMysqlGen();
			daoPojo.setAge(i + 50);
	...
	public void testCombinedInsert1() throws Exception {
		...
		SimpleShardByDBOnMysqlGen daoPojos1 = new SimpleShardByDBOnMysqlGen();
		daoPojos1.setAge(35);
		daoPojos1.setName("Bella");
		daoPojos.add(daoPojos1);

		SimpleShardByDBOnMysqlGen daoPojos2 = new SimpleShardByDBOnMysqlGen();
		daoPojos2.setAge(47);
	...
	public void testQueryByPage() throws Exception {
		...
		int pageSize = 1;
		int pageNo = 3;
		List<SimpleShardByDBOnMysqlGen> list = dao.queryByPage(pageSize,
				pageNo, hints);
	...
	public void testQueryByPk1() throws Exception {
		...
		DalHints hints1 = new DalHints().asyncExecution();// 异步返回结果
		hints1.inShard(0);
		SimpleShardByDBOnMysqlGen ret = dao.queryByPk(id, hints1);
		assertNull(ret);
	...
	public void testQueryByPk2() throws Exception {
		SimpleShardByDBOnMysqlGen pk = new SimpleShardByDBOnMysqlGen();
		pk.setID(2);
		DalHints hints = new DalHints();

		hints.inShard(0);
		SimpleShardByDBOnMysqlGen ret = dao.queryByPk(pk, hints);
	...
	public void testUpdate1() throws Exception {
		...
		Number id1 = 1l;
		SimpleShardByDBOnMysqlGen ret1 = dao.queryByPk(id1,
		...
		Number id2 = 2l;
		SimpleShardByDBOnMysqlGen ret2 = dao.queryByPk(id2,
	...
	public void testUpdate2() throws Exception {
		...
		Number id3 = 1l;
		SimpleShardByDBOnMysqlGen ret3 = dao.queryByPk(id3,
				new DalHints().inShard(0));
		assertEquals("UpdateShard00", ret3.getName());
		Number id4 = 2l;
		SimpleShardByDBOnMysqlGen ret4 = dao.queryByPk(id4,
				new DalHints().inShard(0));
	...
	public void testtest_build_query_first() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao.test_build_query_first(Age,
				new DalHints().inShard(0));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_build_query() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> ret = dao.test_build_query(Age,
				hints.inAllShards());
		assertNull(ret);
	...
	public void testtest_build_query_byPage() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> ret = dao.test_build_query_byPage(Age,
	...
	public void testtest_build_query_single() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao.test_build_query_single(Age,
				new DalHints().inShard(0));
		assertEquals("Initial_Shard_01", ret.getName());
	...
	public void test_def_query_list() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> ret = dao.test_def_query_list(Age,
				hints.inAllShards());
		assertNull(ret);
	...
	public void test_def_query_listByPage() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> ret = dao.test_def_query_listByPage(
	...
	public void test_def_query_list_single() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao.test_def_query_list_single(Age,
				new DalHints().inShard(0));
		assertEquals("Initial_Shard_01", ret.getName());
	...
	public void test_def_query_list_first() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao.test_def_query_list_first(Age,
				new DalHints().inShard(0));
		assertEquals("Initial_Shard_00", ret.getName());
	...
	public void testtest_build_query_single_greaterThan() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao
	...
	public void testtest_build_query_first_greaterThan() throws Exception {
		...
		SimpleShardByDBOnMysqlGen ret = dao.test_build_query_first_greaterThan(
	...
	public void testtest_def_query_equal() throws Exception {
		...
		List<SimpleShardByDBOnMysqlGen> ret = dao.test_def_query_equal(Age,
				hints.inAllShards());
		assertNull(ret);
		// ret = getModel_list(hints);//异步返回结果
		ret = callback.get_list();// 异步回调
