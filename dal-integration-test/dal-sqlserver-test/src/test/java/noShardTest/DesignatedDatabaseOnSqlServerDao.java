...
public class DesignatedDatabaseOnSqlServerDao {
	private static final boolean ASC = true;
	private DalTableDao<DesignatedDatabaseOnSqlServer> client;
...
//	private static final String DATA_BASE = "SqlServerSimpleShard";
	...
	private DalRowMapper<DesignatedDatabaseOnSqlServer> peopleShardColModShardByDBOnSqlServerRowMapper = null;
	...
	public DesignatedDatabaseOnSqlServerDao() throws SQLException {
		this.client = new DalTableDao<>(new DalDefaultJpaParser<>(DesignatedDatabaseOnSqlServer.class));
		this.peopleShardColModShardByDBOnSqlServerRowMapper = new DalDefaultJpaMapper<>(DesignatedDatabaseOnSqlServer.class);
	...
	/**
	 * Query PeopleShardColModShardByDBOnSqlServer by the specified ID
	 * The ID must be a number
	**/
	public DesignatedDatabaseOnSqlServer queryByPk(Number id, DalHints hints)
			throws SQLException {
	...
	/**
	 * Query PeopleShardColModShardByDBOnSqlServer by PeopleShardColModShardByDBOnSqlServer instance which the primary key is set
	**/
	public DesignatedDatabaseOnSqlServer queryByPk(DesignatedDatabaseOnSqlServer pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<DesignatedDatabaseOnSqlServer> queryLike(DesignatedDatabaseOnSqlServer sample, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	/**
	 * Query PeopleShardColModShardByDBOnSqlServer with paging function
	 * The pageSize and pageNo must be greater than zero.
	 */
	public List<DesignatedDatabaseOnSqlServer> queryAllByPage(int pageNo, int pageSize, DalHints hints)  throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 */
	public List<DesignatedDatabaseOnSqlServer> queryAll(DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, DesignatedDatabaseOnSqlServer daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @return how many rows been affected
	 */
	public int[] insert(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public int insert(DalHints hints, KeyHolder keyHolder, DesignatedDatabaseOnSqlServer daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] insert(DalHints hints, KeyHolder keyHolder, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchInsert(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int delete(DalHints hints, DesignatedDatabaseOnSqlServer daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] delete(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchDelete(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int update(DalHints hints, DesignatedDatabaseOnSqlServer daoPojo) throws SQLException {
		if(null == daoPojo)
			return 0;
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] update(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * @throws SQLException
	 */
	public int[] batchUpdate(DalHints hints, List<DesignatedDatabaseOnSqlServer> daoPojos) throws SQLException {
		if(null == daoPojos || daoPojos.size() <= 0)
			return new int[0];
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * testEqual
	**/
	public List<DesignatedDatabaseOnSqlServer> test(Integer param1, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
...
//		builder.select("CityID","Name","ProvinceID","PeopleID","CountryID");
	...
	**/
	 ...
	 * 构建，查询
	**/
	public List<DesignatedDatabaseOnSqlServer> test_build_query_list(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询部分字段
	**/
	public List<DesignatedDatabaseOnSqlServer> test_build_queryPartial_list(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询
	**/
	public List<DesignatedDatabaseOnSqlServer> test_build_query_listByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询部分字段
	**/
	public List<DesignatedDatabaseOnSqlServer> test_build_queryPartial_listByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询
	**/
	public DesignatedDatabaseOnSqlServer test_build_query_single(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询部分字段
	**/
	public DesignatedDatabaseOnSqlServer test_build_queryPartial_single(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询
	**/
	public DesignatedDatabaseOnSqlServer test_build_query_first(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	 ...
	 * 构建，查询部分字段
	**/
	public DesignatedDatabaseOnSqlServer test_build_queryPartial_first(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	 ...
	 * 自定义，查询
	**/
	public List<DesignatedDatabaseOnSqlServer> test_def_query_list(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<List<DesignatedDatabaseOnSqlServer>> builder = new FreeSelectSqlBuilder<>(dbCategory);
	 ...
	 * 自定义，查询
	**/
	public List<DesignatedDatabaseOnSqlServer> test_def_query_listByPage(List<Integer> CityID, int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	public List<DesignatedDatabaseOnSqlServer> test(int pageNo, int pageSize, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<List<DesignatedDatabaseOnSqlServer>> builder = new FreeSelectSqlBuilder<>(dbCategory);
		builder.setTemplate("select * from [llj_SimpleShardBySqlServerMod_0] .[dbo].[People] with (nolock) where [cityid]=20 and [name]='Initial_Shard_00' order by [peopleid] asc");
		StatementParameters parameters = new StatementParameters();
		builder.mapWith(peopleShardColModShardByDBOnSqlServerRowMapper).atPage(pageNo, pageSize);
	 ...
	 * 自定义，查询
	**/
	public DesignatedDatabaseOnSqlServer test_def_query_listSingle(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);

		FreeSelectSqlBuilder<DesignatedDatabaseOnSqlServer> builder = new FreeSelectSqlBuilder<>(dbCategory);
		builder.setTemplate("select * from People with (nolock) where CityID in (?)");
		StatementParameters parameters = new StatementParameters();
		int i = 1;
		i = parameters.setSensitiveInParameter(i, "CityID", Types.INTEGER, CityID);
		...
		return (DesignatedDatabaseOnSqlServer)queryDao.query(builder, parameters, hints);
	}

	/**
	 * 自定义，查询
	**/
	public DesignatedDatabaseOnSqlServer test_def_query_listFirst(List<Integer> CityID, DalHints hints) throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	...
	public List<DesignatedDatabaseOnSqlServer> test_def_top(DalHints hints) throws Exception {
		hints = DalHints.createIfAbsent(hints);
		StatementParameters parameters = new StatementParameters();
		int i = 1;
		return	queryDao.query("select top 100 * from People", parameters, hints, DesignatedDatabaseOnSqlServer.class);
	}
	...
	**/
	...
	private class PeopleShardColModShardByDBOnSqlServerComparator implements Comparator<DesignatedDatabaseOnSqlServer>{
		@Override
		public int compare(DesignatedDatabaseOnSqlServer o1, DesignatedDatabaseOnSqlServer o2) {
...
public List queryListMultipleAllShards(DalHints hints) throws SQLException {
	    ...
	    builder.addQuery(sqlList, new StatementParameters(),peopleShardColModShardByDBOnSqlServerRowMapper,new DalListMerger<DesignatedDatabaseOnSqlServer>());//ListMerger
	    builder.addQuery(sqlList, new StatementParameters(), DesignatedDatabaseOnSqlServer.class);
	    builder.addQuery(sqlList, new StatementParameters(), DesignatedDatabaseOnSqlServer.class, new DalListMerger<DesignatedDatabaseOnSqlServer>());
//	    builder.addQuery(sqlList, new StatementParameters(), PeopleShardColModShardByDBOnSqlServer.class, new DalRangedResultMerger<PeopleShardColModShardByDBOnSqlServer>(1,2));
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,1,1), new DalListMerger<PeopleShardColModShardByDBOnSqlServer>());
	    builder.addQuery(sqlList, new StatementParameters(), new DalSingleResultExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,false), new DalFirstResultMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlList, new StatementParameters(), new TestDalRowCallback());
	    builder.addQuery(sqlList, new StatementParameters(), DesignatedDatabaseOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlCount, new StatementParameters(), Integer.class, new IntegerComparator());
	    ...
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1),peopleShardColModShardByDBOnSqlServerRowMapper,new DalListMerger<DesignatedDatabaseOnSqlServer>());//ListMerger
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class);
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class, new DalListMerger<DesignatedDatabaseOnSqlServer>());
//	    builder.addQuery(sqlList, new StatementParameters(), PeopleShardColModShardByDBOnSqlServer.class, new DalRangedResultMerger<PeopleShardColModShardByDBOnSqlServer>(1,2));
//	    builder.addQuery(sqlList, new StatementParameters(), new DalRowMapperExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,1,1), new DalListMerger<PeopleShardColModShardByDBOnSqlServer>());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), new DalSingleResultExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,false), new DalFirstResultMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), new TestDalRowCallback());
	    builder.addQuery(sqlFirst, new StatementParameters().setSensitive(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlObject, parameters, Integer.class);
	    ...
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1),peopleShardColModShardByDBOnSqlServerRowMapper,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class);
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), new DalSingleResultExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,false), new DalFirstResultMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), new TestDalRowCallback());
	    builder.addQuery(sqlObject, new StatementParameters().set(1, "PeopleID", Types.INTEGER, 1), DesignatedDatabaseOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());
...
//	    builder.addQuery(sqlListCount,new StatementParameters(), PeopleShardColModShardByDBOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());//sorter
...
//	    builder.addQuery(sqlNoResult, new StatementParameters(),new TestDalRowCallback3());//callback
	    ...
	    builder.addQuery(sqlInParam, parameters,peopleShardColModShardByDBOnSqlServerRowMapper,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlInParam, parameters, DesignatedDatabaseOnSqlServer.class);
	    builder.addQuery(sqlInParam, parameters, DesignatedDatabaseOnSqlServer.class,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlInParam, parameters, new DalSingleResultExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,false), new DalFirstResultMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlInParam, parameters, new TestDalRowCallback());
	    builder.addQuery(sqlInParam, parameters, DesignatedDatabaseOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());
	    ...
	    builder.addQuery(sqlNoResult, new StatementParameters(),peopleShardColModShardByDBOnSqlServerRowMapper,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), DesignatedDatabaseOnSqlServer.class);
	    builder.addQuery(sqlNoResult, new StatementParameters(), DesignatedDatabaseOnSqlServer.class,new DalListMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), new DalSingleResultExtractor(peopleShardColModShardByDBOnSqlServerRowMapper,false), new DalFirstResultMerger<DesignatedDatabaseOnSqlServer>());
	    builder.addQuery(sqlNoResult, new StatementParameters(), new TestDalRowCallback());
	    builder.addQuery(sqlNoResult, new StatementParameters(), DesignatedDatabaseOnSqlServer.class, new PeopleShardColModShardByDBOnSqlServerComparator());
