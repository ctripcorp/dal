...
public class VelocityHelper {
	public static String getMockValForUnitTest(JavaParameterHost host, String seed){
		...
		}else if(host.getJavaClass().equals(long.class) ||
				host.getJavaClass().equals(Long.class)){
			return host.isPrimary() ? "(long)"+seed : "-1l";
		}else if(host.getJavaClass().equals(Float.class) ||
				host.getJavaClass().equals(Double.class)){
			return host.isPrimary() ? "(float)"+seed : "-1f";
		}else if(host.getJavaClass().equals(Double.class)||
				host.getJavaClass().equals(double.class)){
			return host.isPrimary() ? "(double)"+seed : "-1d";
		}else if(host.getJavaClass().equals(short.class) ||
				host.getJavaClass().equals(Short.class)){
